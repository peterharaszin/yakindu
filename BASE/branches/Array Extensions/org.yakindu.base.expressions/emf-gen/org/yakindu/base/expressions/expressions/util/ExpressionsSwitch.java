...
public class ExpressionsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ExpressionsPackage.ARRAY_INITIALIZATION_EXPRESSION: {
				ArrayInitializationExpression arrayInitializationExpression = (ArrayInitializationExpression)theEObject;
				T result = caseArrayInitializationExpression(arrayInitializationExpression);
				if (result == null) result = caseExpression(arrayInitializationExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Array Initialization Expression</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Array Initialization Expression</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseArrayInitializationExpression(ArrayInitializationExpression object) {
		return null;
	}
