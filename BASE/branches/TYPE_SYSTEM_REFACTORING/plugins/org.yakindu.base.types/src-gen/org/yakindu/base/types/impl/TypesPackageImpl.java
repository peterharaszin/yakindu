...
public class TypesPackageImpl extends EPackageImpl implements TypesPackage {
	...
	public EReference getEnumerationType_Enumerator() {
		return (EReference) enumerationTypeEClass.getEStructuralFeatures().get(
				0);
	}
	...
	public EAttribute getTypeConstraint_Value() {
		return (EAttribute) typeConstraintEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(dataTypeEClass, DATA_TYPE__FEATURES);
	...
	public void initializePackageContents() {
		...
		typeConstraintEClass.getESuperTypes().add(
				theBasePackage.getNamedElement());

		// Initialize classes and features; add operations and parameters
		initEClass(typeEClass, Type.class, "Type", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getType_Constraint(), this.getTypeConstraint(), null,
				"constraint", null, 0, -1, Type.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(featureEClass, Feature.class, "Feature", IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getFeature_OwningType(), this.getDataType(),
				this.getDataType_Features(), "owningType", null, 0, 1,
		...
		initEClass(operationEClass, Operation.class, "Operation", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getOperation_Parameters(), this.getParameter(),
				this.getParameter_OwningOperation(), "parameters", null, 0, -1,
		...
		initEClass(parameterEClass, Parameter.class, "Parameter", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getParameter_OwningOperation(), this.getOperation(),
				this.getOperation_Parameters(), "owningOperation", null, 0, 1,
		...
		initEClass(enumerationTypeEClass, EnumerationType.class,
				"EnumerationType", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEnumerationType_Enumerator(), this.getEnumerator(),
				this.getEnumerator_OwningEnumeration(), "enumerator", null, 0,
				-1, EnumerationType.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(primitiveTypeEClass, PrimitiveType.class, "PrimitiveType",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPrimitiveType_BaseType(), this.getPrimitiveType(),
				null, "baseType", null, 0, 1, PrimitiveType.class,
		...
		initEClass(dataTypeEClass, DataType.class, "DataType", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDataType_Features(), this.getFeature(),
				this.getFeature_OwningType(), "features", null, 0, -1,
		...
		initEClass(enumeratorEClass, Enumerator.class, "Enumerator",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEnumerator_OwningEnumeration(),
				this.getEnumerationType(),
				this.getEnumerationType_Enumerator(), "owningEnumeration",
				null, 0, 1, Enumerator.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEnumerator_LiteralValue(),
				ecorePackage.getEJavaObject(), "literalValue", null, 0, 1,
				Enumerator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(typeConstraintEClass, TypeConstraint.class,
				"TypeConstraint", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTypeConstraint_Value(),
				ecorePackage.getEJavaObject(), "value", null, 0, 1,
				TypeConstraint.class, !IS_TRANSIENT, !IS_VOLATILE,
