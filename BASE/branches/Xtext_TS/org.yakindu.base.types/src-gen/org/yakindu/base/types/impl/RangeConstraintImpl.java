...
public class RangeConstraintImpl extends TypeConstraintImpl implements RangeConstraint {
	...
	public void setLowerBound(long newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.RANGE_CONSTRAINT__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(long newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.RANGE_CONSTRAINT__UPPER_BOUND, oldUpperBound, upperBound));
	}
	 ...
	 * @generated
	 */
	public boolean assignableTo(RangeConstraint constraint) {
