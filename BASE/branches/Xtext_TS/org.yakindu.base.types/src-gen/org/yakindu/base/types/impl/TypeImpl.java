 ...
 * <ul>
 *   <li>{@link org.yakindu.base.types.impl.TypeImpl#getConstraints <em>Constraints</em>}</li>
...
public abstract class TypeImpl extends PackageMemberImpl implements Type {
	...
	public EList<TypeConstraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectContainmentEList<TypeConstraint>(TypeConstraint.class, this, TypesPackage.TYPE__CONSTRAINTS);
		}
		return constraints;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TypesPackage.TYPE__CONSTRAINTS:
