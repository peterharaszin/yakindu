...
public class TypesPackageImpl extends EPackageImpl implements TypesPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getType_Constraints(), this.getTypeConstraint(), null, "constraints", null, 0, -1, Type.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		EOperation op = addEOperation(rangeConstraintEClass, ecorePackage.getEBoolean(), "assignableTo", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getRangeConstraint(), "constraint", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(stringEClass, org.yakindu.base.types.String.class, "String", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(voidEClass, org.yakindu.base.types.Void.class, "Void", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
