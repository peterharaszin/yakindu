...
public class BlockTypeProvider implements IBlockTypeProvider {
	...
	/* (non-Javadoc)
	 * @see org.eclipselabs.damos.diagram.core.internal.provider.IBlockTypeProvider#getBlockTypeDescriptor()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipselabs.damos.diagram.core.internal.provider.IBlockTypeProvider#getBlockType()
	 */
