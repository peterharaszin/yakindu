...
import org.eclipselabs.damos.library.base.ui.figures.logic.EdgeToggleContentFigure;

/**
 * @author Andreas Unger
 *
 */
public class EdgeToggleEditPart extends RectangularBlockEditPart {
	
	/**
	 * @param view
	 */
	public EdgeToggleEditPart(View view) {
		super(view);
	}
	...
	protected NodeFigure createMainFigure() {
		...
		figure.add(new EdgeToggleContentFigure());
		return figure;
	}
