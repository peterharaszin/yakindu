...
import org.eclipselabs.damos.library.base.ui.figures.sinks.XYScopeContentFigure;

/**
 * @author Andreas Unger
 *
 */
public class XYScopeEditPart extends RectangularBlockEditPart {

	/**
	 * @param view
	 */
	public XYScopeEditPart(View view) {
		super(view);
	}
	...
	protected NodeFigure createMainFigure() {
		...
		figure.add(new XYScopeContentFigure());
		return figure;
	}
