 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.AlgorithmExpressionImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AlgorithmExpressionImpl extends ExpressionImpl implements AlgorithmExpression {
	...
	protected EClass eStaticClass() {
		return MscriptPackage.Literals.ALGORITHM_EXPRESSION;
	}
	...
	public void setBody(Compound newBody) {
		if (newBody != body) {
			...
			if (body != null)
				msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.ALGORITHM_EXPRESSION__BODY, null, msgs);
			if (newBody != null)
				msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.ALGORITHM_EXPRESSION__BODY, null, msgs);
			msgs = basicSetBody(newBody, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.ALGORITHM_EXPRESSION__BODY, newBody, newBody));
	}
