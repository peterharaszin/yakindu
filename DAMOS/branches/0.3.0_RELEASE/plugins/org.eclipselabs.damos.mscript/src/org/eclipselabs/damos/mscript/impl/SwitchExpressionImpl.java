 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.SwitchExpressionImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.SwitchExpressionImpl#getControlExpression <em>Control Expression</em>}</li>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.SwitchExpressionImpl#getCases <em>Cases</em>}</li>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.SwitchExpressionImpl#getDefaultExpression <em>Default Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SwitchExpressionImpl extends ExpressionImpl implements SwitchExpression {
	...
	protected EClass eStaticClass() {
		return MscriptPackage.Literals.SWITCH_EXPRESSION;
	}
	...
	public void setStatic(boolean newStatic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.SWITCH_EXPRESSION__STATIC, oldStatic, static_));
	}
	...
	public NotificationChain basicSetControlExpression(Expression newControlExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MscriptPackage.SWITCH_EXPRESSION__CONTROL_EXPRESSION, oldControlExpression, newControlExpression);
	...
	public void setControlExpression(Expression newControlExpression) {
		if (newControlExpression != controlExpression) {
			...
			if (controlExpression != null)
				msgs = ((InternalEObject)controlExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.SWITCH_EXPRESSION__CONTROL_EXPRESSION, null, msgs);
			if (newControlExpression != null)
				msgs = ((InternalEObject)newControlExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.SWITCH_EXPRESSION__CONTROL_EXPRESSION, null, msgs);
			msgs = basicSetControlExpression(newControlExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.SWITCH_EXPRESSION__CONTROL_EXPRESSION, newControlExpression, newControlExpression));
	}
	...
	public NotificationChain basicSetDefaultExpression(Expression newDefaultExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MscriptPackage.SWITCH_EXPRESSION__DEFAULT_EXPRESSION, oldDefaultExpression, newDefaultExpression);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setDefaultExpression(Expression newDefaultExpression) {
		if (newDefaultExpression != defaultExpression) {
			...
			if (defaultExpression != null)
				msgs = ((InternalEObject)defaultExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.SWITCH_EXPRESSION__DEFAULT_EXPRESSION, null, msgs);
			if (newDefaultExpression != null)
				msgs = ((InternalEObject)newDefaultExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.SWITCH_EXPRESSION__DEFAULT_EXPRESSION, null, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MscriptPackage.SWITCH_EXPRESSION__CONTROL_EXPRESSION:
				return basicSetControlExpression(null, msgs);
			case MscriptPackage.SWITCH_EXPRESSION__CASES:
				return ((InternalEList<?>)getCases()).basicRemove(otherEnd, msgs);
			case MscriptPackage.SWITCH_EXPRESSION__DEFAULT_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MscriptPackage.SWITCH_EXPRESSION__STATIC:
				return isStatic();
			case MscriptPackage.SWITCH_EXPRESSION__CONTROL_EXPRESSION:
