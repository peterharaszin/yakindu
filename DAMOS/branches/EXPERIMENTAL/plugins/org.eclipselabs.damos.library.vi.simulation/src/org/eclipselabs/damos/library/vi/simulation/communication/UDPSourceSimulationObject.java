...
package org.eclipselabs.damos.library.vi.simulation.communication;
...
public class UDPSourceSimulationObject extends UDPSimulationObject {
	...
	/* (non-Javadoc)
	 * @see org.eclipselabs.damos.simulation.simulator.AbstractSimulationObject#getClock()
	 */
	@Override
	...
	private class UDPThread extends Thread implements ISimulationClock {
		...
		/* (non-Javadoc)
		 * @see org.eclipselabs.damos.simulation.simulator.ISimulationClock#getNanoTime()
		 */
