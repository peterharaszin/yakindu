...
public class ConfigureActionCommand extends ConfigureElementCommand {
	
    public ConfigureActionCommand(ConfigureRequest request, EClass configurableType) {
        super(request);
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
    	...
    	Action action = (Action) request.getElementToConfigure();
