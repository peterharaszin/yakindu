...
import org.eclipse.damos.dml.internal.operations.InputPortOperations;
 ...
 * <ul>
 *   <li>{@link org.eclipse.damos.dml.impl.InputPortImpl#getInput <em>Input</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InputPortImpl extends PortImpl implements InputPort {
	...
	protected EClass eStaticClass() {
		return DMLPackage.Literals.INPUT_PORT;
	}
	...
	public Input getInput() {
		if (eContainerFeatureID() != DMLPackage.INPUT_PORT__INPUT) return null;
	...
	public NotificationChain basicSetInput(Input newInput, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newInput, DMLPackage.INPUT_PORT__INPUT, msgs);
		return msgs;
	}
	...
	public void setInput(Input newInput) {
		if (newInput != eInternalContainer() || (eContainerFeatureID() != DMLPackage.INPUT_PORT__INPUT && newInput != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DMLPackage.INPUT_PORT__INPUT, newInput, newInput));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DMLPackage.INPUT_PORT__INPUT:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
