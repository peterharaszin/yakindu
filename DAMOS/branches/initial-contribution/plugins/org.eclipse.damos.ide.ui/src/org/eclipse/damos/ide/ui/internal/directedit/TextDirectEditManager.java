...
public class TextDirectEditManager
     ...
     */
    public TextDirectEditManager(ITextualContentEditPart source) {
        this(source, getTextCellEditorLocator(source));
    }
     ...
     * @param locator
     */
    public TextDirectEditManager(GraphicalEditPart source, CellEditorLocator locator) {
    ...
    public static CellEditorLocator getTextCellEditorLocator(
            final ITextualContentEditPart source) {
    ...
    protected Font getScaledFont(IFigure label) {
        ...
        try {
        	...
        	IDEUIPlugin.getDefault().getLog().log(new Status(IStatus.ERROR, IDEUIPlugin.PLUGIN_ID, "Resource allocation failed", e));
        }
    ...
    protected void initCellEditor() {
        ...
        ITextualContentEditPart textEP = (ITextualContentEditPart) getEditPart();

        setEditText(textEP.getContentText());
