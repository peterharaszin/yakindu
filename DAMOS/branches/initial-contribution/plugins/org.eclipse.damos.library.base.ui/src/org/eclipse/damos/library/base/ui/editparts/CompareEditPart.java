...
public class CompareEditPart extends ArgumentValueBlockEditPart {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.diagram.ui.editparts.RectangularComponentEditPart#createRectangularFigure()
	 */
	@Override
	protected RectangularComponentFigure createRectangularComponentFigure() {
		return new RectangularComponentFigure() {
			...
			/* (non-Javadoc)
			 * @see org.eclipse.damos.diagram.ui.figures.RectangularComponentFigure#hasTopLeftMarker()
			 */
			@Override
