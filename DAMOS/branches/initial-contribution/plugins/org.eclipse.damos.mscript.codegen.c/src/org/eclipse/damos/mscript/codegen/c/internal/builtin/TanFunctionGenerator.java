 ...
 *
 */
public class TanFunctionGenerator extends AbstractSingleParameterFunctionGenerator {
	...
	protected String getFixedPointFunctionName(FixedPointFormat fixedPointFormat) {
		return fixedPointFormat.getWordSize() > 32 ? "DamosMath_tanfix64" : "DamosMath_tanfix32";
	}
