...
public class FunctionContext extends AbstractContextStructMember {
  ...
  private final VariableDeclarationGenerator variableDeclarationGenerator = new Function0<VariableDeclarationGenerator>() {
    public VariableDeclarationGenerator apply() {
      VariableDeclarationGenerator _variableDeclarationGenerator = new VariableDeclarationGenerator(FunctionContext.this.dataTypeGenerator);
  ...
  private CharSequence generateContextStructureMember(final VariableDeclaration variableDeclaration) {
    ...
    final CharSequence cVariableDeclaration = this.variableDeclarationGenerator.generateVariableDeclaration(_configuration, _codeFragmentCollector, dataType, name, false, null);
