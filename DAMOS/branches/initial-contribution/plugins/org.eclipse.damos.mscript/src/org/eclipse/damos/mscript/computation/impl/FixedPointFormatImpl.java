...
import org.eclipse.damos.mscript.internal.computation.operations.FixedPointFormatOperations;
 ...
 * <ul>
 *   <li>{@link org.eclipse.damos.mscript.computation.impl.FixedPointFormatImpl#getPredefinedKind <em>Predefined Kind</em>}</li>
 *   <li>{@link org.eclipse.damos.mscript.computation.impl.FixedPointFormatImpl#isUnsigned <em>Unsigned</em>}</li>
 *   <li>{@link org.eclipse.damos.mscript.computation.impl.FixedPointFormatImpl#getIntegerLength <em>Integer Length</em>}</li>
 *   <li>{@link org.eclipse.damos.mscript.computation.impl.FixedPointFormatImpl#getFractionLength <em>Fraction Length</em>}</li>
 *   <li>{@link org.eclipse.damos.mscript.computation.impl.FixedPointFormatImpl#getWordSize <em>Word Size</em>}</li>
 *   <li>{@link org.eclipse.damos.mscript.computation.impl.FixedPointFormatImpl#getSlope <em>Slope</em>}</li>
 *   <li>{@link org.eclipse.damos.mscript.computation.impl.FixedPointFormatImpl#getBias <em>Bias</em>}</li>
 *   <li>{@link org.eclipse.damos.mscript.computation.impl.FixedPointFormatImpl#isSaturate <em>Saturate</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FixedPointFormatImpl extends NumberFormatImpl implements FixedPointFormat {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.mscript.computation.impl.NumberFormatImpl#isEquivalentTo(org.eclipse.damos.mscript.computation.NumberFormat)
	 */
	@Override
