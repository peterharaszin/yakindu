 ...
 * <ul>
 *   <li>{@link org.eclipse.damos.mscript.impl.ConstantDeclarationImpl#getInitializer <em>Initializer</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstantDeclarationImpl extends NamedVariableDeclarationImpl implements ConstantDeclaration {
	...
	public NotificationChain basicSetInitializer(Expression newInitializer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MscriptPackage.CONSTANT_DECLARATION__INITIALIZER, oldInitializer, newInitializer);
	...
	public void setInitializer(Expression newInitializer) {
		if (newInitializer != initializer) {
			...
			if (initializer != null)
				msgs = ((InternalEObject)initializer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.CONSTANT_DECLARATION__INITIALIZER, null, msgs);
			if (newInitializer != null)
				msgs = ((InternalEObject)newInitializer).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.CONSTANT_DECLARATION__INITIALIZER, null, msgs);
			msgs = basicSetInitializer(newInitializer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.CONSTANT_DECLARATION__INITIALIZER, newInitializer, newInitializer));
	}
