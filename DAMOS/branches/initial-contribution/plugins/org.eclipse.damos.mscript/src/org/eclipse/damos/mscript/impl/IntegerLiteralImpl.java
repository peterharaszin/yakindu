...
import org.eclipse.damos.mscript.IntegerData;
 ...
 * <ul>
 *   <li>{@link org.eclipse.damos.mscript.impl.IntegerLiteralImpl#getData <em>Data</em>}</li>
 *   <li>{@link org.eclipse.damos.mscript.impl.IntegerLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IntegerLiteralImpl extends NumericLiteralImpl implements IntegerLiteral {
	 ...
	 * @ordered
	 */
	protected static final IntegerData DATA_EDEFAULT = (IntegerData)MscriptFactory.eINSTANCE.createFromString(MscriptPackage.eINSTANCE.getIntegerData(), "0");
	...
	protected EClass eStaticClass() {
		return MscriptPackage.Literals.INTEGER_LITERAL;
	}
	...
	public void setData(IntegerData newData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.INTEGER_LITERAL__DATA, oldData, data));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MscriptPackage.INTEGER_LITERAL__DATA:
				return getData();
			case MscriptPackage.INTEGER_LITERAL__VALUE:
				return getValue();
		}
