...
public class LnFunction extends AbstractMathFunction {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.mscript.internal.builtin.AbstractSingleParameterMathFunction#compute(org.eclipse.damos.mscript.interpreter.value.ISimpleNumericValue)
	 */
	@Override
