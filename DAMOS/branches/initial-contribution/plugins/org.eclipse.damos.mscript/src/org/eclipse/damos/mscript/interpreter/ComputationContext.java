...
public class ComputationContext implements IComputationContext {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.mscript.computation.core.IComputationContext#getComputationModel()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.mscript.computation.core.IComputationContext#getOverflowMonitor()
	 */
