...
import org.eclipse.damos.codegen.c.rte.AbstractRuntimeEnvironmentAPI;
import org.eclipse.damos.codegen.c.rte.IFastLockGenerator;
import org.eclipse.damos.codegen.c.rte.IMessageQueueGenerator;
import org.eclipse.damos.codegen.c.rte.ISemaphoreGenerator;
...
public class RuntimeEnvironmentAPI extends AbstractRuntimeEnvironmentAPI {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.codegen.c.rte.IRuntimeEnvironmentAPI#getMultitaskingIncludes()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.codegen.c.rte.IRuntimeEnvironmentAPI#getTaskInfoIncludes()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.codegen.c.rte.IRuntimeEnvironmentAPI#getSemaphoreGenerator()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.codegen.c.rte.IRuntimeEnvironmentAPI#getMessageQueueGenerator()
	 */
