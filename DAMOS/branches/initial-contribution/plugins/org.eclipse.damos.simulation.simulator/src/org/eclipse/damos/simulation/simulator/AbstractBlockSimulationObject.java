...
public abstract class AbstractBlockSimulationObject extends AbstractSimulationObject {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.AbstractSimulationObject#initialize(org.eclipse.damos.simulation.simulator.ISimulationObjectContext, org.eclipse.damos.simulation.simulator.ISimulationMonitor)
	 */
	@Override
