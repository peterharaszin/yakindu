...
public abstract class EmbeddedRungeKuttaSolver extends AdaptiveStepSizeSolver implements ISolver {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.solver.AdaptiveStepSizeSolver#initialize(org.eclipse.damos.simulation.simulator.ISimulationContext, org.eclipse.damos.execution.Graph, org.eclipse.damos.simulation.simulator.ISimulationMonitor)
	 */
	@Override
