 ...
 *
 */
public class InportInputPortFigure extends PortFigure {

	public InportInputPortFigure() {
	}

	public InportInputPortFigure(String text) {
		super(text);
	}

	public InportInputPortFigure(IFigure contentFigure) {
		super(contentFigure);
	}
