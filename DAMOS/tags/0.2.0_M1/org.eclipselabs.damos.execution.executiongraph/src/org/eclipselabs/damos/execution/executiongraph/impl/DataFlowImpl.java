 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.execution.executiongraph.impl.DataFlowImpl#getTargetEnds <em>Target Ends</em>}</li>
 *   <li>{@link org.eclipselabs.damos.execution.executiongraph.impl.DataFlowImpl#getSourceEnd <em>Source End</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataFlowImpl extends EObjectImpl implements DataFlow {
	...
	protected EClass eStaticClass() {
		return ExecutionGraphPackage.Literals.DATA_FLOW;
	}
	...
	public NotificationChain basicSetSourceEnd(DataFlowSourceEnd newSourceEnd, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ExecutionGraphPackage.DATA_FLOW__SOURCE_END, oldSourceEnd, newSourceEnd);
	...
	public void setSourceEnd(DataFlowSourceEnd newSourceEnd) {
		if (newSourceEnd != sourceEnd) {
			...
			if (sourceEnd != null)
				msgs = ((InternalEObject)sourceEnd).eInverseRemove(this, ExecutionGraphPackage.DATA_FLOW_SOURCE_END__DATA_FLOW, DataFlowSourceEnd.class, msgs);
			if (newSourceEnd != null)
				msgs = ((InternalEObject)newSourceEnd).eInverseAdd(this, ExecutionGraphPackage.DATA_FLOW_SOURCE_END__DATA_FLOW, DataFlowSourceEnd.class, msgs);
			msgs = basicSetSourceEnd(newSourceEnd, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionGraphPackage.DATA_FLOW__SOURCE_END, newSourceEnd, newSourceEnd));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ExecutionGraphPackage.DATA_FLOW__TARGET_ENDS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTargetEnds()).basicAdd(otherEnd, msgs);
			case ExecutionGraphPackage.DATA_FLOW__SOURCE_END:
				if (sourceEnd != null)
					msgs = ((InternalEObject)sourceEnd).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ExecutionGraphPackage.DATA_FLOW__SOURCE_END, null, msgs);
	...
	public EList<DataFlowTargetEnd> getTargetEnds() {
		if (targetEnds == null) {
			targetEnds = new EObjectContainmentWithInverseEList<DataFlowTargetEnd>(DataFlowTargetEnd.class, this, ExecutionGraphPackage.DATA_FLOW__TARGET_ENDS, ExecutionGraphPackage.DATA_FLOW_TARGET_END__DATA_FLOW);
		}
		return targetEnds;
	}
