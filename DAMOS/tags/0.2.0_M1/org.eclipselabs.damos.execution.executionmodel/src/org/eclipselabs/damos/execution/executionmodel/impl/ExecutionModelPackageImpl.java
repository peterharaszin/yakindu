...
public class ExecutionModelPackageImpl extends EPackageImpl implements ExecutionModelPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getExecutionModel_ComputationModel(), theComputationModelPackage.getComputationModel(), null, "computationModel", null, 1, 1, ExecutionModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
