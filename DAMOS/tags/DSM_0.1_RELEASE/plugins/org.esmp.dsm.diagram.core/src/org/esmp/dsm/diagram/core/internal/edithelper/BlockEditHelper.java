...
import org.esmp.dsm.diagram.core.internal.commands.ConfigureBlockCommand;
...
public class BlockEditHelper extends AbstractEditHelper {
	...
	protected ICommand getConfigureCommand(ConfigureRequest request) {
		return new ConfigureBlockCommand(request, BlockDiagramPackage.eINSTANCE.getBlock());
	}
