 ...
 *
 */
public class FlipBlockAction extends DiagramAction {

	/**
	 * @param workbenchPage
	 */
	public FlipBlockAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}
	...
	protected Request createTargetRequest() {
		return new Request(RequestConstants.REQ_FLIP_BLOCK);
	}
