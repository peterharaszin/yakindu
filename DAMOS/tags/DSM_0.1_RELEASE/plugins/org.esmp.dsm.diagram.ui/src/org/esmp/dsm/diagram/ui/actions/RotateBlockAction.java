 ...
 *
 */
public class RotateBlockAction extends DiagramAction {

	/**
	 * @param workbenchPage
	 */
	public RotateBlockAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}
	...
	protected Request createTargetRequest() {
		return new Request(RequestConstants.REQ_ROTATE_BLOCK);
	}
