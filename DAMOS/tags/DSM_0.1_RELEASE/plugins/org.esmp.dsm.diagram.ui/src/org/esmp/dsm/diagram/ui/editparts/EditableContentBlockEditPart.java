 ...
 *
 */
public abstract class EditableContentBlockEditPart extends StandardBlockEditPart implements ITextAwareEditPart {
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.ui.editparts.TransformableBlockEditPart#createDefaultEditPolicies()
	 */
	...
	protected ILabelDelegate getContentLabel() {
		IFigure figure = getBlockFigure().getPrimaryContentFigure();
	...
	protected void handleNotificationEvent(Notification notification) {
		if (notification.getNotifier() == getParameter()) {
			refreshContent();
		} else {
		...
		if (parser == null) {
			parser = new IParser() {
				...
				public ICommand getParseCommand(IAdaptable element, String newString, int flags) {
					return new SetParameterValueCommand(getParameter(), newString);
				}
