...
package org.esmp.dsm.diagram.ui.internal.figures;
...
public class CanvasContextImpl implements CanvasContext {
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#clipRect(org.eclipse.draw2d.geometry.Rectangle)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#drawArc(int, int, int, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#drawFocus(int, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#drawLine(int, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#drawOval(int, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#drawPolygon(org.eclipse.draw2d.geometry.PointList)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#drawPolyline(org.eclipse.draw2d.geometry.PointList)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#drawRectangle(int, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvasContext#drawRectangle(org.eclipse.draw2d.geometry.Rectangle)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.ui.figures.CanvasContext#drawRoundRectangle(int, int, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#drawRoundRectangle(org.eclipse.draw2d.geometry.Rectangle, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#fillArc(int, int, int, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#fillOval(int, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#fillPolygon(org.eclipse.draw2d.geometry.PointList)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#fillRectangle(int, int, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.ui.figures.CanvasContext#fillRectangle(org.eclipse.draw2d.geometry.Rectangle)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#fillRoundRectangle(org.eclipse.draw2d.geometry.Rectangle, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#getBackgroundColor()
	 */
...
//	}
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#getForegroundColor()
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#getLineStyle()
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#getLineWidth()
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#getXORMode()
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#popState()
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#pushState()
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#restoreState()
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#setForegroundColor(org.eclipse.swt.graphics.Color)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#setBackgroundColor(org.eclipse.swt.graphics.Color)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.ui.figures.CanvasContext#setAlpha(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#setClip(org.eclipse.draw2d.geometry.Rectangle)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#setLineStyle(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#setLineWidth(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.figures.ICanvas#setXORMode(boolean)
	 */
