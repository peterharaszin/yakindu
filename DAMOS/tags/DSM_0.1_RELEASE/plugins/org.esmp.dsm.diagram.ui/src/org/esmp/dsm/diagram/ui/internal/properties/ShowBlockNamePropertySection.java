...
import org.esmp.dsm.diagram.ui.properties.AbstractCheckboxPropertySection;
 ...
 *
 */
public class ShowBlockNamePropertySection extends AbstractCheckboxPropertySection {

	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.ui.properties.AbstractBasicCheckboxPropertySection#getPropertyChangeCommandName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.ui.properties.AbstractBasicCheckboxPropertySection#getPropertyNameLabel()
	 */
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.ui.properties.AbstractBasicCheckboxPropertySection#getPropertyValue()
	 */
		...
		if (editPart != null) {
			...
			if (view != null) {
				for (View childView : (List<View>) view.getChildren()) {
					if (SemanticHints.BLOCK_NAME.equals(childView.getType())) {
	...
	/* (non-Javadoc)
	 * @see org.esmp.dsm.diagram.ui.properties.AbstractBasicCheckboxPropertySection#setPropertyValue(org.eclipse.emf.ecore.EObject, java.lang.Object)
	 */
	@SuppressWarnings("unchecked")
