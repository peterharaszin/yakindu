...
public class BlockViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable element, String semanticHint, int index, boolean persisted) {
        ...
        getViewService().createNode(element, view, SemanticHints.BLOCK_NAME, ViewUtil.APPEND, persisted, getPreferencesHint());
	}
	...
	protected LayoutConstraint createLayoutConstraint() {
		return BlockDiagramNotationFactory.eINSTANCE.createBlockLayoutConstraint();
	}
