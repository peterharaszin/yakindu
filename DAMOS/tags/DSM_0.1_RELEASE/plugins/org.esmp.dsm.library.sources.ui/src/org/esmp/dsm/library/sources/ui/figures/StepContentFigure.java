 ...
 *
 */
public class StepContentFigure extends Figure implements FigureConstants {
	...
	protected void paintFigure(Graphics g) {
		...
		points[2] = border.x + border.width / 2;
		points[3] = border.y + border.height;
		points[4] = border.x + border.width / 2;
		points[5] = border.y;
