...
/**
 * This is the item provider adapter for a {@link org.esmp.dsm.semantic.blockdiagram.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_specification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_specification_feature", "_UI_Input_type"),
				 BlockDiagramPackage.Literals.INPUT__SPECIFICATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BlockDiagramPackage.Literals.INPUT__PORTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BlockDiagramPackage.Literals.INPUT__PORTS,
				 BlockDiagramFactory.eINSTANCE.createInputPort()));
	}
