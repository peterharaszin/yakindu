...
/**
 * This is the item provider adapter for a {@link org.esmp.dsm.semantic.blockdiagram.Output} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OutputItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Output_specification_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Output_specification_feature", "_UI_Output_type"),
				 BlockDiagramPackage.Literals.OUTPUT__SPECIFICATION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BlockDiagramPackage.Literals.OUTPUT__PORTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BlockDiagramPackage.Literals.OUTPUT__PORTS,
				 BlockDiagramFactory.eINSTANCE.createOutputPort()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return DSMSemanticEditPlugin.INSTANCE;
	}
