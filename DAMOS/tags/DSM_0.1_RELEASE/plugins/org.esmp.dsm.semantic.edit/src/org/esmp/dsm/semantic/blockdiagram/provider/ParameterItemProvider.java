...
/**
 * This is the item provider adapter for a {@link org.esmp.dsm.semantic.blockdiagram.Parameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 BlockDiagramPackage.Literals.PARAMETER__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addDescriptorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parameter_descriptor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parameter_descriptor_feature", "_UI_Parameter_type"),
				 BlockDiagramPackage.Literals.PARAMETER__DESCRIPTOR,
				 true,
				 false,
				 true,
				 null,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Parameter.class)) {
			case BlockDiagramPackage.PARAMETER__VALUE:
