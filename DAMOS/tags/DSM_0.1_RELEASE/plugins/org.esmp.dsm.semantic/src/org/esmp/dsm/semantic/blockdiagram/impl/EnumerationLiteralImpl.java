 ...
 * <ul>
 *   <li>{@link org.esmp.dsm.semantic.blockdiagram.impl.EnumerationLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationLiteralImpl extends NamedElementImpl implements EnumerationLiteral {
	...
	protected EClass eStaticClass() {
		return BlockDiagramPackage.Literals.ENUMERATION_LITERAL;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BlockDiagramPackage.ENUMERATION_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BlockDiagramPackage.ENUMERATION_LITERAL__VALUE:
				return getValue();
		}
