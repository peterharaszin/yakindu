...
public class ChoiceGenerator extends AbstractComponentGenerator {
  ...
  private CharSequence generateValueSpecification(final ValueSpecification valueSpecification) {
    if ((valueSpecification instanceof DscriptValueSpecification)) {
      ...
      double _sampleTime = _node.getSampleTime();
      ...
      MscriptGeneratorContext _mscriptGeneratorContext = new MscriptGeneratorContext(_mscriptGeneratorConfiguration, staticFunctionInfo, _sampleTime, _choiceVariableAccessStrategy, _codeFragmentCollector);
