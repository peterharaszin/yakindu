 ...
 *
 */
public class ArduinoShieldsExecutableExtensionFactory extends AbstractGuiceAwareExecutableExtensionFactory {
	...
	protected Bundle getBundle() {
		return ArduinoShieldsPlugin.getDefault().getBundle();
	}
	...
	protected Injector getInjector() {
		return Guice.createInjector(new ArduinoShieldsModule());
	}
