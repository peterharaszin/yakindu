...
public class InoFileGenerator {
  public CharSequence generate(final IGeneratorContext context, final IProgressMonitor monitor) {
    CharSequence _xblockexpression = null;
    {
      ...
      ISampleInterval _fundamentalSampleInterval = _executionFlow.getFundamentalSampleInterval();
      final double fundamentalSampleTime = _fundamentalSampleInterval.sampleTime();
