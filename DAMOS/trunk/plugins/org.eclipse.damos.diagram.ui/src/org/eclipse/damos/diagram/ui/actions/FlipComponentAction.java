 ...
 *
 */
public class FlipComponentAction extends DiagramAction {

	/**
	 * @param workbenchPage
	 */
	public FlipComponentAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}
	...
	protected Request createTargetRequest() {
		return new Request(IRequestConstants.REQ_FLIP_COMPONENT);
	}
