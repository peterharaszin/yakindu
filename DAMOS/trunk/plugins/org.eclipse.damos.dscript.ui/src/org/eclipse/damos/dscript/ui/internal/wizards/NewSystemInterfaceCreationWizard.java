...
package org.eclipse.damos.dscript.ui.internal.wizards;
 ...
 *
 */
public class NewSystemInterfaceCreationWizard extends NewDscriptCreationWizard {

	/* (non-Javadoc)
	 * @see org.eclipse.damos.dscript.ui.internal.wizards.NewDscriptCreationWizard#createMainPage()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.dscript.ui.internal.wizards.NewDscriptCreationWizard#writeBody(java.lang.Appendable)
	 */
	@Override
	...
	private void writeDataType(Appendable appendable, Collection<? extends Inoutport> inoutports, String keyword) throws IOException {
		for (Inoutport inoutport : inoutports) {
			...
			if (dataType != null) {
				dataTypeString = DscriptUtil.getText(dataType);
			}
