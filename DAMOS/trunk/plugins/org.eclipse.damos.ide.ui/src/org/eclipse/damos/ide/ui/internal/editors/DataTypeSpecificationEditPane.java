...
public class DataTypeSpecificationEditPane implements IDataTypeSpecificationEditPane {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.dml.ui.IDataTypeSpecificationEditor#createEditControl(org.eclipse.swt.widgets.Composite)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.dml.ui.IDataTypeSpecificationEditor#getEditControl()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.dml.ui.IDataTypeSpecificationEditor#contributesCommonDataTypesControl()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.dml.ui.IDataTypeSpecificationEditor#createCommonDataTypesControl(org.eclipse.swt.widgets.Composite)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.dml.ui.IDataTypeSpecificationEditor#getCommonDataTypesControl()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.dml.ui.IDataTypeSpecificationEditor#initialize()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.dml.ui.IDataTypeSpecificationEditor#initialize(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.dml.ui.IDataTypeSpecificationEditor#refresh(org.eclipse.emf.edit.domain.EditingDomain, org.eclipse.emf.ecore.EObject, org.eclipse.emf.ecore.EStructuralFeature[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.dml.ui.IDataTypeSpecificationEditor#dispose()
	 */
	public void dispose() {
		disposeModelObservables();
	}
