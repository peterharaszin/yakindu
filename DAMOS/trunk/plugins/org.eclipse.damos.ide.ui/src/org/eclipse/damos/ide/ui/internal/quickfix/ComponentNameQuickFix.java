...
public class ComponentNameQuickFix extends AbstractQuickFix implements IStatefulQuickFix {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.ide.ui.internal.quickfix.IStatefulQuickFix#initialize(org.eclipse.damos.ide.core.validation.Problem, org.eclipse.emf.transaction.TransactionalEditingDomain)
	 */
