...
class RecordConstructionFunction extends AbstractCodeFragment {
	...
	override void initialize(ICodeFragmentContext context, IProgressMonitor monitor) {
		...
		val recordTypeDeclaration = codeFragmentCollector.addCodeFragment(new org.eclipse.damos.mscript.codegen.c.codefragments.RecordTypeDeclaration(recordType), monitor);
