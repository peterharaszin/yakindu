...
import org.eclipse.damos.mscript.codegen.c.codefragments.factories.IInitializeFunctionFactory.Default;
...
public interface IInitializeFunctionFactory {
	...
	class Default implements IInitializeFunctionFactory {
		...
		public ICodeFragment create(IMscriptGeneratorContext generatorContext, IComputeFunction computeFunction) {
			ICodeFragment codeFragment = new InitializeFunction(generatorContext, computeFunction);
