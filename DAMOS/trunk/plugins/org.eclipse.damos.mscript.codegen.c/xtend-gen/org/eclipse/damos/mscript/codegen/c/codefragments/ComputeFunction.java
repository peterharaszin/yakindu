...
public class ComputeFunction extends AbstractCodeFragment implements IComputeFunction {
  ...
  public void initialize(final ICodeFragmentContext context, final IProgressMonitor monitor) {
    ...
    if (_isStateful) {
      ...
      ICodeFragment _create = this.updateFunctionFactory.create(this.generatorContext, this);
      NullProgressMonitor _nullProgressMonitor_1 = new NullProgressMonitor();
      ICodeFragment _addCodeFragment_1 = codeFragmentCollector.<ICodeFragment>addCodeFragment(_create, _nullProgressMonitor_1);
      this.updateFunction = ((UpdateFunction) _addCodeFragment_1);
      ICodeFragment _create_1 = this.initializeFunctionFactory.create(this.generatorContext, this);
      NullProgressMonitor _nullProgressMonitor_2 = new NullProgressMonitor();
      ICodeFragment _addCodeFragment_2 = codeFragmentCollector.<ICodeFragment>addCodeFragment(_create_1, _nullProgressMonitor_2);
