...
public class ArrayScalarMultiplyGenerator implements IOperationGenerator {
  ...
  public CharSequence generate(final IMscriptGeneratorContext context, final Type resultDataType, final CharSequence target, final Expression expression) {
    CharSequence _xblockexpression = null;
    {
      ...
      Type _dataType_2 = _value_2.getDataType();
      final MachineNumericType scalarType = this.machineDataTypeFactory.create(_configuration, ((NumericType) _dataType_2));
      ...
      Type _dataType_3 = _value_3.getDataType();
      final MachineArrayType arrayType = this.machineDataTypeFactory.create(_configuration_1, ((ArrayType) _dataType_3));
      ...
      TextualNumericExpressionOperand _textualNumericExpressionOperand = new TextualNumericExpressionOperand(this.numericExpressionCaster, _generate, _numberFormat);
      ...
      TextualNumericExpressionOperand _textualNumericExpressionOperand_1 = new TextualNumericExpressionOperand(this.numericExpressionCaster, _plus, _numberFormat_1);
