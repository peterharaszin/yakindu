...
import org.eclipse.damos.mscript.interpreter.util.FixMath;
...
public class FixedPointValue extends AbstractNumericValue implements ISimpleNumericValue {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.mscript.interpreter.value.AbstractNumericValue#doAdd(org.eclipse.damos.mscript.interpreter.value.IValue, org.eclipse.damos.mscript.DataType)
	 */
	@Override
