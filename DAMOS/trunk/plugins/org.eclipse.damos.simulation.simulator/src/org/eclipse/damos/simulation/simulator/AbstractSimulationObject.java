...
public abstract class AbstractSimulationObject implements ISimulationObject {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.ISimulationObject#getClock()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.ISimulationObject#initialize(org.eclipse.damos.simulation.simulator.ISimulationObjectContext, org.eclipse.damos.simulation.simulator.ISimulationMonitor)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.ISimulationObject#stop()
	 */
	public boolean stop() {
		return false;
	}
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.ISimulationObject#getStateVector()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.ISimulationObject#computeDerivatives(double, double[])
	 */
	public void computeDerivatives(double t, double[] y, double[] yDot) {
	}
	
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.ISimulationObject#getZeroCrossingTime(double)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.ISimulationObject#dispose()
	 */
	public void dispose() {
	}
