...
public abstract class AbstractSimulationAgent extends PlatformObject implements ISimulationAgent {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.ISimulationAgent#getTracePoints()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.ISimulationAgent#getVariationPoints()
	 */
