 ...
 * @generated
 */
public class GenSubsystemItemProvider
	 ...
	 * @generated
	 */
	public GenSubsystemItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GenSubsystem_subsystem_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_GenSubsystem_subsystem_feature", "_UI_GenSubsystem_type"),
				 CGenModelPackage.Literals.GEN_SUBSYSTEM__SUBSYSTEM,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GenSubsystem"));
	}
