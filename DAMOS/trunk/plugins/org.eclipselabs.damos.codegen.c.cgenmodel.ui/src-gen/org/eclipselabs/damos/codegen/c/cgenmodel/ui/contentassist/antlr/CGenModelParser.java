...
* generated by Xtext
*/
package org.eclipselabs.damos.codegen.c.cgenmodel.ui.contentassist.antlr;
...
public class CGenModelParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipselabs.damos.codegen.c.cgenmodel.ui.contentassist.antlr.internal.InternalCGenModelParser createParser() {
		org.eclipselabs.damos.codegen.c.cgenmodel.ui.contentassist.antlr.internal.InternalCGenModelParser result = new org.eclipselabs.damos.codegen.c.cgenmodel.ui.contentassist.antlr.internal.InternalCGenModelParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGenModelAccess().getGroup(), "rule__GenModel__Group__0");
					put(grammarAccess.getGenModelAccess().getGroup_4_1(), "rule__GenModel__Group_4_1__0");
					put(grammarAccess.getGenModelAccess().getGroup_4_2(), "rule__GenModel__Group_4_2__0");
					...
					put(grammarAccess.getGenModelAccess().getQualifiedNameAssignment_1(), "rule__GenModel__QualifiedNameAssignment_1");
					put(grammarAccess.getGenModelAccess().getExecutionModelAssignment_3(), "rule__GenModel__ExecutionModelAssignment_3");
					put(grammarAccess.getGenModelAccess().getGenTopLevelSystemAssignment_4_0(), "rule__GenModel__GenTopLevelSystemAssignment_4_0");
					put(grammarAccess.getGenModelAccess().getSourceDirectoryAssignment_4_1_1(), "rule__GenModel__SourceDirectoryAssignment_4_1_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipselabs.damos.codegen.c.cgenmodel.ui.contentassist.antlr.internal.InternalCGenModelParser typedParser = (org.eclipselabs.damos.codegen.c.cgenmodel.ui.contentassist.antlr.internal.InternalCGenModelParser) parser;
			typedParser.entryRuleGenModel();
