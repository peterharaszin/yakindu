...
public class SemaphoreInfo implements ISemaphoreInfo {
	...
	/* (non-Javadoc)
	 * @see org.eclipselabs.damos.codegen.c.internal.rte.ISemaphoreDescriptor#getMaximumCount()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipselabs.damos.codegen.c.internal.rte.ISemaphoreDescriptor#getInitialCount()
	 */
