...
public class CompoundGenerator implements ICompoundGenerator {
  ...
  private CharSequence generateMemoryVariableDeclaration(final IGeneratorContext context, final ComponentNode node) {
    CharSequence _xblockexpression = null;
    {
      ...
      final CharSequence cDataType = this.dataTypeGenerator.generateDataType(_mscriptGeneratorConfiguration, _codeFragmentCollector, outputDataType, null);
      ...
      final String initializer = GeneratorUtil.getIncomingVariableName(_configuration_2, node, _firstInputPort);
      Configuration _configuration_3 = context.getConfiguration();
      final String variableName = CompoundGeneratorUtil.getMemoryPreviousValueVariableName(_configuration_3, node);
      StringConcatenation _builder = new StringConcatenation();
