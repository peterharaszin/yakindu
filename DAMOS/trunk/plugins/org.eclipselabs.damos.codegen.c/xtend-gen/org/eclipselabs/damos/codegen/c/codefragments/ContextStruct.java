  ...
  public void doInitialize(final IGeneratorContext context, final IProgressMonitor monitor) {
    final Function1<ICodeFragment,Boolean> _function = new Function1<ICodeFragment,Boolean>() {
        public Boolean apply(final ICodeFragment it) {
          return (it instanceof TaskMessageStruct);
        }
      };
    ...
    if (!_isSingleton) {
      ...
      boolean _isEmpty_1 = IterableExtensions.isEmpty(nodes);
      _and = (_isSingleton && _isEmpty_1);
    }
    this.unused = _and;
    ...
    _builder.newLine();
    {
      boolean _isEmpty_2 = IterableExtensions.isEmpty(nodes);
      if (_isEmpty_2) {
        _builder.append("\t");
        ...
        _builder.newLineIfNotEmpty();
        {
          for(final ComponentNode node_2 : nodes) {
            ...
            String _prefix = GeneratorConfigurationExtensions.getPrefix(_configuration_2, node_2);
