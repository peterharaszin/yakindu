...
import org.eclipselabs.damos.codegen.c.internal.componentgenerators.ChoiceVariableAccessStrategy;
...
public class ChoiceGenerator extends AbstractComponentGenerator {
  ...
  private CharSequence generateValueSpecification(final ValueSpecification valueSpecification) {
    if ((valueSpecification instanceof DscriptValueSpecification)) {
      ...
      MscriptGeneratorContext _mscriptGeneratorContext = new MscriptGeneratorContext(_mscriptGeneratorConfiguration, staticFunctionInfo, _choiceVariableAccessStrategy, _codeFragmentCollector);
