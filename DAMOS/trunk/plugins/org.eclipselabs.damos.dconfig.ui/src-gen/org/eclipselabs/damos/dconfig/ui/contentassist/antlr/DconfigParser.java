...
public class DconfigParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipselabs.damos.dconfig.ui.contentassist.antlr.internal.InternalDconfigParser createParser() {
		org.eclipselabs.damos.dconfig.ui.contentassist.antlr.internal.InternalDconfigParser result = new org.eclipselabs.damos.dconfig.ui.contentassist.antlr.internal.InternalDconfigParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSelectionPropertyBodyAccess().getAlternatives_2(), "rule__SelectionPropertyBody__Alternatives_2");
					put(grammarAccess.getSystemConfigurationBodyAccess().getAlternatives_2(), "rule__SystemConfigurationBody__Alternatives_2");
					put(grammarAccess.getFragmentConfigurationAccess().getAlternatives_1(), "rule__FragmentConfiguration__Alternatives_1");
					put(grammarAccess.getNumberFormatAccess().getAlternatives(), "rule__NumberFormat__Alternatives");
					put(grammarAccess.getFixedPointFormatAccess().getAlternatives_0(), "rule__FixedPointFormat__Alternatives_0");
					put(grammarAccess.getFixedPointFormatAccess().getAlternatives_0_0_0(), "rule__FixedPointFormat__Alternatives_0_0_0");
					put(grammarAccess.getFixedPointFormatAccess().getAlternatives_0_0_2(), "rule__FixedPointFormat__Alternatives_0_0_2");
					put(grammarAccess.getQualifiedNameWithWildcardAccess().getAlternatives_1(), "rule__QualifiedNameWithWildcard__Alternatives_1");
					put(grammarAccess.getValidIDWithoutIJAccess().getAlternatives(), "rule__ValidIDWithoutIJ__Alternatives");
					put(grammarAccess.getValidDoubleAccess().getAlternatives_2(), "rule__ValidDouble__Alternatives_2");
					put(grammarAccess.getValidDoubleAccess().getAlternatives_2_0_2(), "rule__ValidDouble__Alternatives_2_0_2");
					...
					put(grammarAccess.getFunctionDeclarationAccess().getAlternatives_10(), "rule__FunctionDeclaration__Alternatives_10");
					put(grammarAccess.getCheckArgumentAccess().getAlternatives(), "rule__CheckArgument__Alternatives");
					...
					put(grammarAccess.getImplicitUnitAccess().getAlternatives_1_1(), "rule__ImplicitUnit__Alternatives_1_1");
					put(grammarAccess.getImplicitUnitAccess().getAlternatives_1_2_1(), "rule__ImplicitUnit__Alternatives_1_2_1");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getAlternatives_1_1(), "rule__ImplicitUnitWithAny__Alternatives_1_1");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getAlternatives_1_1_1_0(), "rule__ImplicitUnitWithAny__Alternatives_1_1_1_0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getAlternatives_1_1_1_1_1(), "rule__ImplicitUnitWithAny__Alternatives_1_1_1_1_1");
					put(grammarAccess.getExplicitUnitAccess().getAlternatives_2(), "rule__ExplicitUnit__Alternatives_2");
					put(grammarAccess.getExplicitUnitAccess().getAlternatives_3_1(), "rule__ExplicitUnit__Alternatives_3_1");
					...
					put(grammarAccess.getPredefinedFloatingPointFormatKindAccess().getAlternatives(), "rule__PredefinedFloatingPointFormatKind__Alternatives");
					put(grammarAccess.getPredefinedFixedPointFormatKindAccess().getAlternatives(), "rule__PredefinedFixedPointFormatKind__Alternatives");
					...
					put(grammarAccess.getSystemConfigurationBodyAccess().getGroup(), "rule__SystemConfigurationBody__Group__0");
					put(grammarAccess.getFragmentConfigurationAccess().getGroup(), "rule__FragmentConfiguration__Group__0");
					put(grammarAccess.getFragmentConfigurationAccess().getGroup_1_0(), "rule__FragmentConfiguration__Group_1_0__0");
					put(grammarAccess.getFragmentConfigurationAccess().getGroup_1_0_1(), "rule__FragmentConfiguration__Group_1_0_1__0");
					put(grammarAccess.getFragmentConfigurationAccess().getGroup_1_1(), "rule__FragmentConfiguration__Group_1_1__0");
					put(grammarAccess.getFragmentConfigurationBodyAccess().getGroup(), "rule__FragmentConfigurationBody__Group__0");
					...
					put(grammarAccess.getComponentPathAccess().getGroup(), "rule__ComponentPath__Group__0");
					put(grammarAccess.getComponentPathAccess().getGroup_1(), "rule__ComponentPath__Group_1__0");
					put(grammarAccess.getBindingAccess().getGroup(), "rule__Binding__Group__0");
					put(grammarAccess.getBindingResourceReferenceAccess().getGroup(), "rule__BindingResourceReference__Group__0");
					put(grammarAccess.getBindingResourceReferenceAccess().getGroup_1(), "rule__BindingResourceReference__Group_1__0");
					put(grammarAccess.getBindingBodyAccess().getGroup(), "rule__BindingBody__Group__0");
					...
					put(grammarAccess.getFixedPointFormatAccess().getGroup_0_0(), "rule__FixedPointFormat__Group_0_0__0");
					put(grammarAccess.getFixedPointFormatAccess().getGroup_0_0_2_0(), "rule__FixedPointFormat__Group_0_0_2_0__0");
					put(grammarAccess.getFixedPointFormatAccess().getGroup_0_0_2_1(), "rule__FixedPointFormat__Group_0_0_2_1__0");
					put(grammarAccess.getFixedPointFormatAccess().getGroup_0_0_2_1_0(), "rule__FixedPointFormat__Group_0_0_2_1_0__0");
					put(grammarAccess.getFixedPointFormatAccess().getGroup_0_0_2_1_1(), "rule__FixedPointFormat__Group_0_0_2_1_1__0");
					put(grammarAccess.getNumberFormatMappingAccess().getGroup(), "rule__NumberFormatMapping__Group__0");
					...
					put(grammarAccess.getQualifiedNameWithoutIJAccess().getGroup(), "rule__QualifiedNameWithoutIJ__Group__0");
					put(grammarAccess.getQualifiedNameWithoutIJAccess().getGroup_1(), "rule__QualifiedNameWithoutIJ__Group_1__0");
					put(grammarAccess.getValidDoubleAccess().getGroup(), "rule__ValidDouble__Group__0");
					put(grammarAccess.getValidDoubleAccess().getGroup_2_0(), "rule__ValidDouble__Group_2_0__0");
					put(grammarAccess.getValidDoubleAccess().getGroup_2_0_2_1(), "rule__ValidDouble__Group_2_0_2_1__0");
					...
					put(grammarAccess.getUnitDefinitionAccess().getGroup_1_1(), "rule__UnitDefinition__Group_1_1__0");
					put(grammarAccess.getUnitDefinitionAccess().getGroup_1_1_1(), "rule__UnitDefinition__Group_1_1_1__0");
					put(grammarAccess.getUnitDefinitionAccess().getGroup_2(), "rule__UnitDefinition__Group_2__0");
					put(grammarAccess.getUnitDefinitionAccess().getGroup_2_1_1(), "rule__UnitDefinition__Group_2_1_1__0");
					put(grammarAccess.getUnitDefinitionAccess().getGroup_2_1_1_2(), "rule__UnitDefinition__Group_2_1_1_2__0");
					...
					put(grammarAccess.getFunctionDeclarationAccess().getGroup_8(), "rule__FunctionDeclaration__Group_8__0");
					put(grammarAccess.getInputParameterDeclarationAccess().getGroup(), "rule__InputParameterDeclaration__Group__0");
					...
					put(grammarAccess.getCheckAccess().getGroup_6(), "rule__Check__Group_6__0");
					put(grammarAccess.getExpressionCheckArgumentAccess().getGroup(), "rule__ExpressionCheckArgument__Group__0");
					...
					put(grammarAccess.getImplicitUnitAccess().getGroup(), "rule__ImplicitUnit__Group__0");
					put(grammarAccess.getImplicitUnitAccess().getGroup_1(), "rule__ImplicitUnit__Group_1__0");
					put(grammarAccess.getImplicitUnitAccess().getGroup_1_1_1(), "rule__ImplicitUnit__Group_1_1_1__0");
					put(grammarAccess.getImplicitUnitAccess().getGroup_1_1_1_1(), "rule__ImplicitUnit__Group_1_1_1_1__0");
					put(grammarAccess.getImplicitUnitAccess().getGroup_1_2(), "rule__ImplicitUnit__Group_1_2__0");
					put(grammarAccess.getImplicitUnitAccess().getGroup_1_2_1_1(), "rule__ImplicitUnit__Group_1_2_1_1__0");
					put(grammarAccess.getImplicitUnitAccess().getGroup_1_2_1_1_2(), "rule__ImplicitUnit__Group_1_2_1_1_2__0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getGroup(), "rule__ImplicitUnitWithAny__Group__0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getGroup_1(), "rule__ImplicitUnitWithAny__Group_1__0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getGroup_1_1_1(), "rule__ImplicitUnitWithAny__Group_1_1_1__0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getGroup_1_1_1_0_1(), "rule__ImplicitUnitWithAny__Group_1_1_1_0_1__0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getGroup_1_1_1_0_1_1(), "rule__ImplicitUnitWithAny__Group_1_1_1_0_1_1__0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getGroup_1_1_1_1(), "rule__ImplicitUnitWithAny__Group_1_1_1_1__0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getGroup_1_1_1_1_1_1(), "rule__ImplicitUnitWithAny__Group_1_1_1_1_1_1__0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getGroup_1_1_1_1_1_1_2(), "rule__ImplicitUnitWithAny__Group_1_1_1_1_1_1_2__0");
					put(grammarAccess.getExplicitUnitAccess().getGroup(), "rule__ExplicitUnit__Group__0");
					put(grammarAccess.getExplicitUnitAccess().getGroup_2_1(), "rule__ExplicitUnit__Group_2_1__0");
					put(grammarAccess.getExplicitUnitAccess().getGroup_2_1_1(), "rule__ExplicitUnit__Group_2_1_1__0");
					put(grammarAccess.getExplicitUnitAccess().getGroup_3(), "rule__ExplicitUnit__Group_3__0");
					put(grammarAccess.getExplicitUnitAccess().getGroup_3_1_1(), "rule__ExplicitUnit__Group_3_1_1__0");
					put(grammarAccess.getExplicitUnitAccess().getGroup_3_1_1_2(), "rule__ExplicitUnit__Group_3_1_1_2__0");
					...
					put(grammarAccess.getUnitDenominatorFactorAccess().getGroup(), "rule__UnitDenominatorFactor__Group__0");
					put(grammarAccess.getUnitDenominatorFactorAccess().getGroup_1(), "rule__UnitDenominatorFactor__Group_1__0");
					put(grammarAccess.getUnitExponentAccess().getGroup(), "rule__UnitExponent__Group__0");
					put(grammarAccess.getUnitDenominatorExponentAccess().getGroup(), "rule__UnitDenominatorExponent__Group__0");
					...
					put(grammarAccess.getConfigurationAccess().getPackageNameAssignment_1(), "rule__Configuration__PackageNameAssignment_1");
					...
					put(grammarAccess.getRootSystemConfigurationAccess().getBodyAssignment_2(), "rule__RootSystemConfiguration__BodyAssignment_2");
					put(grammarAccess.getSubsystemConfigurationAccess().getSubsystemAssignment_1(), "rule__SubsystemConfiguration__SubsystemAssignment_1");
					put(grammarAccess.getSubsystemConfigurationAccess().getBodyAssignment_2(), "rule__SubsystemConfiguration__BodyAssignment_2");
					put(grammarAccess.getSystemConfigurationBodyAccess().getPropertiesAssignment_2_0(), "rule__SystemConfigurationBody__PropertiesAssignment_2_0");
					put(grammarAccess.getSystemConfigurationBodyAccess().getComponentConfigurationsAssignment_2_1(), "rule__SystemConfigurationBody__ComponentConfigurationsAssignment_2_1");
					put(grammarAccess.getSystemConfigurationBodyAccess().getFragmentConfigurationsAssignment_2_2(), "rule__SystemConfigurationBody__FragmentConfigurationsAssignment_2_2");
					put(grammarAccess.getSystemConfigurationBodyAccess().getSubsystemConfigurationsAssignment_2_3(), "rule__SystemConfigurationBody__SubsystemConfigurationsAssignment_2_3");
					put(grammarAccess.getFragmentConfigurationAccess().getStartFragmentAssignment_1_0_0(), "rule__FragmentConfiguration__StartFragmentAssignment_1_0_0");
					put(grammarAccess.getFragmentConfigurationAccess().getRangeAssignment_1_0_1_0(), "rule__FragmentConfiguration__RangeAssignment_1_0_1_0");
					put(grammarAccess.getFragmentConfigurationAccess().getEndFragmentAssignment_1_0_1_1(), "rule__FragmentConfiguration__EndFragmentAssignment_1_0_1_1");
					put(grammarAccess.getFragmentConfigurationAccess().getRangeAssignment_1_1_0(), "rule__FragmentConfiguration__RangeAssignment_1_1_0");
					put(grammarAccess.getFragmentConfigurationAccess().getEndFragmentAssignment_1_1_1(), "rule__FragmentConfiguration__EndFragmentAssignment_1_1_1");
					put(grammarAccess.getFragmentConfigurationAccess().getBodyAssignment_2(), "rule__FragmentConfiguration__BodyAssignment_2");
					put(grammarAccess.getFragmentConfigurationBodyAccess().getPropertiesAssignment_2(), "rule__FragmentConfigurationBody__PropertiesAssignment_2");
					put(grammarAccess.getComponentConfigurationAccess().getComponentAssignment_1(), "rule__ComponentConfiguration__ComponentAssignment_1");
					put(grammarAccess.getComponentConfigurationAccess().getBodyAssignment_2(), "rule__ComponentConfiguration__BodyAssignment_2");
					put(grammarAccess.getComponentConfigurationBodyAccess().getPropertiesAssignment_2(), "rule__ComponentConfigurationBody__PropertiesAssignment_2");
					...
					put(grammarAccess.getComponentPathAccess().getReferencesAssignment_0(), "rule__ComponentPath__ReferencesAssignment_0");
					put(grammarAccess.getComponentPathAccess().getReferencesAssignment_1_1(), "rule__ComponentPath__ReferencesAssignment_1_1");
					put(grammarAccess.getComponentReferenceAccess().getComponentAssignment(), "rule__ComponentReference__ComponentAssignment");
					put(grammarAccess.getBindingAccess().getTargetAssignment_1(), "rule__Binding__TargetAssignment_1");
					put(grammarAccess.getBindingAccess().getSourceAssignment_3(), "rule__Binding__SourceAssignment_3");
					put(grammarAccess.getBindingAccess().getBodyAssignment_4(), "rule__Binding__BodyAssignment_4");
					put(grammarAccess.getBindingResourceReferenceAccess().getResourceDeclarationAssignment_0(), "rule__BindingResourceReference__ResourceDeclarationAssignment_0");
					put(grammarAccess.getBindingResourceReferenceAccess().getSubscriptAssignment_1_1(), "rule__BindingResourceReference__SubscriptAssignment_1_1");
					put(grammarAccess.getBindingBodyAccess().getPropertiesAssignment_2(), "rule__BindingBody__PropertiesAssignment_2");
					put(grammarAccess.getBindingResourceSubscriptAccess().getIndexAssignment(), "rule__BindingResourceSubscript__IndexAssignment");
					...
					put(grammarAccess.getFloatingPointFormatAccess().getKindAssignment(), "rule__FloatingPointFormat__KindAssignment");
					put(grammarAccess.getFixedPointFormatAccess().getUnsignedAssignment_0_0_0_1(), "rule__FixedPointFormat__UnsignedAssignment_0_0_0_1");
					put(grammarAccess.getFixedPointFormatAccess().getIntegerLengthAssignment_0_0_1(), "rule__FixedPointFormat__IntegerLengthAssignment_0_0_1");
					put(grammarAccess.getFixedPointFormatAccess().getFractionLengthAssignment_0_0_2_0_1(), "rule__FixedPointFormat__FractionLengthAssignment_0_0_2_0_1");
					put(grammarAccess.getFixedPointFormatAccess().getSlopeAssignment_0_0_2_1_0_1(), "rule__FixedPointFormat__SlopeAssignment_0_0_2_1_0_1");
					put(grammarAccess.getFixedPointFormatAccess().getBiasAssignment_0_0_2_1_1_1(), "rule__FixedPointFormat__BiasAssignment_0_0_2_1_1_1");
					put(grammarAccess.getFixedPointFormatAccess().getPredefinedKindAssignment_0_1(), "rule__FixedPointFormat__PredefinedKindAssignment_0_1");
					put(grammarAccess.getFixedPointFormatAccess().getSaturateAssignment_1(), "rule__FixedPointFormat__SaturateAssignment_1");
					put(grammarAccess.getNumberFormatMappingAccess().getTypeSpecifierAssignment_1(), "rule__NumberFormatMapping__TypeSpecifierAssignment_1");
					put(grammarAccess.getNumberFormatMappingAccess().getNumberFormatAssignment_3(), "rule__NumberFormatMapping__NumberFormatAssignment_3");
					...
					put(grammarAccess.getUnitDefinitionAccess().getFactorsAssignment_1_1_0(), "rule__UnitDefinition__FactorsAssignment_1_1_0");
					put(grammarAccess.getUnitDefinitionAccess().getFactorsAssignment_1_1_1_1(), "rule__UnitDefinition__FactorsAssignment_1_1_1_1");
					put(grammarAccess.getUnitDefinitionAccess().getFactorsAssignment_2_1_0(), "rule__UnitDefinition__FactorsAssignment_2_1_0");
					put(grammarAccess.getUnitDefinitionAccess().getFactorsAssignment_2_1_1_1(), "rule__UnitDefinition__FactorsAssignment_2_1_1_1");
					put(grammarAccess.getUnitDefinitionAccess().getFactorsAssignment_2_1_1_2_1(), "rule__UnitDefinition__FactorsAssignment_2_1_1_2_1");
					...
					put(grammarAccess.getFunctionDeclarationAccess().getInputParameterDeclarationsAssignment_4_0(), "rule__FunctionDeclaration__InputParameterDeclarationsAssignment_4_0");
					put(grammarAccess.getFunctionDeclarationAccess().getInputParameterDeclarationsAssignment_4_1_1(), "rule__FunctionDeclaration__InputParameterDeclarationsAssignment_4_1_1");
					put(grammarAccess.getFunctionDeclarationAccess().getOutputParameterDeclarationsAssignment_7(), "rule__FunctionDeclaration__OutputParameterDeclarationsAssignment_7");
					put(grammarAccess.getFunctionDeclarationAccess().getOutputParameterDeclarationsAssignment_8_1(), "rule__FunctionDeclaration__OutputParameterDeclarationsAssignment_8_1");
					put(grammarAccess.getFunctionDeclarationAccess().getChecksAssignment_10_0(), "rule__FunctionDeclaration__ChecksAssignment_10_0");
					put(grammarAccess.getFunctionDeclarationAccess().getAssertionsAssignment_10_1(), "rule__FunctionDeclaration__AssertionsAssignment_10_1");
					put(grammarAccess.getFunctionDeclarationAccess().getFunctionAliasDeclarationsAssignment_10_2(), "rule__FunctionDeclaration__FunctionAliasDeclarationsAssignment_10_2");
					put(grammarAccess.getFunctionDeclarationAccess().getStateVariableDeclarationsAssignment_10_3(), "rule__FunctionDeclaration__StateVariableDeclarationsAssignment_10_3");
					put(grammarAccess.getFunctionDeclarationAccess().getConstantDeclarationsAssignment_10_4(), "rule__FunctionDeclaration__ConstantDeclarationsAssignment_10_4");
					put(grammarAccess.getFunctionDeclarationAccess().getEquationsAssignment_10_5(), "rule__FunctionDeclaration__EquationsAssignment_10_5");
					put(grammarAccess.getInputParameterDeclarationAccess().getConstantAssignment_0(), "rule__InputParameterDeclaration__ConstantAssignment_0");
					put(grammarAccess.getInputParameterDeclarationAccess().getNameAssignment_1(), "rule__InputParameterDeclaration__NameAssignment_1");
					...
					put(grammarAccess.getCheckAccess().getOutputTypeSpecifiersAssignment_5(), "rule__Check__OutputTypeSpecifiersAssignment_5");
					put(grammarAccess.getCheckAccess().getOutputTypeSpecifiersAssignment_6_1(), "rule__Check__OutputTypeSpecifiersAssignment_6_1");
					put(grammarAccess.getTypeCheckArgumentAccess().getTypeSpecifierAssignment(), "rule__TypeCheckArgument__TypeSpecifierAssignment");
					put(grammarAccess.getExpressionCheckArgumentAccess().getExpressionAssignment_1(), "rule__ExpressionCheckArgument__ExpressionAssignment_1");
					...
					put(grammarAccess.getImplicitUnitAccess().getFactorsAssignment_1_1_1_0(), "rule__ImplicitUnit__FactorsAssignment_1_1_1_0");
					put(grammarAccess.getImplicitUnitAccess().getFactorsAssignment_1_1_1_1_1(), "rule__ImplicitUnit__FactorsAssignment_1_1_1_1_1");
					put(grammarAccess.getImplicitUnitAccess().getFactorsAssignment_1_2_1_0(), "rule__ImplicitUnit__FactorsAssignment_1_2_1_0");
					put(grammarAccess.getImplicitUnitAccess().getFactorsAssignment_1_2_1_1_1(), "rule__ImplicitUnit__FactorsAssignment_1_2_1_1_1");
					put(grammarAccess.getImplicitUnitAccess().getFactorsAssignment_1_2_1_1_2_1(), "rule__ImplicitUnit__FactorsAssignment_1_2_1_1_2_1");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getAnyAssignment_1_1_0(), "rule__ImplicitUnitWithAny__AnyAssignment_1_1_0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getFactorsAssignment_1_1_1_0_1_0(), "rule__ImplicitUnitWithAny__FactorsAssignment_1_1_1_0_1_0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getFactorsAssignment_1_1_1_0_1_1_1(), "rule__ImplicitUnitWithAny__FactorsAssignment_1_1_1_0_1_1_1");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getFactorsAssignment_1_1_1_1_1_0(), "rule__ImplicitUnitWithAny__FactorsAssignment_1_1_1_1_1_0");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getFactorsAssignment_1_1_1_1_1_1_1(), "rule__ImplicitUnitWithAny__FactorsAssignment_1_1_1_1_1_1_1");
					put(grammarAccess.getImplicitUnitWithAnyAccess().getFactorsAssignment_1_1_1_1_1_1_2_1(), "rule__ImplicitUnitWithAny__FactorsAssignment_1_1_1_1_1_1_2_1");
					put(grammarAccess.getExplicitUnitAccess().getFactorsAssignment_2_1_0(), "rule__ExplicitUnit__FactorsAssignment_2_1_0");
					put(grammarAccess.getExplicitUnitAccess().getFactorsAssignment_2_1_1_1(), "rule__ExplicitUnit__FactorsAssignment_2_1_1_1");
					put(grammarAccess.getExplicitUnitAccess().getFactorsAssignment_3_1_0(), "rule__ExplicitUnit__FactorsAssignment_3_1_0");
					put(grammarAccess.getExplicitUnitAccess().getFactorsAssignment_3_1_1_1(), "rule__ExplicitUnit__FactorsAssignment_3_1_1_1");
					put(grammarAccess.getExplicitUnitAccess().getFactorsAssignment_3_1_1_2_1(), "rule__ExplicitUnit__FactorsAssignment_3_1_1_2_1");
					...
					put(grammarAccess.getUnitDenominatorFactorAccess().getSymbolAssignment_0(), "rule__UnitDenominatorFactor__SymbolAssignment_0");
					put(grammarAccess.getUnitDenominatorFactorAccess().getExponentAssignment_1_1(), "rule__UnitDenominatorFactor__ExponentAssignment_1_1");
				}
			};
		}
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipselabs.damos.dconfig.ui.contentassist.antlr.internal.InternalDconfigParser typedParser = (org.eclipselabs.damos.dconfig.ui.contentassist.antlr.internal.InternalDconfigParser) parser;
