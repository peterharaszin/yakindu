		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSelectionPropertyAccess().getGroup_4(), "rule__SelectionProperty__Group_4__0");
					...
					put(grammarAccess.getBindingTargetPathAccess().getGroup(), "rule__BindingTargetPath__Group__0");
					put(grammarAccess.getBindingTargetPathAccess().getGroup_1(), "rule__BindingTargetPath__Group_1__0");
					put(grammarAccess.getBindingTargetPathAccess().getGroup_4(), "rule__BindingTargetPath__Group_4__0");
					...
					put(grammarAccess.getSelectionPropertyAccess().getNameAssignment_4_1(), "rule__SelectionProperty__NameAssignment_4_1");
					put(grammarAccess.getSelectionPropertyAccess().getBodyAssignment_5(), "rule__SelectionProperty__BodyAssignment_5");
					put(grammarAccess.getSelectionPropertyBodyAccess().getPropertiesAssignment_2(), "rule__SelectionPropertyBody__PropertiesAssignment_2");
					...
					put(grammarAccess.getSystemConfigurationBodyAccess().getBindingsAssignment_2_1(), "rule__SystemConfigurationBody__BindingsAssignment_2_1");
					put(grammarAccess.getSystemConfigurationBodyAccess().getComponentConfigurationsAssignment_2_2(), "rule__SystemConfigurationBody__ComponentConfigurationsAssignment_2_2");
					put(grammarAccess.getSystemConfigurationBodyAccess().getFragmentConfigurationsAssignment_2_3(), "rule__SystemConfigurationBody__FragmentConfigurationsAssignment_2_3");
					put(grammarAccess.getSystemConfigurationBodyAccess().getSubsystemConfigurationsAssignment_2_4(), "rule__SystemConfigurationBody__SubsystemConfigurationsAssignment_2_4");
					...
					put(grammarAccess.getBindingAccess().getTargetPathAssignment_1(), "rule__Binding__TargetPathAssignment_1");
					...
					put(grammarAccess.getBindingTargetPathAccess().getPropertyReferencesAssignment_0(), "rule__BindingTargetPath__PropertyReferencesAssignment_0");
					put(grammarAccess.getBindingTargetPathAccess().getPropertyReferencesAssignment_1_1(), "rule__BindingTargetPath__PropertyReferencesAssignment_1_1");
					put(grammarAccess.getBindingTargetPathAccess().getResourceAssignment_3(), "rule__BindingTargetPath__ResourceAssignment_3");
					put(grammarAccess.getBindingTargetPathAccess().getSubscriptAssignment_4_1(), "rule__BindingTargetPath__SubscriptAssignment_4_1");
					put(grammarAccess.getBindingPropertyReferenceAccess().getPropertyAssignment(), "rule__BindingPropertyReference__PropertyAssignment");
					put(grammarAccess.getBindingBodyAccess().getPropertiesAssignment_2(), "rule__BindingBody__PropertiesAssignment_2");
					put(grammarAccess.getBindingSubscriptAccess().getIndexAssignment(), "rule__BindingSubscript__IndexAssignment");
					...
					put(grammarAccess.getStructDeclarationAccess().getMemberDeclarationsAssignment_3(), "rule__StructDeclaration__MemberDeclarationsAssignment_3");
					...
					put(grammarAccess.getMemberFeatureCallAccess().getIterationVariablesAssignment_1_2_4(), "rule__MemberFeatureCall__IterationVariablesAssignment_1_2_4");
					put(grammarAccess.getMemberFeatureCallAccess().getIterationVariablesAssignment_1_2_5_1(), "rule__MemberFeatureCall__IterationVariablesAssignment_1_2_5_1");
