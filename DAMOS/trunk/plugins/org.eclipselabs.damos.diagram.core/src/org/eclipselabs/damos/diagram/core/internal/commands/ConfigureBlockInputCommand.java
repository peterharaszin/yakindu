 ...
 *
 */
public class ConfigureBlockInputCommand extends ConfigureElementCommand {

	/**
	 * 
	 */
	public ConfigureBlockInputCommand(ConfigureRequest request, EClass configurableType) {
		super(request);
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
    	...
    	BlockInput input = (BlockInput) request.getElementToConfigure();
    	InputDefinition definition = (InputDefinition) request.getParameter(RequestParameterConstants.INPUT_DEFINITION);
