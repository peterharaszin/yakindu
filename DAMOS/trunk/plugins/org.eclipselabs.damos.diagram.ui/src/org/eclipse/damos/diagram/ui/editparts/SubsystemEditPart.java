...
import org.eclipse.damos.diagram.ui.figures.SubsystemFigure;
...
import org.eclipse.damos.dml.util.DMLUtil.SubsystemRealizationType;
...
public class SubsystemEditPart extends StandardComponentEditPart {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.diagram.ui.editparts.BlockEditPart#activate()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.diagram.ui.editparts.BlockEditPart#deactivate()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.diagram.ui.editparts.BlockEditPart#refreshVisuals()
	 */
	@Override
