...
public abstract class AbstractPortLayoutHelper implements IPortLayoutHelper {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.diagram.figures.IPortLayoutHelper#getMaximumTerminalDisplacement(int)
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.diagram.figures.IPortLayoutHelper#getTerminalDisplacement(int, int, int)
	 */
