 ...
 *
 */
public class AddInputPortAction extends DiagramAction {

	/**
	 * @param workbenchPage
	 */
	public AddInputPortAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}
	...
	protected Request createTargetRequest() {
		return new Request(IRequestConstants.REQ_ADD_INPUT_PORT);
	}
