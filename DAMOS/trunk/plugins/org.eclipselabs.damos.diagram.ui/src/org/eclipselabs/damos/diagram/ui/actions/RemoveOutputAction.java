 ...
 *
 */
public class RemoveOutputAction extends DiagramAction {

	/**
	 * @param workbenchPage
	 */
	public RemoveOutputAction(IWorkbenchPage workbenchPage) {
		super(workbenchPage);
	}
	...
	protected Request createTargetRequest() {
		return new Request(IRequestConstants.REQ_REMOVE_OUTPUT);
	}
