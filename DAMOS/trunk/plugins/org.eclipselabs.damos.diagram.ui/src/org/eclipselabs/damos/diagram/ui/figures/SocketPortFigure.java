...
public abstract class SocketPortFigure extends PortFigure {
	...
	/* (non-Javadoc)
	 * @see org.eclipselabs.damos.diagram.ui.figures.PortFigure#getTerminalLocation()
	 */
	@Override
	...
	protected static abstract class SocketTerminalFigure extends PolypointTerminalFigure {
		...
		/* (non-Javadoc)
		 * @see org.eclipselabs.damos.diagram.ui.figures.TerminalFigure#setConnected(boolean)
		 */
		@Override
