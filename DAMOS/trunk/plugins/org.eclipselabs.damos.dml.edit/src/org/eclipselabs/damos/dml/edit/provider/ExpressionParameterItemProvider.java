...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.damos.dml.ExpressionParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExpressionParameterItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DMLPackage.Literals.EXPRESSION_PARAMETER__DEFAULT_EXPRESSION);
			childrenFeatures.add(DMLPackage.Literals.EXPRESSION_PARAMETER__PREDEFINED_EXPRESSIONS);
			childrenFeatures.add(DMLPackage.Literals.EXPRESSION_PARAMETER__DATA_TYPE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DMLPackage.Literals.EXPRESSION_PARAMETER__DEFAULT_EXPRESSION,
				 DMLFactory.eINSTANCE.createExpressionSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(DMLPackage.Literals.EXPRESSION_PARAMETER__PREDEFINED_EXPRESSIONS,
				 DMLFactory.eINSTANCE.createPredefinedExpressionEntry()));

		newChildDescriptors.add
			(createChildParameter
				(DMLPackage.Literals.EXPRESSION_PARAMETER__DATA_TYPE,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == DMLPackage.Literals.PARAMETER__OWNED_DEFAULT_VALUE ||
			childFeature == DMLPackage.Literals.EXPRESSION_PARAMETER__DEFAULT_EXPRESSION;
