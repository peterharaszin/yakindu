...
/**
 * This is the item provider adapter for a {@link org.eclipselabs.damos.dml.QualifiedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class QualifiedElementItemProvider
	 ...
	 * @generated
	 */
	public QualifiedElementItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_QualifiedElement_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_QualifiedElement_name_feature", "_UI_QualifiedElement_type"),
				 DMLPackage.Literals.QUALIFIED_ELEMENT__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((QualifiedElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_QualifiedElement_type") :
			getString("_UI_QualifiedElement_type") + " " + label;
	}
