		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBlockTypeAccess().getGroup(), "rule__BlockType__Group__0");
					...
					put(grammarAccess.getParameterAccess().getGroup_5_3(), "rule__Parameter__Group_5_3__0");
					put(grammarAccess.getParameterPredefinedValueAccess().getGroup(), "rule__ParameterPredefinedValue__Group__0");
					put(grammarAccess.getParameterPredefinedValueAccess().getGroup_1(), "rule__ParameterPredefinedValue__Group_1__0");
					put(grammarAccess.getMscriptBehaviorSpecificationAccess().getGroup(), "rule__MscriptBehaviorSpecification__Group__0");
					put(grammarAccess.getSystemInterfaceAccess().getGroup(), "rule__SystemInterface__Group__0");
					...
					put(grammarAccess.getParameterAccess().getOwnedDefaultValueAssignment_4(), "rule__Parameter__OwnedDefaultValueAssignment_4");
					put(grammarAccess.getParameterAccess().getPredefinedValuesAssignment_5_2(), "rule__Parameter__PredefinedValuesAssignment_5_2");
					put(grammarAccess.getParameterAccess().getPredefinedValuesAssignment_5_3_1(), "rule__Parameter__PredefinedValuesAssignment_5_3_1");
					put(grammarAccess.getParameterPredefinedValueAccess().getValueAssignment_0(), "rule__ParameterPredefinedValue__ValueAssignment_0");
					put(grammarAccess.getParameterPredefinedValueAccess().getAliasAssignment_1_1(), "rule__ParameterPredefinedValue__AliasAssignment_1_1");
					...
					put(grammarAccess.getSystemInterfaceAccess().getNameAssignment_1(), "rule__SystemInterface__NameAssignment_1");
					...
					put(grammarAccess.getInletAccess().getNameAssignment_1(), "rule__Inlet__NameAssignment_1");
					put(grammarAccess.getInletAccess().getDataTypeAssignment_3(), "rule__Inlet__DataTypeAssignment_3");
					put(grammarAccess.getOutletAccess().getNameAssignment_1(), "rule__Outlet__NameAssignment_1");
					put(grammarAccess.getOutletAccess().getDataTypeAssignment_3(), "rule__Outlet__DataTypeAssignment_3");
