...
ruleMscriptDataTypeSpecification
	...
	:
(
{ before(grammarAccess.getMscriptDataTypeSpecificationAccess().getSpecifierAssignment()); }
(rule__MscriptDataTypeSpecification__SpecifierAssignment)
{ after(grammarAccess.getMscriptDataTypeSpecificationAccess().getSpecifierAssignment()); }
)
...
:
(
{ before(grammarAccess.getMscriptDataTypeSpecificationAccess().getSpecifierDataTypeSpecifierParserRuleCall_0()); }
	ruleDataTypeSpecifier{ after(grammarAccess.getMscriptDataTypeSpecificationAccess().getSpecifierDataTypeSpecifierParserRuleCall_0()); }
)
