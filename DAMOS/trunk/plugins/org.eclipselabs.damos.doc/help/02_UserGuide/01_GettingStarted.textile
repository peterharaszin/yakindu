...
# In the *Project Explorer*, select the newly created Damos project and select the menu item *File > New > Folder*: !01_GettingStarted_images/NewModelFolder.png(New Damos Project Wizard)!
...
# Select *Damos > Block Diagram* then click *Next* to start the *New Block Diagram* wizard: !01_GettingStarted_images/NewBlockDiagram.png(New Block Diagram Wizard)!
# Enter a file name (or keep the default) and click *Finish*.
...
!01_GettingStarted_images/BlockDiagramWithBlocks.png(Block diagram with blocks)!
...
* The gain value of the *Gain* block will be set to 10: !01_GettingStarted_images/GainParameters.png(Gain parameters)!
* The gain value of the *Integrator* block will be set to 10(1/s): !01_GettingStarted_images/IntegratorParameters.png(Integrator parameters)!
...
!01_GettingStarted_images/SumInputPortSign.png(Sum input port sign)!
...
!01_GettingStarted_images/SumInputPortArrangement.png(Sum input port port arrangement)!
...
!01_GettingStarted_images/FinalBlockDiagram.png(Final block diagram)!

h2. Simulating the Model

The easiest way to simulate the model is by setting the focus on the block diagram editor, and then clicking the *Run* (!01_GettingStarted_images/run_exc.gif!) icon in the toolbar. This will create a new simulation run configuration for the focused block diagram, and start the simulation. The simulation result will be shown in the *Simulation* view:

!01_GettingStarted_images/SimulationResult.png(Simulation result)!
...
!01_GettingStarted_images/SimulationRunConfiguration.png(Simulation run configuration)!
