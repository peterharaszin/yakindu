...
# Select *Damos > Damos Project* and then click *Next* to start the *New Damos Project* wizard: !01_CreatingModel_images/NewDamosProject.png(New Damos Project Wizard)!
...
# Select *Damos > Block Diagram* and then click *Next* to start the *New Block Diagram* wizard: !01_CreatingModel_images/NewBlockDiagram.png(New Block Diagram Wizard)!
...
If you need more control over the simulation, you can define a _simulation model_, which will directly be passed to the simulator by the simulation launcher. See the topic _Concepts_ for more information on the simulation model.