...
public class DscriptParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipselabs.damos.dscript.ui.contentassist.antlr.internal.InternalDscriptParser createParser() {
		org.eclipselabs.damos.dscript.ui.contentassist.antlr.internal.InternalDscriptParser result = new org.eclipselabs.damos.dscript.ui.contentassist.antlr.internal.InternalDscriptParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBehaviorDeclarationAccess().getAlternatives_3(), "rule__BehaviorDeclaration__Alternatives_3");
					...
					put(grammarAccess.getStandardFunctionDeclarationAccess().getAlternatives_10(), "rule__StandardFunctionDeclaration__Alternatives_10");
					...
					put(grammarAccess.getDscriptBlockTypeAccess().getGroup(), "rule__DscriptBlockType__Group__0");
					put(grammarAccess.getDscriptBlockTypeAccess().getGroup_11(), "rule__DscriptBlockType__Group_11__0");
					put(grammarAccess.getDscriptInputDefinitionAccess().getGroup(), "rule__DscriptInputDefinition__Group__0");
					put(grammarAccess.getDscriptInputDefinitionAccess().getGroup_3(), "rule__DscriptInputDefinition__Group_3__0");
					put(grammarAccess.getDscriptInputDefinitionAccess().getGroup_3_4(), "rule__DscriptInputDefinition__Group_3_4__0");
					put(grammarAccess.getDscriptInputDefinitionAccess().getGroup_4(), "rule__DscriptInputDefinition__Group_4__0");
					put(grammarAccess.getDscriptInputDefinitionAccess().getGroup_4_1_0(), "rule__DscriptInputDefinition__Group_4_1_0__0");
					put(grammarAccess.getBooleanDirectFeedthroughPolicyAccess().getGroup(), "rule__BooleanDirectFeedthroughPolicy__Group__0");
					put(grammarAccess.getDscriptOutputDefinitionAccess().getGroup(), "rule__DscriptOutputDefinition__Group__0");
					put(grammarAccess.getDscriptOutputDefinitionAccess().getGroup_3(), "rule__DscriptOutputDefinition__Group_3__0");
					put(grammarAccess.getDscriptOutputDefinitionAccess().getGroup_3_4(), "rule__DscriptOutputDefinition__Group_3_4__0");
					put(grammarAccess.getDscriptOutputDefinitionAccess().getGroup_4(), "rule__DscriptOutputDefinition__Group_4__0");
					...
					put(grammarAccess.getDscriptParameterAccess().getGroup(), "rule__DscriptParameter__Group__0");
					put(grammarAccess.getDscriptParameterAccess().getGroup_5(), "rule__DscriptParameter__Group_5__0");
					put(grammarAccess.getDscriptParameterAccess().getGroup_5_3(), "rule__DscriptParameter__Group_5_3__0");
					...
					put(grammarAccess.getDscriptParameterPredefinedValueAccess().getGroup(), "rule__DscriptParameterPredefinedValue__Group__0");
					put(grammarAccess.getDscriptParameterPredefinedValueAccess().getGroup_1(), "rule__DscriptParameterPredefinedValue__Group_1__0");
					put(grammarAccess.getBehaviorDeclarationAccess().getGroup(), "rule__BehaviorDeclaration__Group__0");
					put(grammarAccess.getDscriptSystemInterfaceAccess().getGroup(), "rule__DscriptSystemInterface__Group__0");
					...
					put(grammarAccess.getStandardFunctionDeclarationAccess().getGroup(), "rule__StandardFunctionDeclaration__Group__0");
					put(grammarAccess.getStandardFunctionDeclarationAccess().getGroup_4(), "rule__StandardFunctionDeclaration__Group_4__0");
					...
					put(grammarAccess.getDscriptBlockTypeAccess().getPackageNameAssignment_1(), "rule__DscriptBlockType__PackageNameAssignment_1");
					put(grammarAccess.getDscriptBlockTypeAccess().getImportDeclarationsAssignment_2(), "rule__DscriptBlockType__ImportDeclarationsAssignment_2");
					put(grammarAccess.getDscriptBlockTypeAccess().getTimingAssignment_3_0(), "rule__DscriptBlockType__TimingAssignment_3_0");
					put(grammarAccess.getDscriptBlockTypeAccess().getBoundaryAssignment_3_1(), "rule__DscriptBlockType__BoundaryAssignment_3_1");
					put(grammarAccess.getDscriptBlockTypeAccess().getNameAssignment_5(), "rule__DscriptBlockType__NameAssignment_5");
					put(grammarAccess.getDscriptBlockTypeAccess().getInputDefinitionsAssignment_7(), "rule__DscriptBlockType__InputDefinitionsAssignment_7");
					put(grammarAccess.getDscriptBlockTypeAccess().getOutputDefinitionsAssignment_8(), "rule__DscriptBlockType__OutputDefinitionsAssignment_8");
					put(grammarAccess.getDscriptBlockTypeAccess().getParametersAssignment_9(), "rule__DscriptBlockType__ParametersAssignment_9");
					put(grammarAccess.getDscriptBlockTypeAccess().getDeclarationsAssignment_10(), "rule__DscriptBlockType__DeclarationsAssignment_10");
					put(grammarAccess.getDscriptBlockTypeAccess().getBehaviorAssignment_11_0(), "rule__DscriptBlockType__BehaviorAssignment_11_0");
					put(grammarAccess.getDscriptBlockTypeAccess().getDeclarationsAssignment_11_1(), "rule__DscriptBlockType__DeclarationsAssignment_11_1");
					put(grammarAccess.getDscriptInputDefinitionAccess().getSocketAssignment_0_0(), "rule__DscriptInputDefinition__SocketAssignment_0_0");
					put(grammarAccess.getDscriptInputDefinitionAccess().getTestPointAssignment_0_1(), "rule__DscriptInputDefinition__TestPointAssignment_0_1");
					put(grammarAccess.getDscriptInputDefinitionAccess().getNameAssignment_2(), "rule__DscriptInputDefinition__NameAssignment_2");
					put(grammarAccess.getDscriptInputDefinitionAccess().getMinimumPortCountAssignment_3_1(), "rule__DscriptInputDefinition__MinimumPortCountAssignment_3_1");
					put(grammarAccess.getDscriptInputDefinitionAccess().getMaximumPortCountAssignment_3_3(), "rule__DscriptInputDefinition__MaximumPortCountAssignment_3_3");
					put(grammarAccess.getDscriptInputDefinitionAccess().getDefaultPortCountAssignment_3_4_1(), "rule__DscriptInputDefinition__DefaultPortCountAssignment_3_4_1");
					put(grammarAccess.getDscriptInputDefinitionAccess().getDirectFeedthroughPolicyAssignment_4_1_0_1(), "rule__DscriptInputDefinition__DirectFeedthroughPolicyAssignment_4_1_0_1");
					put(grammarAccess.getDscriptInputDefinitionAccess().getParametersAssignment_4_1_1(), "rule__DscriptInputDefinition__ParametersAssignment_4_1_1");
					...
					put(grammarAccess.getDscriptOutputDefinitionAccess().getSocketAssignment_0_0(), "rule__DscriptOutputDefinition__SocketAssignment_0_0");
					put(grammarAccess.getDscriptOutputDefinitionAccess().getTestPointAssignment_0_1(), "rule__DscriptOutputDefinition__TestPointAssignment_0_1");
					put(grammarAccess.getDscriptOutputDefinitionAccess().getNameAssignment_2(), "rule__DscriptOutputDefinition__NameAssignment_2");
					put(grammarAccess.getDscriptOutputDefinitionAccess().getMinimumPortCountAssignment_3_1(), "rule__DscriptOutputDefinition__MinimumPortCountAssignment_3_1");
					put(grammarAccess.getDscriptOutputDefinitionAccess().getMaximumPortCountAssignment_3_3(), "rule__DscriptOutputDefinition__MaximumPortCountAssignment_3_3");
					put(grammarAccess.getDscriptOutputDefinitionAccess().getDefaultPortCountAssignment_3_4_1(), "rule__DscriptOutputDefinition__DefaultPortCountAssignment_3_4_1");
					put(grammarAccess.getDscriptOutputDefinitionAccess().getParametersAssignment_4_1(), "rule__DscriptOutputDefinition__ParametersAssignment_4_1");
					...
					put(grammarAccess.getDscriptParameterAccess().getVisibilityAssignment_0(), "rule__DscriptParameter__VisibilityAssignment_0");
					put(grammarAccess.getDscriptParameterAccess().getNameAssignment_2(), "rule__DscriptParameter__NameAssignment_2");
					put(grammarAccess.getDscriptParameterAccess().getOwnedDefaultValueAssignment_4(), "rule__DscriptParameter__OwnedDefaultValueAssignment_4");
					put(grammarAccess.getDscriptParameterAccess().getPredefinedValuesAssignment_5_2(), "rule__DscriptParameter__PredefinedValuesAssignment_5_2");
					put(grammarAccess.getDscriptParameterAccess().getPredefinedValuesAssignment_5_3_1(), "rule__DscriptParameter__PredefinedValuesAssignment_5_3_1");
					...
					put(grammarAccess.getDscriptParameterPredefinedValueAccess().getValueAssignment_0(), "rule__DscriptParameterPredefinedValue__ValueAssignment_0");
					put(grammarAccess.getDscriptParameterPredefinedValueAccess().getAliasAssignment_1_1(), "rule__DscriptParameterPredefinedValue__AliasAssignment_1_1");
					put(grammarAccess.getBehaviorDeclarationAccess().getChecksAssignment_3_0(), "rule__BehaviorDeclaration__ChecksAssignment_3_0");
					put(grammarAccess.getBehaviorDeclarationAccess().getAssertionsAssignment_3_1(), "rule__BehaviorDeclaration__AssertionsAssignment_3_1");
					put(grammarAccess.getBehaviorDeclarationAccess().getStateVariableDeclarationsAssignment_3_2(), "rule__BehaviorDeclaration__StateVariableDeclarationsAssignment_3_2");
					put(grammarAccess.getBehaviorDeclarationAccess().getConstantDeclarationsAssignment_3_3(), "rule__BehaviorDeclaration__ConstantDeclarationsAssignment_3_3");
					put(grammarAccess.getBehaviorDeclarationAccess().getEquationsAssignment_3_4(), "rule__BehaviorDeclaration__EquationsAssignment_3_4");
					...
					put(grammarAccess.getDscriptValueSpecificationAccess().getExpressionAssignment(), "rule__DscriptValueSpecification__ExpressionAssignment");
					put(grammarAccess.getDscriptSystemInterfaceAccess().getPackageNameAssignment_1(), "rule__DscriptSystemInterface__PackageNameAssignment_1");
					put(grammarAccess.getDscriptSystemInterfaceAccess().getImportDeclarationsAssignment_2(), "rule__DscriptSystemInterface__ImportDeclarationsAssignment_2");
					put(grammarAccess.getDscriptSystemInterfaceAccess().getNameAssignment_4(), "rule__DscriptSystemInterface__NameAssignment_4");
					put(grammarAccess.getDscriptSystemInterfaceAccess().getInletsAssignment_6(), "rule__DscriptSystemInterface__InletsAssignment_6");
					put(grammarAccess.getDscriptSystemInterfaceAccess().getOutletsAssignment_7(), "rule__DscriptSystemInterface__OutletsAssignment_7");
					...
					put(grammarAccess.getDscriptDataTypeSpecificationAccess().getTypeSpecifierAssignment(), "rule__DscriptDataTypeSpecification__TypeSpecifierAssignment");
					...
					put(grammarAccess.getStandardFunctionDeclarationAccess().getKindAssignment_0(), "rule__StandardFunctionDeclaration__KindAssignment_0");
					put(grammarAccess.getStandardFunctionDeclarationAccess().getNameAssignment_2(), "rule__StandardFunctionDeclaration__NameAssignment_2");
					put(grammarAccess.getStandardFunctionDeclarationAccess().getInputParameterDeclarationsAssignment_4_0(), "rule__StandardFunctionDeclaration__InputParameterDeclarationsAssignment_4_0");
					put(grammarAccess.getStandardFunctionDeclarationAccess().getInputParameterDeclarationsAssignment_4_1_1(), "rule__StandardFunctionDeclaration__InputParameterDeclarationsAssignment_4_1_1");
					put(grammarAccess.getStandardFunctionDeclarationAccess().getOutputParameterDeclarationsAssignment_7(), "rule__StandardFunctionDeclaration__OutputParameterDeclarationsAssignment_7");
					put(grammarAccess.getStandardFunctionDeclarationAccess().getOutputParameterDeclarationsAssignment_8_1(), "rule__StandardFunctionDeclaration__OutputParameterDeclarationsAssignment_8_1");
					put(grammarAccess.getStandardFunctionDeclarationAccess().getChecksAssignment_10_0(), "rule__StandardFunctionDeclaration__ChecksAssignment_10_0");
					put(grammarAccess.getStandardFunctionDeclarationAccess().getAssertionsAssignment_10_1(), "rule__StandardFunctionDeclaration__AssertionsAssignment_10_1");
					put(grammarAccess.getStandardFunctionDeclarationAccess().getStateVariableDeclarationsAssignment_10_2(), "rule__StandardFunctionDeclaration__StateVariableDeclarationsAssignment_10_2");
					put(grammarAccess.getStandardFunctionDeclarationAccess().getConstantDeclarationsAssignment_10_3(), "rule__StandardFunctionDeclaration__ConstantDeclarationsAssignment_10_3");
					...
					put(grammarAccess.getDscriptBlockTypeAccess().getUnorderedGroup_3(), "rule__DscriptBlockType__UnorderedGroup_3");
					put(grammarAccess.getDscriptInputDefinitionAccess().getUnorderedGroup_0(), "rule__DscriptInputDefinition__UnorderedGroup_0");
					put(grammarAccess.getDscriptInputDefinitionAccess().getUnorderedGroup_4_1(), "rule__DscriptInputDefinition__UnorderedGroup_4_1");
					put(grammarAccess.getDscriptOutputDefinitionAccess().getUnorderedGroup_0(), "rule__DscriptOutputDefinition__UnorderedGroup_0");
				}
			};
		}
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipselabs.damos.dscript.ui.contentassist.antlr.internal.InternalDscriptParser typedParser = (org.eclipselabs.damos.dscript.ui.contentassist.antlr.internal.InternalDscriptParser) parser;
