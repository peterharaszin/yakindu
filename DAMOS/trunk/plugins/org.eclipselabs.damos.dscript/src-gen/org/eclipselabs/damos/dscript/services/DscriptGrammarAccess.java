...
package org.eclipselabs.damos.dscript.services;
...
@Singleton
public class DscriptGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class RootElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cBlockTypesDscriptBlockTypeParserRuleCall_0_0 = (RuleCall)cBlockTypesAssignment_0.eContents().get(0);
		private final Assignment cSystemInterfacesAssignment_1 = (Assignment)cAlternatives.eContents().get(1);
		private final RuleCall cSystemInterfacesDscriptSystemInterfaceParserRuleCall_1_0 = (RuleCall)cSystemInterfacesAssignment_1.eContents().get(0);
		...
		//blockTypes+=DscriptBlockType
		public Assignment getBlockTypesAssignment_0() { return cBlockTypesAssignment_0; }

		//DscriptBlockType
		public RuleCall getBlockTypesDscriptBlockTypeParserRuleCall_0_0() { return cBlockTypesDscriptBlockTypeParserRuleCall_0_0; }

		//systemInterfaces+=DscriptSystemInterface
		public Assignment getSystemInterfacesAssignment_1() { return cSystemInterfacesAssignment_1; }

		//DscriptSystemInterface
		public RuleCall getSystemInterfacesDscriptSystemInterfaceParserRuleCall_1_0() { return cSystemInterfacesDscriptSystemInterfaceParserRuleCall_1_0; }
	}

	public class DscriptBlockTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "DscriptBlockType");
		...
		private final RuleCall cInputDefinitionsDscriptInputDefinitionParserRuleCall_7_0 = (RuleCall)cInputDefinitionsAssignment_7.eContents().get(0);
		private final Assignment cOutputDefinitionsAssignment_8 = (Assignment)cGroup.eContents().get(8);
		private final RuleCall cOutputDefinitionsDscriptOutputDefinitionParserRuleCall_8_0 = (RuleCall)cOutputDefinitionsAssignment_8.eContents().get(0);
		...
		private final Assignment cBehaviorAssignment_11_0 = (Assignment)cGroup_11.eContents().get(0);
		private final RuleCall cBehaviorBehaviorDeclarationParserRuleCall_11_0_0 = (RuleCall)cBehaviorAssignment_11_0.eContents().get(0);
		private final Assignment cDeclarationsAssignment_11_1 = (Assignment)cGroup_11.eContents().get(1);
		private final RuleCall cDeclarationsTopLevelDeclarationParserRuleCall_11_1_0 = (RuleCall)cDeclarationsAssignment_11_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_12 = (Keyword)cGroup.eContents().get(12);
		
		//DscriptBlockType:
		//	"package" packageName=QualifiedName importDeclarations+=ImportDeclaration* (timing=TimingKind? &
		//	boundary?="boundary"?) "blockType" name=ValidID "{" inputDefinitions+=DscriptInputDefinition*
		//	outputDefinitions+=DscriptOutputDefinition* parameters+=Parameter* declarations+=TopLevelDeclaration*
		//	(behavior=BehaviorDeclaration declarations+=TopLevelDeclaration*)? "}";
		public ParserRule getRule() { return rule; }

		//"package" packageName=QualifiedName importDeclarations+=ImportDeclaration* (timing=TimingKind? & boundary?="boundary"?)
		//"blockType" name=ValidID "{" inputDefinitions+=DscriptInputDefinition* outputDefinitions+=DscriptOutputDefinition*
		//parameters+=Parameter* declarations+=TopLevelDeclaration* (behavior=BehaviorDeclaration
		...
		public RuleCall getInputDefinitionsDscriptInputDefinitionParserRuleCall_7_0() { return cInputDefinitionsDscriptInputDefinitionParserRuleCall_7_0; }
		...
		public RuleCall getOutputDefinitionsDscriptOutputDefinitionParserRuleCall_8_0() { return cOutputDefinitionsDscriptOutputDefinitionParserRuleCall_8_0; }
		...
		public Assignment getBehaviorAssignment_11_0() { return cBehaviorAssignment_11_0; }

		//BehaviorDeclaration
		public RuleCall getBehaviorBehaviorDeclarationParserRuleCall_11_0_0() { return cBehaviorBehaviorDeclarationParserRuleCall_11_0_0; }

		//declarations+=TopLevelDeclaration*
		public Assignment getDeclarationsAssignment_11_1() { return cDeclarationsAssignment_11_1; }

		//TopLevelDeclaration
		public RuleCall getDeclarationsTopLevelDeclarationParserRuleCall_11_1_0() { return cDeclarationsTopLevelDeclarationParserRuleCall_11_1_0; }

		//"}"
		public Keyword getRightCurlyBracketKeyword_12() { return cRightCurlyBracketKeyword_12; }
	}

	public class DscriptInputDefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "DscriptInputDefinition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DscriptOutputDefinitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "DscriptOutputDefinition");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final UnorderedGroup cUnorderedGroup_0 = (UnorderedGroup)cGroup.eContents().get(0);
		private final Assignment cSocketAssignment_0_0 = (Assignment)cUnorderedGroup_0.eContents().get(0);
		private final Keyword cSocketSocketKeyword_0_0_0 = (Keyword)cSocketAssignment_0_0.eContents().get(0);
	...
	public class ParameterElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cDscriptParameterParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		//DscriptParameter
		public RuleCall getDscriptParameterParserRuleCall_1() { return cDscriptParameterParserRuleCall_1; }
	}
	...
	public class DscriptParameterElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "DscriptParameter");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cVisibilityAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cVisibilityParameterVisibilityKindEnumRuleCall_0_0 = (RuleCall)cVisibilityAssignment_0.eContents().get(0);
		...
		private final RuleCall cOwnedDefaultValueDscriptValueSpecificationParserRuleCall_4_0 = (RuleCall)cOwnedDefaultValueAssignment_4.eContents().get(0);
		...
		private final RuleCall cPredefinedValuesDscriptParameterPredefinedValueParserRuleCall_5_2_0 = (RuleCall)cPredefinedValuesAssignment_5_2.eContents().get(0);
		...
		private final RuleCall cPredefinedValuesDscriptParameterPredefinedValueParserRuleCall_5_3_1_0 = (RuleCall)cPredefinedValuesAssignment_5_3_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_5_4 = (Keyword)cGroup_5.eContents().get(4);
		
		//DscriptParameter:
		//	visibility=ParameterVisibilityKind? "parameter" name=ValidID "=" ownedDefaultValue=DscriptValueSpecification
		//	("predefined" "{" predefinedValues+=DscriptParameterPredefinedValue (","
		//	predefinedValues+=DscriptParameterPredefinedValue)* "}")?;
		public ParserRule getRule() { return rule; }
		...
		//ownedDefaultValue=DscriptValueSpecification
		public Assignment getOwnedDefaultValueAssignment_4() { return cOwnedDefaultValueAssignment_4; }

		//DscriptValueSpecification
		public RuleCall getOwnedDefaultValueDscriptValueSpecificationParserRuleCall_4_0() { return cOwnedDefaultValueDscriptValueSpecificationParserRuleCall_4_0; }
		...
		public RuleCall getPredefinedValuesDscriptParameterPredefinedValueParserRuleCall_5_2_0() { return cPredefinedValuesDscriptParameterPredefinedValueParserRuleCall_5_2_0; }
		...
		//DscriptParameterPredefinedValue
		public RuleCall getPredefinedValuesDscriptParameterPredefinedValueParserRuleCall_5_3_1_0() { return cPredefinedValuesDscriptParameterPredefinedValueParserRuleCall_5_3_1_0; }
	...
	public class DscriptParameterPredefinedValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "DscriptParameterPredefinedValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cValueAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cValueDscriptValueSpecificationParserRuleCall_0_0 = (RuleCall)cValueAssignment_0.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Keyword cAliasKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final Assignment cAliasAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final RuleCall cAliasSTRINGTerminalRuleCall_1_1_0 = (RuleCall)cAliasAssignment_1_1.eContents().get(0);
		...
		//value=DscriptValueSpecification
		public Assignment getValueAssignment_0() { return cValueAssignment_0; }

		//DscriptValueSpecification
		public RuleCall getValueDscriptValueSpecificationParserRuleCall_0_0() { return cValueDscriptValueSpecificationParserRuleCall_0_0; }
	...
	public class BehaviorDeclarationElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cBehaviorDeclarationAction_0 = (Action)cGroup.eContents().get(0);
		private final Keyword cBehaviorKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Keyword cLeftCurlyBracketKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Alternatives cAlternatives_3 = (Alternatives)cGroup.eContents().get(3);
		private final Assignment cChecksAssignment_3_0 = (Assignment)cAlternatives_3.eContents().get(0);
		private final RuleCall cChecksCheckParserRuleCall_3_0_0 = (RuleCall)cChecksAssignment_3_0.eContents().get(0);
		private final Assignment cAssertionsAssignment_3_1 = (Assignment)cAlternatives_3.eContents().get(1);
		private final RuleCall cAssertionsAssertionParserRuleCall_3_1_0 = (RuleCall)cAssertionsAssignment_3_1.eContents().get(0);
		private final Assignment cStateVariableDeclarationsAssignment_3_2 = (Assignment)cAlternatives_3.eContents().get(2);
		private final RuleCall cStateVariableDeclarationsStateVariableDeclarationParserRuleCall_3_2_0 = (RuleCall)cStateVariableDeclarationsAssignment_3_2.eContents().get(0);
		private final Assignment cConstantDeclarationsAssignment_3_3 = (Assignment)cAlternatives_3.eContents().get(3);
		private final RuleCall cConstantDeclarationsConstantDeclarationParserRuleCall_3_3_0 = (RuleCall)cConstantDeclarationsAssignment_3_3.eContents().get(0);
		private final Assignment cEquationsAssignment_3_4 = (Assignment)cAlternatives_3.eContents().get(4);
		private final RuleCall cEquationsEquationParserRuleCall_3_4_0 = (RuleCall)cEquationsAssignment_3_4.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_4 = (Keyword)cGroup.eContents().get(4);
		
		//BehaviorDeclaration:
		//	{BehaviorDeclaration} "behavior" "{" (checks+=Check | assertions+=Assertion |
		...
		//{BehaviorDeclaration}
		public Action getBehaviorDeclarationAction_0() { return cBehaviorDeclarationAction_0; }
		...
		//checks+=Check
		public Assignment getChecksAssignment_3_0() { return cChecksAssignment_3_0; }

		//Check
		public RuleCall getChecksCheckParserRuleCall_3_0_0() { return cChecksCheckParserRuleCall_3_0_0; }
		...
		public Assignment getStateVariableDeclarationsAssignment_3_2() { return cStateVariableDeclarationsAssignment_3_2; }

		//StateVariableDeclaration
		public RuleCall getStateVariableDeclarationsStateVariableDeclarationParserRuleCall_3_2_0() { return cStateVariableDeclarationsStateVariableDeclarationParserRuleCall_3_2_0; }

		//constantDeclarations+=ConstantDeclaration
		public Assignment getConstantDeclarationsAssignment_3_3() { return cConstantDeclarationsAssignment_3_3; }

		//ConstantDeclaration
		public RuleCall getConstantDeclarationsConstantDeclarationParserRuleCall_3_3_0() { return cConstantDeclarationsConstantDeclarationParserRuleCall_3_3_0; }

		//equations+=Equation
		public Assignment getEquationsAssignment_3_4() { return cEquationsAssignment_3_4; }

		//Equation
		public RuleCall getEquationsEquationParserRuleCall_3_4_0() { return cEquationsEquationParserRuleCall_3_4_0; }
	...
	public class DscriptValueSpecificationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "DscriptValueSpecification");
	...
	public class DscriptSystemInterfaceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "DscriptSystemInterface");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cPackageKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cPackageNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cPackageNameQualifiedNameParserRuleCall_1_0 = (RuleCall)cPackageNameAssignment_1.eContents().get(0);
	...
	public class InletElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cDataTypeAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cDataTypeDscriptDataTypeSpecificationParserRuleCall_1_0 = (RuleCall)cDataTypeAssignment_1.eContents().get(0);
		private final Assignment cNameAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cNameValidIDParserRuleCall_2_0 = (RuleCall)cNameAssignment_2.eContents().get(0);
		...
		//dataType=DscriptDataTypeSpecification
		public Assignment getDataTypeAssignment_1() { return cDataTypeAssignment_1; }

		//DscriptDataTypeSpecification
		public RuleCall getDataTypeDscriptDataTypeSpecificationParserRuleCall_1_0() { return cDataTypeDscriptDataTypeSpecificationParserRuleCall_1_0; }
	...
	public class DscriptDataTypeSpecificationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "DscriptDataTypeSpecification");
	...
	private DscriptBlockTypeElements pDscriptBlockType;
	private TimingKindElements unknownRuleTimingKind;
	private DscriptInputDefinitionElements pDscriptInputDefinition;
	...
	private DscriptOutputDefinitionElements pDscriptOutputDefinition;
	private ParameterElements pParameter;
	private OpaqueParameterElements pOpaqueParameter;
	private DscriptParameterElements pDscriptParameter;
	private OpaqueParameterPredefinedValueElements pOpaqueParameterPredefinedValue;
	private DscriptParameterPredefinedValueElements pDscriptParameterPredefinedValue;
	...
	private DscriptValueSpecificationElements pDscriptValueSpecification;
	private DscriptSystemInterfaceElements pDscriptSystemInterface;
	private InletElements pInlet;
	private OutletElements pOutlet;
	private DscriptDataTypeSpecificationElements pDscriptDataTypeSpecification;
	...
	@Inject
	public DscriptGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eclipselabs.damos.dscript.Dscript".equals(grammar.getName())) {
				return grammar;
			}
	...
	//	outputDefinitions+=DscriptOutputDefinition* parameters+=Parameter* declarations+=TopLevelDeclaration*
	//	(behavior=BehaviorDeclaration declarations+=TopLevelDeclaration*)? "}";
	public DscriptBlockTypeElements getDscriptBlockTypeAccess() {
		return (pDscriptBlockType != null) ? pDscriptBlockType : (pDscriptBlockType = new DscriptBlockTypeElements());
	}
	
	public ParserRule getDscriptBlockTypeRule() {
		return getDscriptBlockTypeAccess().getRule();
	}
	...
	//	maximumPortCount=UpperBoundLiteral ("|" defaultPortCount=ValidInt)? "]")? ("{" (("directFeedthrough"
	//	directFeedthroughPolicy=DirectFeedthroughPolicy)? & parameters+=Parameter*) "}")?;
	public DscriptInputDefinitionElements getDscriptInputDefinitionAccess() {
		return (pDscriptInputDefinition != null) ? pDscriptInputDefinition : (pDscriptInputDefinition = new DscriptInputDefinitionElements());
	}
	
	public ParserRule getDscriptInputDefinitionRule() {
		return getDscriptInputDefinitionAccess().getRule();
	}
	...
	//	(socket?="socket"? & testPoint?="testPoint"?) "output" name=ValidID ("[" minimumPortCount=ValidInt ".."
	//	maximumPortCount=UpperBoundLiteral ("|" defaultPortCount=ValidInt)? "]")? ("{" parameters+=Parameter* "}")?;
	public DscriptOutputDefinitionElements getDscriptOutputDefinitionAccess() {
		return (pDscriptOutputDefinition != null) ? pDscriptOutputDefinition : (pDscriptOutputDefinition = new DscriptOutputDefinitionElements());
	}
	
	public ParserRule getDscriptOutputDefinitionRule() {
		return getDscriptOutputDefinitionAccess().getRule();
	}
	...
	//	("predefined" "{" predefinedValues+=DscriptParameterPredefinedValue (","
	//	predefinedValues+=DscriptParameterPredefinedValue)* "}")?;
	public DscriptParameterElements getDscriptParameterAccess() {
		return (pDscriptParameter != null) ? pDscriptParameter : (pDscriptParameter = new DscriptParameterElements());
	}
	
	public ParserRule getDscriptParameterRule() {
		return getDscriptParameterAccess().getRule();
	}
	...
	//DscriptParameterPredefinedValue returns ParameterPredefinedValue:
	//	value=DscriptValueSpecification ("alias" alias=STRING)?;
	public DscriptParameterPredefinedValueElements getDscriptParameterPredefinedValueAccess() {
		return (pDscriptParameterPredefinedValue != null) ? pDscriptParameterPredefinedValue : (pDscriptParameterPredefinedValue = new DscriptParameterPredefinedValueElements());
	}
	
	public ParserRule getDscriptParameterPredefinedValueRule() {
		return getDscriptParameterPredefinedValueAccess().getRule();
	}
	...
	//DscriptValueSpecification:
	//	expression=Expression;
	public DscriptValueSpecificationElements getDscriptValueSpecificationAccess() {
		return (pDscriptValueSpecification != null) ? pDscriptValueSpecification : (pDscriptValueSpecification = new DscriptValueSpecificationElements());
	}
	
	public ParserRule getDscriptValueSpecificationRule() {
		return getDscriptValueSpecificationAccess().getRule();
	}

	//DscriptSystemInterface:
	//	"package" packageName=QualifiedName importDeclarations+=ImportDeclaration* "systemInterface" name=ValidID "{"
	//	inlets+=Inlet* outlets+=Outlet* "}";
	public DscriptSystemInterfaceElements getDscriptSystemInterfaceAccess() {
		return (pDscriptSystemInterface != null) ? pDscriptSystemInterface : (pDscriptSystemInterface = new DscriptSystemInterfaceElements());
	}
	
	public ParserRule getDscriptSystemInterfaceRule() {
		return getDscriptSystemInterfaceAccess().getRule();
	}
	...
	//DscriptDataTypeSpecification:
	//	typeSpecifier=TypeSpecifier;
	public DscriptDataTypeSpecificationElements getDscriptDataTypeSpecificationAccess() {
		return (pDscriptDataTypeSpecification != null) ? pDscriptDataTypeSpecification : (pDscriptDataTypeSpecification = new DscriptDataTypeSpecificationElements());
	}
	
	public ParserRule getDscriptDataTypeSpecificationRule() {
		return getDscriptDataTypeSpecificationAccess().getRule();
	}
	...
	public MscriptGrammarAccess.DerivedUnitDeclarationElements getDerivedUnitDeclarationAccess() {
		return gaMscript.getDerivedUnitDeclarationAccess();
	}
	...
	//	stateVariableDeclarations+=StateVariableDeclaration | constantDeclarations+=ConstantDeclaration |
	//	equations+=Equation)* "}";
	public MscriptGrammarAccess.StandardFunctionDeclarationElements getStandardFunctionDeclarationAccess() {
		return gaMscript.getStandardFunctionDeclarationAccess();
	}
	...
	//	name=ValidID;
	public MscriptGrammarAccess.StandardOutputParameterDeclarationElements getStandardOutputParameterDeclarationAccess() {
		return gaMscript.getStandardOutputParameterDeclarationAccess();
	}
	...
	public MscriptGrammarAccess.CallablePrimaryExpressionElements getCallablePrimaryExpressionAccess() {
		return gaMscript.getCallablePrimaryExpressionAccess();
	}
