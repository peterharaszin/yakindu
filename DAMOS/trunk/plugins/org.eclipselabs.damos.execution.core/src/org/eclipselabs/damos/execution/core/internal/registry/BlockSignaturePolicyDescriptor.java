...
package org.eclipselabs.damos.execution.core.internal.registry;
...
public class BlockSignaturePolicyDescriptor {
	...
	public IComponentSignaturePolicy createObject() {
		...
		try {
			return (IComponentSignaturePolicy) clazz.newInstance();
	...
	private void loadClass() {
		...
		try {
			...
			if (!IComponentSignaturePolicy.class.isAssignableFrom(clazz)) {
				log("Class must implement 'BlockSignaturePolicy' interface");
				return;
			}
