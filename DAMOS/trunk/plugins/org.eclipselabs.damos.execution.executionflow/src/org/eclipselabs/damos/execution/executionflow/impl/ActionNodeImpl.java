 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.execution.executionflow.impl.ActionNodeImpl#getChoiceNode <em>Choice Node</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionNodeImpl extends CompoundNodeImpl implements ActionNode {
	...
	protected EClass eStaticClass() {
		return ExecutionFlowPackage.Literals.ACTION_NODE;
	}
		...
		if (choiceNode != null && choiceNode.eIsProxy()) {
			...
			if (choiceNode != oldChoiceNode) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExecutionFlowPackage.ACTION_NODE__CHOICE_NODE, oldChoiceNode, choiceNode));
			}
		}
		return choiceNode;
	}
	...
	public void setChoiceNode(ComponentNode newChoiceNode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionFlowPackage.ACTION_NODE__CHOICE_NODE, oldChoiceNode, choiceNode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExecutionFlowPackage.ACTION_NODE__CHOICE_NODE:
