 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.execution.executionflow.impl.PortInfoImpl#getInoutputIndex <em>Inoutput Index</em>}</li>
 *   <li>{@link org.eclipselabs.damos.execution.executionflow.impl.PortInfoImpl#getPortIndex <em>Port Index</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PortInfoImpl extends ConnectorInfoImpl implements PortInfo {
	...
	protected EClass eStaticClass() {
		return ExecutionFlowPackage.Literals.PORT_INFO;
	}
	...
	public void setInoutputIndex(int newInoutputIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionFlowPackage.PORT_INFO__INOUTPUT_INDEX, oldInoutputIndex, inoutputIndex));
	}
	...
	public void setPortIndex(int newPortIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionFlowPackage.PORT_INFO__PORT_INDEX, oldPortIndex, portIndex));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExecutionFlowPackage.PORT_INFO__INOUTPUT_INDEX:
				return getInoutputIndex();
			case ExecutionFlowPackage.PORT_INFO__PORT_INDEX:
				return getPortIndex();
		}
