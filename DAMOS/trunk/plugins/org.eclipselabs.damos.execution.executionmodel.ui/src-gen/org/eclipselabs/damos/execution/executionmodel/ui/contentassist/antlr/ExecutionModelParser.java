...
* generated by Xtext
*/
package org.eclipselabs.damos.execution.executionmodel.ui.contentassist.antlr;
...
public class ExecutionModelParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipselabs.damos.execution.executionmodel.ui.contentassist.antlr.internal.InternalExecutionModelParser createParser() {
		org.eclipselabs.damos.execution.executionmodel.ui.contentassist.antlr.internal.InternalExecutionModelParser result = new org.eclipselabs.damos.execution.executionmodel.ui.contentassist.antlr.internal.InternalExecutionModelParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getComputationModelMappingAccess().getGroup(), "rule__ComputationModelMapping__Group__0");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipselabs.damos.execution.executionmodel.ui.contentassist.antlr.internal.InternalExecutionModelParser typedParser = (org.eclipselabs.damos.execution.executionmodel.ui.contentassist.antlr.internal.InternalExecutionModelParser) parser;
			typedParser.entryRuleExecutionModel();
