...
package org.eclipselabs.damos.execution.executionmodel.services;
...
@Singleton
public class ExecutionModelGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ExecutionModelElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cComputationModelMappingsAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cComputationModelMappingsComputationModelMappingParserRuleCall_2_0 = (RuleCall)cComputationModelMappingsAssignment_2.eContents().get(0);
		...
		public Assignment getComputationModelMappingsAssignment_2() { return cComputationModelMappingsAssignment_2; }

		//ComputationModelMapping
		public RuleCall getComputationModelMappingsComputationModelMappingParserRuleCall_2_0() { return cComputationModelMappingsComputationModelMappingParserRuleCall_2_0; }
	}
	...
	private ExecutionModelElements pExecutionModel;
	private ComputationModelMappingElements pComputationModelMapping;
	...
	@Inject
	public ExecutionModelGrammarAccess(GrammarProvider grammarProvider,
	...
	public ExecutionModelElements getExecutionModelAccess() {
		return (pExecutionModel != null) ? pExecutionModel : (pExecutionModel = new ExecutionModelElements());
	}
	...
	public ParserRule getComputationModelMappingRule() {
		return getComputationModelMappingAccess().getRule();
	}
