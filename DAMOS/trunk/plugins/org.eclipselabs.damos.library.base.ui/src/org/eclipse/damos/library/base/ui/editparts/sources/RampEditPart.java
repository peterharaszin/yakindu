...
package org.eclipse.damos.library.base.ui.editparts.sources;
...
import org.eclipse.damos.library.base.ui.figures.sources.RampContentFigure;
 ...
 *
 */
public class RampEditPart extends RectangularBlockEditPart {

	/**
	 * @param view
	 */
	public RampEditPart(View view) {
		super(view);
	}
	...
	protected NodeFigure createMainFigure() {
		...
		figure.add(new RampContentFigure());
		return figure;
	}
