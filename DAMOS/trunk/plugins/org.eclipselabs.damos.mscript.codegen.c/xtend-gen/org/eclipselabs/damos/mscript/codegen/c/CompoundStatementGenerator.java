...
public class CompoundStatementGenerator implements ICompoundStatementGenerator {
  ...
  private CharSequence _generateAssignment(final IMscriptGeneratorContext context, final DataType targetDataType, final CharSequence target, final Expression assignedExpression) {
    StringConcatenation _builder = new StringConcatenation();
