...
public class ArrayLiteralDeclaration extends AbstractCodeFragment {
  ...
  @Inject
  public ArrayLiteralDeclaration(@Assisted final ComputationModel computationModel, @Assisted final IArrayValue value) {
  ...
  public void initialize(final ICodeFragmentContext context, final IProgressMonitor monitor) {
    ...
    final MachineArrayType arrayType = MachineDataTypes.create(this.computationModel, _dataType);
    ArrayTypeDeclaration _arrayTypeDeclaration = new ArrayTypeDeclaration(this.computationModel, arrayType);
    ...
    CharSequence _generateInitializer = this.literalGenerator.generateInitializer(this.computationModel, codeFragmentCollector, this.arrayValue);
