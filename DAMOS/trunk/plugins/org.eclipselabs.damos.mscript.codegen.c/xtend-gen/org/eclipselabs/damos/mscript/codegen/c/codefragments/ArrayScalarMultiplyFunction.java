...
public class ArrayScalarMultiplyFunction extends AbstractCodeFragment {
  ...
  @Inject
  public ArrayScalarMultiplyFunction(@Assisted final MachineNumericType scalarType, @Assisted final MachineArrayType arrayType, @Assisted final MachineArrayType resultType) {
  ...
  public void initialize(final ICodeFragmentContext context, final IProgressMonitor monitor) {
    ...
    String _generateDataType = this.scalarType.generateDataType(codeFragmentCollector, this);
    this.scalarTypeText = _generateDataType;
    MachineDataType _elementType = this.arrayType.getElementType();
    CharSequence _generateDataType_1 = _elementType.generateDataType(codeFragmentCollector, this);
    ...
    TextualNumericExpressionOperand _textualNumericExpressionOperand = new TextualNumericExpressionOperand("scalar", _numberFormat);
