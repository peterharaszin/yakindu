...
public class InitializeFunction extends AbstractCodeFragment {
  ...
  private final VariableReferenceGenerator variableAccessGenerator = new Function0<VariableReferenceGenerator>() {
    public VariableReferenceGenerator apply() {
      LiteralGenerator _literalGenerator = new LiteralGenerator(InitializeFunction.this.dataTypeGenerator);
      VariableReferenceGenerator _variableReferenceGenerator = new VariableReferenceGenerator(InitializeFunction.this.expressionGenerator, _literalGenerator);
  ...
  private final ICompoundStatementGenerator compoundStatementGenerator = new Function0<ICompoundStatementGenerator>() {
    public ICompoundStatementGenerator apply() {
      StatementGenerator _statementGenerator = new StatementGenerator(InitializeFunction.this.expressionGenerator, InitializeFunction.this.dataTypeGenerator, InitializeFunction.this.variableDeclarationGenerator, InitializeFunction.this.variableAccessGenerator, InitializeFunction.this.operationGeneratorProvider);
      CompoundStatementGenerator _compoundStatementGenerator = new CompoundStatementGenerator(_statementGenerator, InitializeFunction.this.variableDeclarationGenerator);
  ...
  public InitializeFunction(final IMscriptGeneratorContext generatorContext, final ComputeFunction computeFunction) {
