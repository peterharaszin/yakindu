...
public class MatrixVectorMultiplyFunction extends AbstractCodeFragment {
  ...
  @Inject
  public MatrixVectorMultiplyFunction(@Assisted final MachineArrayType matrixType, @Assisted final MachineArrayType vectorType, @Assisted final MachineArrayType resultType) {
