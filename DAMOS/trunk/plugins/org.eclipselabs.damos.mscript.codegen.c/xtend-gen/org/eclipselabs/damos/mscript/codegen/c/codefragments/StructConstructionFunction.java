...
public class StructConstructionFunction extends AbstractCodeFragment {
  ...
  @Inject
  public StructConstructionFunction(@Assisted final ComputationModel computationModel, @Assisted final MachineStructType structType) {
  ...
  public void initialize(final ICodeFragmentContext context, final IProgressMonitor monitor) {
    ...
    StructTypeDeclaration _structTypeDeclaration = new StructTypeDeclaration(this.computationModel, this.structType);
  ...
  private CharSequence generateFunctionSignature(final ICodeFragmentCollector codeFragmentCollector) {
    ...
    _builder.append("(");
    {
      ...
      for(final MachineStructMember member : _members) {
        ...
        CharSequence _generateDataType = _type.generateDataType(this.computationModel, codeFragmentCollector, this);
