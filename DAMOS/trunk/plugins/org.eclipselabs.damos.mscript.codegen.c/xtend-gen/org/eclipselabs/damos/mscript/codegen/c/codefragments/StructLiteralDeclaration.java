...
public class StructLiteralDeclaration extends AbstractCodeFragment {
  ...
  @Inject
  public StructLiteralDeclaration(@Assisted final IMscriptGeneratorConfiguration configuration, @Assisted final StructValue value) {
  ...
  public void initialize(final ICodeFragmentContext context, final IProgressMonitor monitor) {
    ...
    MachineStructType _create = MachineDataTypes.create(this.configuration, _dataType);
    StructTypeDeclaration _structTypeDeclaration = new StructTypeDeclaration(_create);
    ...
    CharSequence _generateInitializer = this.literalGenerator.generateInitializer(_computationModel, codeFragmentCollector, this.structValue);
