...
public class UpdateFunction extends AbstractCodeFragment {
  ...
  private final VariableReferenceGenerator variableAccessGenerator = new Function0<VariableReferenceGenerator>() {
    public VariableReferenceGenerator apply() {
      LiteralGenerator _literalGenerator = new LiteralGenerator(UpdateFunction.this.dataTypeGenerator);
      VariableReferenceGenerator _variableReferenceGenerator = new VariableReferenceGenerator(UpdateFunction.this.expressionGenerator, _literalGenerator);
  ...
  private final ICompoundStatementGenerator compoundStatementGenerator = new Function0<ICompoundStatementGenerator>() {
    public ICompoundStatementGenerator apply() {
      StatementGenerator _statementGenerator = new StatementGenerator(UpdateFunction.this.expressionGenerator, UpdateFunction.this.dataTypeGenerator, UpdateFunction.this.variableDeclarationGenerator, UpdateFunction.this.variableAccessGenerator, UpdateFunction.this.operationGeneratorProvider);
      CompoundStatementGenerator _compoundStatementGenerator = new CompoundStatementGenerator(_statementGenerator, UpdateFunction.this.variableDeclarationGenerator);
  ...
  public UpdateFunction(final IMscriptGeneratorContext generatorContext, final ComputeFunction computeFunction) {
