...
* generated by Xtext
*/
package org.eclipselabs.damos.mscript.computationmodel.ui.contentassist.antlr;
...
public class ComputationModelParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipselabs.damos.mscript.computationmodel.ui.contentassist.antlr.internal.InternalComputationModelParser createParser() {
		org.eclipselabs.damos.mscript.computationmodel.ui.contentassist.antlr.internal.InternalComputationModelParser result = new org.eclipselabs.damos.mscript.computationmodel.ui.contentassist.antlr.internal.InternalComputationModelParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getComputationModelAccess().getAlternatives_2(), "rule__ComputationModel__Alternatives_2");
					...
					put(grammarAccess.getFloatingPointFormatAccess().getGroup(), "rule__FloatingPointFormat__Group__0");
					...
					put(grammarAccess.getFixedPointFormatAccess().getGroup_0_0_2(), "rule__FixedPointFormat__Group_0_0_2__0");
					put(grammarAccess.getFixedPointFormatAccess().getGroup_0_1(), "rule__FixedPointFormat__Group_0_1__0");
					put(grammarAccess.getFixedPointFormatAccess().getGroup_2(), "rule__FixedPointFormat__Group_2__0");
					put(grammarAccess.getFixedPointOperationAccess().getGroup(), "rule__FixedPointOperation__Group__0");
					put(grammarAccess.getFixedPointOperationAccess().getGroup_2_0(), "rule__FixedPointOperation__Group_2_0__0");
					...
					put(grammarAccess.getFloatingPointFormatAccess().getKindAssignment_1(), "rule__FloatingPointFormat__KindAssignment_1");
					put(grammarAccess.getFloatingPointFormatAccess().getNameAssignment_2(), "rule__FloatingPointFormat__NameAssignment_2");
					...
					put(grammarAccess.getFixedPointFormatAccess().getFractionLengthAssignment_0_0_2_1(), "rule__FixedPointFormat__FractionLengthAssignment_0_0_2_1");
					put(grammarAccess.getFixedPointFormatAccess().getFractionLengthAssignment_0_1_1(), "rule__FixedPointFormat__FractionLengthAssignment_0_1_1");
					put(grammarAccess.getFixedPointFormatAccess().getNameAssignment_1(), "rule__FixedPointFormat__NameAssignment_1");
					put(grammarAccess.getFixedPointFormatAccess().getOperationsAssignment_2_1(), "rule__FixedPointFormat__OperationsAssignment_2_1");
					put(grammarAccess.getFixedPointOperationAccess().getKindAssignment_0(), "rule__FixedPointOperation__KindAssignment_0");
					put(grammarAccess.getFixedPointOperationAccess().getIntermediateWordSizeAssignment_2_0_1(), "rule__FixedPointOperation__IntermediateWordSizeAssignment_2_0_1");
					put(grammarAccess.getFixedPointOperationAccess().getSaturateAssignment_2_1(), "rule__FixedPointOperation__SaturateAssignment_2_1");
					...
					put(grammarAccess.getFixedPointOperationAccess().getUnorderedGroup_2(), "rule__FixedPointOperation__UnorderedGroup_2");
				}
			};
		}
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipselabs.damos.mscript.computationmodel.ui.contentassist.antlr.internal.InternalComputationModelParser typedParser = (org.eclipselabs.damos.mscript.computationmodel.ui.contentassist.antlr.internal.InternalComputationModelParser) parser;
			typedParser.entryRuleComputationModel();
