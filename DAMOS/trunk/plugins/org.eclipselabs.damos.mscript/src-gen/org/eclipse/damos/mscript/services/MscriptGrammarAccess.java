...
package org.eclipse.damos.mscript.services;
...
public class MscriptGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TopLevelDeclarationElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cStandardFunctionDeclarationParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		...
		public RuleCall getStandardFunctionDeclarationParserRuleCall_2() { return cStandardFunctionDeclarationParserRuleCall_2; }
	...
	public class UnitDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "UnitDeclaration");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cBaseUnitDeclarationParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cDerivedUnitDeclarationParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		//BaseUnitDeclaration
		public RuleCall getBaseUnitDeclarationParserRuleCall_0() { return cBaseUnitDeclarationParserRuleCall_0; }

		//DerivedUnitDeclaration
		public RuleCall getDerivedUnitDeclarationParserRuleCall_1() { return cDerivedUnitDeclarationParserRuleCall_1; }
	}

	public class BaseUnitDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "BaseUnitDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class DerivedUnitDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "DerivedUnitDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cUnitKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNameValidIDParserRuleCall_1_0 = (RuleCall)cNameAssignment_1.eContents().get(0);
		...
		private final RuleCall cDefinitionUnitDefinitionParserRuleCall_3_0 = (RuleCall)cDefinitionAssignment_3.eContents().get(0);
		...
		//UnitDefinition
		public RuleCall getDefinitionUnitDefinitionParserRuleCall_3_0() { return cDefinitionUnitDefinitionParserRuleCall_3_0; }
	}
	...
	public class UnitDefinitionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cONETerminalRuleCall_1_0 = (RuleCall)cAlternatives_1.eContents().get(0);
		private final Group cGroup_1_1 = (Group)cAlternatives_1.eContents().get(1);
		private final Assignment cFactorsAssignment_1_1_0 = (Assignment)cGroup_1_1.eContents().get(0);
		private final RuleCall cFactorsUnitFactorParserRuleCall_1_1_0_0 = (RuleCall)cFactorsAssignment_1_1_0.eContents().get(0);
		private final Group cGroup_1_1_1 = (Group)cGroup_1_1.eContents().get(1);
		private final Keyword cAsteriskKeyword_1_1_1_0 = (Keyword)cGroup_1_1_1.eContents().get(0);
		private final Assignment cFactorsAssignment_1_1_1_1 = (Assignment)cGroup_1_1_1.eContents().get(1);
		private final RuleCall cFactorsUnitFactorParserRuleCall_1_1_1_1_0 = (RuleCall)cFactorsAssignment_1_1_1_1.eContents().get(0);
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		private final Keyword cSolidusKeyword_2_0 = (Keyword)cGroup_2.eContents().get(0);
		private final Alternatives cAlternatives_2_1 = (Alternatives)cGroup_2.eContents().get(1);
		private final Assignment cFactorsAssignment_2_1_0 = (Assignment)cAlternatives_2_1.eContents().get(0);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_2_1_0_0 = (RuleCall)cFactorsAssignment_2_1_0.eContents().get(0);
		...
		private final Assignment cFactorsAssignment_2_1_1_1 = (Assignment)cGroup_2_1_1.eContents().get(1);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_2_1_1_1_0 = (RuleCall)cFactorsAssignment_2_1_1_1.eContents().get(0);
		private final Group cGroup_2_1_1_2 = (Group)cGroup_2_1_1.eContents().get(2);
		private final Keyword cAsteriskKeyword_2_1_1_2_0 = (Keyword)cGroup_2_1_1_2.eContents().get(0);
		private final Assignment cFactorsAssignment_2_1_1_2_1 = (Assignment)cGroup_2_1_1_2.eContents().get(1);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_2_1_1_2_1_0 = (RuleCall)cFactorsAssignment_2_1_1_2_1.eContents().get(0);
		...
		//ONE
		public RuleCall getONETerminalRuleCall_1_0() { return cONETerminalRuleCall_1_0; }

		//factors+=UnitFactor ("*" factors+=UnitFactor)*
		public Group getGroup_1_1() { return cGroup_1_1; }

		//factors+=UnitFactor
		public Assignment getFactorsAssignment_1_1_0() { return cFactorsAssignment_1_1_0; }

		//UnitFactor
		public RuleCall getFactorsUnitFactorParserRuleCall_1_1_0_0() { return cFactorsUnitFactorParserRuleCall_1_1_0_0; }
		...
		//factors+=UnitFactor
		public Assignment getFactorsAssignment_1_1_1_1() { return cFactorsAssignment_1_1_1_1; }

		//UnitFactor
		public RuleCall getFactorsUnitFactorParserRuleCall_1_1_1_1_0() { return cFactorsUnitFactorParserRuleCall_1_1_1_1_0; }
		...
		public Assignment getFactorsAssignment_2_1_0() { return cFactorsAssignment_2_1_0; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_2_1_0_0() { return cFactorsUnitDenominatorFactorParserRuleCall_2_1_0_0; }
		...
		//factors+=UnitDenominatorFactor
		public Assignment getFactorsAssignment_2_1_1_1() { return cFactorsAssignment_2_1_1_1; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_2_1_1_1_0() { return cFactorsUnitDenominatorFactorParserRuleCall_2_1_1_1_0; }

		//("*" factors+=UnitDenominatorFactor)*
		public Group getGroup_2_1_1_2() { return cGroup_2_1_1_2; }

		//"*"
		public Keyword getAsteriskKeyword_2_1_1_2_0() { return cAsteriskKeyword_2_1_1_2_0; }

		//factors+=UnitDenominatorFactor
		public Assignment getFactorsAssignment_2_1_1_2_1() { return cFactorsAssignment_2_1_1_2_1; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_2_1_1_2_1_0() { return cFactorsUnitDenominatorFactorParserRuleCall_2_1_1_2_1_0; }
	...
	public class StandardFunctionDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "StandardFunctionDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Assignment cInputParameterDeclarationsAssignment_4_0 = (Assignment)cGroup_4.eContents().get(0);
		private final RuleCall cInputParameterDeclarationsStandardInputParameterDeclarationParserRuleCall_4_0_0 = (RuleCall)cInputParameterDeclarationsAssignment_4_0.eContents().get(0);
		private final Group cGroup_4_1 = (Group)cGroup_4.eContents().get(1);
		private final Keyword cCommaKeyword_4_1_0 = (Keyword)cGroup_4_1.eContents().get(0);
		private final Assignment cInputParameterDeclarationsAssignment_4_1_1 = (Assignment)cGroup_4_1.eContents().get(1);
		private final RuleCall cInputParameterDeclarationsStandardInputParameterDeclarationParserRuleCall_4_1_1_0 = (RuleCall)cInputParameterDeclarationsAssignment_4_1_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_5 = (Keyword)cGroup.eContents().get(5);
		private final Keyword cHyphenMinusGreaterThanSignKeyword_6 = (Keyword)cGroup.eContents().get(6);
		private final Assignment cOutputParameterDeclarationsAssignment_7 = (Assignment)cGroup.eContents().get(7);
		private final RuleCall cOutputParameterDeclarationsStandardOutputParameterDeclarationParserRuleCall_7_0 = (RuleCall)cOutputParameterDeclarationsAssignment_7.eContents().get(0);
		private final Group cGroup_8 = (Group)cGroup.eContents().get(8);
		private final Keyword cCommaKeyword_8_0 = (Keyword)cGroup_8.eContents().get(0);
		private final Assignment cOutputParameterDeclarationsAssignment_8_1 = (Assignment)cGroup_8.eContents().get(1);
		private final RuleCall cOutputParameterDeclarationsStandardOutputParameterDeclarationParserRuleCall_8_1_0 = (RuleCall)cOutputParameterDeclarationsAssignment_8_1.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_9 = (Keyword)cGroup.eContents().get(9);
		private final Alternatives cAlternatives_10 = (Alternatives)cGroup.eContents().get(10);
		private final Assignment cChecksAssignment_10_0 = (Assignment)cAlternatives_10.eContents().get(0);
		private final RuleCall cChecksCheckParserRuleCall_10_0_0 = (RuleCall)cChecksAssignment_10_0.eContents().get(0);
		private final Assignment cAssertionsAssignment_10_1 = (Assignment)cAlternatives_10.eContents().get(1);
		private final RuleCall cAssertionsAssertionParserRuleCall_10_1_0 = (RuleCall)cAssertionsAssignment_10_1.eContents().get(0);
		private final Assignment cStateVariableDeclarationsAssignment_10_2 = (Assignment)cAlternatives_10.eContents().get(2);
		private final RuleCall cStateVariableDeclarationsStateVariableDeclarationParserRuleCall_10_2_0 = (RuleCall)cStateVariableDeclarationsAssignment_10_2.eContents().get(0);
		private final Assignment cConstantDeclarationsAssignment_10_3 = (Assignment)cAlternatives_10.eContents().get(3);
		private final RuleCall cConstantDeclarationsConstantDeclarationParserRuleCall_10_3_0 = (RuleCall)cConstantDeclarationsAssignment_10_3.eContents().get(0);
		private final Assignment cEquationsAssignment_10_4 = (Assignment)cAlternatives_10.eContents().get(4);
		private final RuleCall cEquationsEquationParserRuleCall_10_4_0 = (RuleCall)cEquationsAssignment_10_4.eContents().get(0);
		...
		//inputParameterDeclarations+=StandardInputParameterDeclaration
		public Assignment getInputParameterDeclarationsAssignment_4_0() { return cInputParameterDeclarationsAssignment_4_0; }

		//StandardInputParameterDeclaration
		public RuleCall getInputParameterDeclarationsStandardInputParameterDeclarationParserRuleCall_4_0_0() { return cInputParameterDeclarationsStandardInputParameterDeclarationParserRuleCall_4_0_0; }
		...
		//inputParameterDeclarations+=StandardInputParameterDeclaration
		public Assignment getInputParameterDeclarationsAssignment_4_1_1() { return cInputParameterDeclarationsAssignment_4_1_1; }

		//StandardInputParameterDeclaration
		public RuleCall getInputParameterDeclarationsStandardInputParameterDeclarationParserRuleCall_4_1_1_0() { return cInputParameterDeclarationsStandardInputParameterDeclarationParserRuleCall_4_1_1_0; }
		...
		//outputParameterDeclarations+=StandardOutputParameterDeclaration
		public Assignment getOutputParameterDeclarationsAssignment_7() { return cOutputParameterDeclarationsAssignment_7; }

		//StandardOutputParameterDeclaration
		public RuleCall getOutputParameterDeclarationsStandardOutputParameterDeclarationParserRuleCall_7_0() { return cOutputParameterDeclarationsStandardOutputParameterDeclarationParserRuleCall_7_0; }
		...
		//outputParameterDeclarations+=StandardOutputParameterDeclaration
		public Assignment getOutputParameterDeclarationsAssignment_8_1() { return cOutputParameterDeclarationsAssignment_8_1; }

		//StandardOutputParameterDeclaration
		public RuleCall getOutputParameterDeclarationsStandardOutputParameterDeclarationParserRuleCall_8_1_0() { return cOutputParameterDeclarationsStandardOutputParameterDeclarationParserRuleCall_8_1_0; }
		...
		//checks+=Check
		public Assignment getChecksAssignment_10_0() { return cChecksAssignment_10_0; }

		//Check
		public RuleCall getChecksCheckParserRuleCall_10_0_0() { return cChecksCheckParserRuleCall_10_0_0; }

		//assertions+=Assertion
		public Assignment getAssertionsAssignment_10_1() { return cAssertionsAssignment_10_1; }

		//Assertion
		public RuleCall getAssertionsAssertionParserRuleCall_10_1_0() { return cAssertionsAssertionParserRuleCall_10_1_0; }

		//stateVariableDeclarations+=StateVariableDeclaration
		public Assignment getStateVariableDeclarationsAssignment_10_2() { return cStateVariableDeclarationsAssignment_10_2; }

		//StateVariableDeclaration
		public RuleCall getStateVariableDeclarationsStateVariableDeclarationParserRuleCall_10_2_0() { return cStateVariableDeclarationsStateVariableDeclarationParserRuleCall_10_2_0; }

		//constantDeclarations+=ConstantDeclaration
		public Assignment getConstantDeclarationsAssignment_10_3() { return cConstantDeclarationsAssignment_10_3; }

		//ConstantDeclaration
		public RuleCall getConstantDeclarationsConstantDeclarationParserRuleCall_10_3_0() { return cConstantDeclarationsConstantDeclarationParserRuleCall_10_3_0; }

		//equations+=Equation
		public Assignment getEquationsAssignment_10_4() { return cEquationsAssignment_10_4; }

		//Equation
		public RuleCall getEquationsEquationParserRuleCall_10_4_0() { return cEquationsEquationParserRuleCall_10_4_0; }

		//"}"
		public Keyword getRightCurlyBracketKeyword_11() { return cRightCurlyBracketKeyword_11; }
	}

	public class StandardInputParameterDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "StandardInputParameterDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class StandardOutputParameterDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "StandardOutputParameterDeclaration");
		private final Assignment cNameAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cNameValidIDParserRuleCall_0 = (RuleCall)cNameAssignment.eContents().get(0);
	...
	public class CheckElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		private final Assignment cInputArgumentsAssignment_2_0 = (Assignment)cGroup_2.eContents().get(0);
		private final RuleCall cInputArgumentsCheckArgumentParserRuleCall_2_0_0 = (RuleCall)cInputArgumentsAssignment_2_0.eContents().get(0);
		private final Group cGroup_2_1 = (Group)cGroup_2.eContents().get(1);
		private final Keyword cCommaKeyword_2_1_0 = (Keyword)cGroup_2_1.eContents().get(0);
		private final Assignment cInputArgumentsAssignment_2_1_1 = (Assignment)cGroup_2_1.eContents().get(1);
		private final RuleCall cInputArgumentsCheckArgumentParserRuleCall_2_1_1_0 = (RuleCall)cInputArgumentsAssignment_2_1_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Keyword cHyphenMinusGreaterThanSignKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Assignment cOutputTypeSpecifiersAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final RuleCall cOutputTypeSpecifiersTypeSpecifierParserRuleCall_5_0 = (RuleCall)cOutputTypeSpecifiersAssignment_5.eContents().get(0);
		private final Group cGroup_6 = (Group)cGroup.eContents().get(6);
		private final Keyword cCommaKeyword_6_0 = (Keyword)cGroup_6.eContents().get(0);
		private final Assignment cOutputTypeSpecifiersAssignment_6_1 = (Assignment)cGroup_6.eContents().get(1);
		private final RuleCall cOutputTypeSpecifiersTypeSpecifierParserRuleCall_6_1_0 = (RuleCall)cOutputTypeSpecifiersAssignment_6_1.eContents().get(0);
		...
		public Assignment getInputArgumentsAssignment_2_0() { return cInputArgumentsAssignment_2_0; }

		//CheckArgument
		public RuleCall getInputArgumentsCheckArgumentParserRuleCall_2_0_0() { return cInputArgumentsCheckArgumentParserRuleCall_2_0_0; }
		...
		//inputArguments+=CheckArgument
		public Assignment getInputArgumentsAssignment_2_1_1() { return cInputArgumentsAssignment_2_1_1; }

		//CheckArgument
		public RuleCall getInputArgumentsCheckArgumentParserRuleCall_2_1_1_0() { return cInputArgumentsCheckArgumentParserRuleCall_2_1_1_0; }
		...
		public Assignment getOutputTypeSpecifiersAssignment_5() { return cOutputTypeSpecifiersAssignment_5; }

		//TypeSpecifier
		public RuleCall getOutputTypeSpecifiersTypeSpecifierParserRuleCall_5_0() { return cOutputTypeSpecifiersTypeSpecifierParserRuleCall_5_0; }
		...
		//outputTypeSpecifiers+=TypeSpecifier
		public Assignment getOutputTypeSpecifiersAssignment_6_1() { return cOutputTypeSpecifiersAssignment_6_1; }

		//TypeSpecifier
		public RuleCall getOutputTypeSpecifiersTypeSpecifierParserRuleCall_6_1_0() { return cOutputTypeSpecifiersTypeSpecifierParserRuleCall_6_1_0; }
	}

	public class CheckArgumentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "CheckArgument");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cTypeCheckArgumentParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cExpressionCheckArgumentParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		//TypeCheckArgument
		public RuleCall getTypeCheckArgumentParserRuleCall_0() { return cTypeCheckArgumentParserRuleCall_0; }

		//ExpressionCheckArgument
		public RuleCall getExpressionCheckArgumentParserRuleCall_1() { return cExpressionCheckArgumentParserRuleCall_1; }
	}

	public class TypeCheckArgumentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "TypeCheckArgument");
	...
	public class ExpressionCheckArgumentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ExpressionCheckArgument");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AnonymousTypeSpecifierElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cTypeAnonymousArrayTypeParserRuleCall_0_0 = (RuleCall)cTypeAlternatives_0.eContents().get(0);
		private final RuleCall cTypeDeclaredArrayTypeParserRuleCall_0_1 = (RuleCall)cTypeAlternatives_0.eContents().get(1);
		...
		//AnonymousArrayType | DeclaredArrayType
		public Alternatives getTypeAlternatives_0() { return cTypeAlternatives_0; }

		//AnonymousArrayType
		public RuleCall getTypeAnonymousArrayTypeParserRuleCall_0_0() { return cTypeAnonymousArrayTypeParserRuleCall_0_0; }

		//DeclaredArrayType
		public RuleCall getTypeDeclaredArrayTypeParserRuleCall_0_1() { return cTypeDeclaredArrayTypeParserRuleCall_0_1; }
	}
	...
	public class RealTypeElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cUnitImplicitUnitWithAnyParserRuleCall_2_0 = (RuleCall)cUnitAssignment_2.eContents().get(0);
		...
		//ImplicitUnitWithAny
		public RuleCall getUnitImplicitUnitWithAnyParserRuleCall_2_0() { return cUnitImplicitUnitWithAnyParserRuleCall_2_0; }
	}
	...
	public class AnonymousArrayTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "AnonymousArrayType");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Alternatives cAlternatives_0 = (Alternatives)cGroup.eContents().get(0);
		private final RuleCall cPrimitiveTypeParserRuleCall_0_0 = (RuleCall)cAlternatives_0.eContents().get(0);
		private final RuleCall cCompositeTypeParserRuleCall_0_1 = (RuleCall)cAlternatives_0.eContents().get(1);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Action cAnonymousArrayTypeElementTypeAction_1_0 = (Action)cGroup_1.eContents().get(0);
		...
		//CompositeType
		public RuleCall getCompositeTypeParserRuleCall_0_1() { return cCompositeTypeParserRuleCall_0_1; }
		...
		public Action getAnonymousArrayTypeElementTypeAction_1_0() { return cAnonymousArrayTypeElementTypeAction_1_0; }
	...
	public class DeclaredArrayTypeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "DeclaredArrayType");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cElementTypeDeclarationAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final CrossReference cElementTypeDeclarationTypeDeclarationCrossReference_0_0 = (CrossReference)cElementTypeDeclarationAssignment_0.eContents().get(0);
		private final RuleCall cElementTypeDeclarationTypeDeclarationQualifiedNameParserRuleCall_0_0_1 = (RuleCall)cElementTypeDeclarationTypeDeclarationCrossReference_0_0.eContents().get(1);
		...
		public Assignment getElementTypeDeclarationAssignment_0() { return cElementTypeDeclarationAssignment_0; }

		//[TypeDeclaration|QualifiedName]
		public CrossReference getElementTypeDeclarationTypeDeclarationCrossReference_0_0() { return cElementTypeDeclarationTypeDeclarationCrossReference_0_0; }

		//QualifiedName
		public RuleCall getElementTypeDeclarationTypeDeclarationQualifiedNameParserRuleCall_0_0_1() { return cElementTypeDeclarationTypeDeclarationQualifiedNameParserRuleCall_0_0_1; }
	...
	public class RecordTypeElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Alternatives cAlternatives_0 = (Alternatives)cGroup.eContents().get(0);
		private final Assignment cLabelAssignment_0_0 = (Assignment)cAlternatives_0.eContents().get(0);
		private final RuleCall cLabelValidIDParserRuleCall_0_0_0 = (RuleCall)cLabelAssignment_0_0.eContents().get(0);
		...
		//ValidID
		public RuleCall getLabelValidIDParserRuleCall_0_0_0() { return cLabelValidIDParserRuleCall_0_0_0; }

		//anyLabel?="?"
		public Assignment getAnyLabelAssignment_0_1() { return cAnyLabelAssignment_0_1; }

		//"?"
		public Keyword getAnyLabelQuestionMarkKeyword_0_1_0() { return cAnyLabelQuestionMarkKeyword_0_1_0; }
	...
	public class UnionTypeElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cLabelValidIDParserRuleCall_1_0_0 = (RuleCall)cLabelAssignment_1_0.eContents().get(0);
		...
		//ValidID
		public RuleCall getLabelValidIDParserRuleCall_1_0_0() { return cLabelValidIDParserRuleCall_1_0_0; }

		//anyLabel?="?"
		public Assignment getAnyLabelAssignment_1_1() { return cAnyLabelAssignment_1_1; }

		//"?"
		public Keyword getAnyLabelQuestionMarkKeyword_1_1_0() { return cAnyLabelQuestionMarkKeyword_1_1_0; }
	...
	public class ExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cInspectExpressionParserRuleCall_4 = (RuleCall)cAlternatives.eContents().get(4);
		private final RuleCall cUnionConstructionOperatorParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		private final RuleCall cRangeExpressionParserRuleCall_6 = (RuleCall)cAlternatives.eContents().get(6);
		...
		//InspectExpression
		public RuleCall getInspectExpressionParserRuleCall_4() { return cInspectExpressionParserRuleCall_4; }

		//UnionConstructionOperator
		public RuleCall getUnionConstructionOperatorParserRuleCall_5() { return cUnionConstructionOperatorParserRuleCall_5; }

		//RangeExpression
		public RuleCall getRangeExpressionParserRuleCall_6() { return cRangeExpressionParserRuleCall_6; }
	}
	...
	public class InspectExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "InspectExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cInspectKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cUnionExpressionAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cUnionExpressionExpressionParserRuleCall_1_0 = (RuleCall)cUnionExpressionAssignment_1.eContents().get(0);
		private final Assignment cWhenClausesAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cWhenClausesInspectWhenClauseParserRuleCall_2_0 = (RuleCall)cWhenClausesAssignment_2.eContents().get(0);
		...
		public Assignment getUnionExpressionAssignment_1() { return cUnionExpressionAssignment_1; }

		//Expression
		public RuleCall getUnionExpressionExpressionParserRuleCall_1_0() { return cUnionExpressionExpressionParserRuleCall_1_0; }

		//whenClauses+=InspectWhenClause*
		public Assignment getWhenClausesAssignment_2() { return cWhenClausesAssignment_2; }

		//InspectWhenClause
		public RuleCall getWhenClausesInspectWhenClauseParserRuleCall_2_0() { return cWhenClausesInspectWhenClauseParserRuleCall_2_0; }
	}

	public class InspectWhenClauseElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "InspectWhenClause");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PrefixUnaryExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cUnitConversionExpressionParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		...
		private final RuleCall cOperandUnitConversionExpressionParserRuleCall_1_2_0 = (RuleCall)cOperandAssignment_1_2.eContents().get(0);
		...
		public RuleCall getUnitConversionExpressionParserRuleCall_0() { return cUnitConversionExpressionParserRuleCall_0; }
		...
		//UnitConversionExpression
		public RuleCall getOperandUnitConversionExpressionParserRuleCall_1_2_0() { return cOperandUnitConversionExpressionParserRuleCall_1_2_0; }
	}

	public class UnitConversionExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "UnitConversionExpression");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cPostfixUnaryExpressionParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Action cUnitConversionExpressionOperandAction_1_0 = (Action)cGroup_1.eContents().get(0);
		...
		private final RuleCall cUnitExplicitUnitParserRuleCall_1_2_0 = (RuleCall)cUnitAssignment_1_2.eContents().get(0);
		...
		public Action getUnitConversionExpressionOperandAction_1_0() { return cUnitConversionExpressionOperandAction_1_0; }
		...
		//ExplicitUnit
		public RuleCall getUnitExplicitUnitParserRuleCall_1_2_0() { return cUnitExplicitUnitParserRuleCall_1_2_0; }
	}
	...
	public class MemberAccessElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "MemberAccess");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Alternatives cAlternatives_0 = (Alternatives)cGroup.eContents().get(0);
		private final RuleCall cFunctionCallParserRuleCall_0_0 = (RuleCall)cAlternatives_0.eContents().get(0);
		...
		private final Assignment cTargetAssignment_1_2_2 = (Assignment)cGroup_1_2.eContents().get(2);
		private final RuleCall cTargetFeatureReferenceParserRuleCall_1_2_2_0 = (RuleCall)cTargetAssignment_1_2_2.eContents().get(0);
		...
		//FunctionCall
		public RuleCall getFunctionCallParserRuleCall_0_0() { return cFunctionCallParserRuleCall_0_0; }
		...
		public Assignment getTargetAssignment_1_2_2() { return cTargetAssignment_1_2_2; }

		//FeatureReference
		public RuleCall getTargetFeatureReferenceParserRuleCall_1_2_2_0() { return cTargetFeatureReferenceParserRuleCall_1_2_2_0; }
	...
	public class FunctionCallElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cCallablePrimaryExpressionParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Action cFunctionCallTargetAction_1_0 = (Action)cGroup_1.eContents().get(0);
		...
		public RuleCall getCallablePrimaryExpressionParserRuleCall_0() { return cCallablePrimaryExpressionParserRuleCall_0; }

		//({FunctionCall.target=current} "(" (arguments+=Expression ("," arguments+=Expression)*)? ")")?
		public Group getGroup_1() { return cGroup_1; }

		//{FunctionCall.target=current}
		public Action getFunctionCallTargetAction_1_0() { return cFunctionCallTargetAction_1_0; }
	...
	public class PrimaryExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cRecordConstructionOperatorParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		...
		public RuleCall getRecordConstructionOperatorParserRuleCall_5() { return cRecordConstructionOperatorParserRuleCall_5; }
	...
	public class RealLiteralElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cUnitImplicitUnitParserRuleCall_1_0 = (RuleCall)cUnitAssignment_1.eContents().get(0);
		...
		//ImplicitUnit
		public RuleCall getUnitImplicitUnitParserRuleCall_1_0() { return cUnitImplicitUnitParserRuleCall_1_0; }
	}
	...
	public class FeatureReferenceElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cFeatureReferenceAction_0 = (Action)cGroup.eContents().get(0);
		private final Alternatives cAlternatives_1 = (Alternatives)cGroup.eContents().get(1);
		private final Assignment cFeatureAssignment_1_0 = (Assignment)cAlternatives_1.eContents().get(0);
		private final CrossReference cFeatureCallableElementCrossReference_1_0_0 = (CrossReference)cFeatureAssignment_1_0.eContents().get(0);
		private final RuleCall cFeatureCallableElementValidIDWithUnitParserRuleCall_1_0_0_1 = (RuleCall)cFeatureCallableElementCrossReference_1_0_0.eContents().get(1);
		private final Group cGroup_1_1 = (Group)cAlternatives_1.eContents().get(1);
		private final Assignment cFeatureAssignment_1_1_0 = (Assignment)cGroup_1_1.eContents().get(0);
		private final CrossReference cFeatureCallableElementCrossReference_1_1_0_0 = (CrossReference)cFeatureAssignment_1_1_0.eContents().get(0);
		private final RuleCall cFeatureCallableElementValidIDParserRuleCall_1_1_0_0_1 = (RuleCall)cFeatureCallableElementCrossReference_1_1_0_0.eContents().get(1);
		private final Keyword cLeftCurlyBracketKeyword_1_1_1 = (Keyword)cGroup_1_1.eContents().get(1);
		private final Assignment cStepExpressionAssignment_1_1_2 = (Assignment)cGroup_1_1.eContents().get(2);
		private final RuleCall cStepExpressionStepExpressionParserRuleCall_1_1_2_0 = (RuleCall)cStepExpressionAssignment_1_1_2.eContents().get(0);
		...
		//{FeatureReference}
		public Action getFeatureReferenceAction_0() { return cFeatureReferenceAction_0; }
		...
		public Assignment getFeatureAssignment_1_0() { return cFeatureAssignment_1_0; }

		//[CallableElement|ValidIDWithUnit]
		public CrossReference getFeatureCallableElementCrossReference_1_0_0() { return cFeatureCallableElementCrossReference_1_0_0; }

		//ValidIDWithUnit
		public RuleCall getFeatureCallableElementValidIDWithUnitParserRuleCall_1_0_0_1() { return cFeatureCallableElementValidIDWithUnitParserRuleCall_1_0_0_1; }

		//feature=[CallableElement|ValidID] "{" stepExpression=StepExpression "}"
		public Group getGroup_1_1() { return cGroup_1_1; }

		//feature=[CallableElement|ValidID]
		public Assignment getFeatureAssignment_1_1_0() { return cFeatureAssignment_1_1_0; }

		//[CallableElement|ValidID]
		public CrossReference getFeatureCallableElementCrossReference_1_1_0_0() { return cFeatureCallableElementCrossReference_1_1_0_0; }

		//ValidID
		public RuleCall getFeatureCallableElementValidIDParserRuleCall_1_1_0_0_1() { return cFeatureCallableElementValidIDParserRuleCall_1_1_0_0_1; }

		//"{"
		public Keyword getLeftCurlyBracketKeyword_1_1_1() { return cLeftCurlyBracketKeyword_1_1_1; }

		//stepExpression=StepExpression
		public Assignment getStepExpressionAssignment_1_1_2() { return cStepExpressionAssignment_1_1_2; }

		//StepExpression
		public RuleCall getStepExpressionStepExpressionParserRuleCall_1_1_2_0() { return cStepExpressionStepExpressionParserRuleCall_1_1_2_0; }
	...
	public class QualifiedFunctionCallElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cQualifiedFeatureReferenceParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Action cFunctionCallTargetAction_1_0 = (Action)cGroup_1.eContents().get(0);
		private final Keyword cLeftParenthesisKeyword_1_1 = (Keyword)cGroup_1.eContents().get(1);
		private final Group cGroup_1_2 = (Group)cGroup_1.eContents().get(2);
		...
		public RuleCall getQualifiedFeatureReferenceParserRuleCall_0() { return cQualifiedFeatureReferenceParserRuleCall_0; }
	...
	public class QualifiedFeatureReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "QualifiedFeatureReference");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cFeatureReferenceAction_0 = (Action)cGroup.eContents().get(0);
		...
		private final RuleCall cFeatureCallableElementQualifiedNameWithUnitParserRuleCall_2_0_1 = (RuleCall)cFeatureCallableElementCrossReference_2_0.eContents().get(1);
		...
		//[CallableElement|QualifiedNameWithUnit]
		...
		public RuleCall getFeatureCallableElementQualifiedNameWithUnitParserRuleCall_2_0_1() { return cFeatureCallableElementQualifiedNameWithUnitParserRuleCall_2_0_1; }
	}
	...
	public class RecordConstructionOperatorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "RecordConstructionOperator");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cLabelAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cLabelValidIDParserRuleCall_0_0 = (RuleCall)cLabelAssignment_0.eContents().get(0);
		private final Keyword cLeftCurlyBracketKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cMembersAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cMembersRecordConstructionMemberParserRuleCall_2_0 = (RuleCall)cMembersAssignment_2.eContents().get(0);
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		private final Keyword cCommaKeyword_3_0 = (Keyword)cGroup_3.eContents().get(0);
		private final Assignment cMembersAssignment_3_1 = (Assignment)cGroup_3.eContents().get(1);
		private final RuleCall cMembersRecordConstructionMemberParserRuleCall_3_1_0 = (RuleCall)cMembersAssignment_3_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_4 = (Keyword)cGroup.eContents().get(4);
		...
		//ValidID
		public RuleCall getLabelValidIDParserRuleCall_0_0() { return cLabelValidIDParserRuleCall_0_0; }
		...
		public RuleCall getMembersRecordConstructionMemberParserRuleCall_2_0() { return cMembersRecordConstructionMemberParserRuleCall_2_0; }
		...
		//RecordConstructionMember
		public RuleCall getMembersRecordConstructionMemberParserRuleCall_3_1_0() { return cMembersRecordConstructionMemberParserRuleCall_3_1_0; }

		//"}"
		public Keyword getRightCurlyBracketKeyword_4() { return cRightCurlyBracketKeyword_4; }
	}

	public class RecordConstructionMemberElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "RecordConstructionMember");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class UnionConstructionOperatorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "UnionConstructionOperator");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cNewKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cTypeSpecifierAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cTypeSpecifierUnionTypeSpecifierParserRuleCall_1_0 = (RuleCall)cTypeSpecifierAssignment_1.eContents().get(0);
		private final Keyword cWithKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Assignment cMemberAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final CrossReference cMemberCompositeTypeMemberCrossReference_3_0 = (CrossReference)cMemberAssignment_3.eContents().get(0);
		private final RuleCall cMemberCompositeTypeMemberValidIDParserRuleCall_3_0_1 = (RuleCall)cMemberCompositeTypeMemberCrossReference_3_0.eContents().get(1);
		...
		//UnionTypeSpecifier
		public RuleCall getTypeSpecifierUnionTypeSpecifierParserRuleCall_1_0() { return cTypeSpecifierUnionTypeSpecifierParserRuleCall_1_0; }
		...
		//[CompositeTypeMember|ValidID]
		public CrossReference getMemberCompositeTypeMemberCrossReference_3_0() { return cMemberCompositeTypeMemberCrossReference_3_0; }

		//ValidID
		public RuleCall getMemberCompositeTypeMemberValidIDParserRuleCall_3_0_1() { return cMemberCompositeTypeMemberValidIDParserRuleCall_3_0_1; }
	...
	public class UnionTypeSpecifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "UnionTypeSpecifier");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final RuleCall cAnonymousUnionTypeSpecifierParserRuleCall_0 = (RuleCall)cAlternatives.eContents().get(0);
		private final RuleCall cDeclaredTypeSpecifierParserRuleCall_1 = (RuleCall)cAlternatives.eContents().get(1);
		...
		public RuleCall getAnonymousUnionTypeSpecifierParserRuleCall_0() { return cAnonymousUnionTypeSpecifierParserRuleCall_0; }

		//DeclaredTypeSpecifier
		public RuleCall getDeclaredTypeSpecifierParserRuleCall_1() { return cDeclaredTypeSpecifierParserRuleCall_1; }
	}

	public class AnonymousUnionTypeSpecifierElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "AnonymousUnionTypeSpecifier");
		private final Assignment cTypeAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cTypeUnionTypeParserRuleCall_0 = (RuleCall)cTypeAssignment.eContents().get(0);
		...
		//UnionType
		public RuleCall getTypeUnionTypeParserRuleCall_0() { return cTypeUnionTypeParserRuleCall_0; }
	}
	...
	public class AssignmentElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cTargetAssignableMemberFeatureReferenceParserRuleCall_0_0 = (RuleCall)cTargetAssignment_0.eContents().get(0);
		private final Keyword cEqualsSignKeyword_1 = (Keyword)cGroup.eContents().get(1);
		private final Assignment cAssignedExpressionAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final RuleCall cAssignedExpressionExpressionParserRuleCall_2_0 = (RuleCall)cAssignedExpressionAssignment_2.eContents().get(0);
		...
		public RuleCall getTargetAssignableMemberFeatureReferenceParserRuleCall_0_0() { return cTargetAssignableMemberFeatureReferenceParserRuleCall_0_0; }
	...
	public class AssignableMemberFeatureReferenceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "AssignableMemberFeatureReference");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ImplicitUnitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ImplicitUnit");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cUnitAction_0 = (Action)cGroup.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Keyword cLeftParenthesisKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final Alternatives cAlternatives_1_1 = (Alternatives)cGroup_1.eContents().get(1);
		private final RuleCall cONETerminalRuleCall_1_1_0 = (RuleCall)cAlternatives_1_1.eContents().get(0);
		private final Group cGroup_1_1_1 = (Group)cAlternatives_1_1.eContents().get(1);
		private final Assignment cFactorsAssignment_1_1_1_0 = (Assignment)cGroup_1_1_1.eContents().get(0);
		private final RuleCall cFactorsUnitFactorParserRuleCall_1_1_1_0_0 = (RuleCall)cFactorsAssignment_1_1_1_0.eContents().get(0);
		private final Group cGroup_1_1_1_1 = (Group)cGroup_1_1_1.eContents().get(1);
		private final Keyword cAsteriskKeyword_1_1_1_1_0 = (Keyword)cGroup_1_1_1_1.eContents().get(0);
		private final Assignment cFactorsAssignment_1_1_1_1_1 = (Assignment)cGroup_1_1_1_1.eContents().get(1);
		private final RuleCall cFactorsUnitFactorParserRuleCall_1_1_1_1_1_0 = (RuleCall)cFactorsAssignment_1_1_1_1_1.eContents().get(0);
		private final Group cGroup_1_2 = (Group)cGroup_1.eContents().get(2);
		...
		private final Assignment cFactorsAssignment_1_2_1_0 = (Assignment)cAlternatives_1_2_1.eContents().get(0);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_1_2_1_0_0 = (RuleCall)cFactorsAssignment_1_2_1_0.eContents().get(0);
		private final Group cGroup_1_2_1_1 = (Group)cAlternatives_1_2_1.eContents().get(1);
		private final Keyword cLeftParenthesisKeyword_1_2_1_1_0 = (Keyword)cGroup_1_2_1_1.eContents().get(0);
		private final Assignment cFactorsAssignment_1_2_1_1_1 = (Assignment)cGroup_1_2_1_1.eContents().get(1);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_1_2_1_1_1_0 = (RuleCall)cFactorsAssignment_1_2_1_1_1.eContents().get(0);
		private final Group cGroup_1_2_1_1_2 = (Group)cGroup_1_2_1_1.eContents().get(2);
		private final Keyword cAsteriskKeyword_1_2_1_1_2_0 = (Keyword)cGroup_1_2_1_1_2.eContents().get(0);
		private final Assignment cFactorsAssignment_1_2_1_1_2_1 = (Assignment)cGroup_1_2_1_1_2.eContents().get(1);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_1_2_1_1_2_1_0 = (RuleCall)cFactorsAssignment_1_2_1_1_2_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_1_2_1_1_3 = (Keyword)cGroup_1_2_1_1.eContents().get(3);
		private final Keyword cRightParenthesisKeyword_1_3 = (Keyword)cGroup_1.eContents().get(3);
		...
		//ONE
		public RuleCall getONETerminalRuleCall_1_1_0() { return cONETerminalRuleCall_1_1_0; }

		//factors+=UnitFactor ("*" factors+=UnitFactor)*
		public Group getGroup_1_1_1() { return cGroup_1_1_1; }

		//factors+=UnitFactor
		public Assignment getFactorsAssignment_1_1_1_0() { return cFactorsAssignment_1_1_1_0; }

		//UnitFactor
		public RuleCall getFactorsUnitFactorParserRuleCall_1_1_1_0_0() { return cFactorsUnitFactorParserRuleCall_1_1_1_0_0; }
		...
		//factors+=UnitFactor
		public Assignment getFactorsAssignment_1_1_1_1_1() { return cFactorsAssignment_1_1_1_1_1; }

		//UnitFactor
		public RuleCall getFactorsUnitFactorParserRuleCall_1_1_1_1_1_0() { return cFactorsUnitFactorParserRuleCall_1_1_1_1_1_0; }
		...
		//factors+=UnitDenominatorFactor
		public Assignment getFactorsAssignment_1_2_1_0() { return cFactorsAssignment_1_2_1_0; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_1_2_1_0_0() { return cFactorsUnitDenominatorFactorParserRuleCall_1_2_1_0_0; }

		//"(" factors+=UnitDenominatorFactor ("*" factors+=UnitDenominatorFactor)* ")"
		public Group getGroup_1_2_1_1() { return cGroup_1_2_1_1; }

		//"("
		public Keyword getLeftParenthesisKeyword_1_2_1_1_0() { return cLeftParenthesisKeyword_1_2_1_1_0; }

		//factors+=UnitDenominatorFactor
		public Assignment getFactorsAssignment_1_2_1_1_1() { return cFactorsAssignment_1_2_1_1_1; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_1_2_1_1_1_0() { return cFactorsUnitDenominatorFactorParserRuleCall_1_2_1_1_1_0; }

		//("*" factors+=UnitDenominatorFactor)*
		public Group getGroup_1_2_1_1_2() { return cGroup_1_2_1_1_2; }

		//"*"
		public Keyword getAsteriskKeyword_1_2_1_1_2_0() { return cAsteriskKeyword_1_2_1_1_2_0; }

		//factors+=UnitDenominatorFactor
		public Assignment getFactorsAssignment_1_2_1_1_2_1() { return cFactorsAssignment_1_2_1_1_2_1; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_1_2_1_1_2_1_0() { return cFactorsUnitDenominatorFactorParserRuleCall_1_2_1_1_2_1_0; }

		//")"
		public Keyword getRightParenthesisKeyword_1_2_1_1_3() { return cRightParenthesisKeyword_1_2_1_1_3; }

		//")"
		public Keyword getRightParenthesisKeyword_1_3() { return cRightParenthesisKeyword_1_3; }
	}

	public class ImplicitUnitWithAnyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ImplicitUnitWithAny");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cUnitAction_0 = (Action)cGroup.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Keyword cLeftParenthesisKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final Alternatives cAlternatives_1_1 = (Alternatives)cGroup_1.eContents().get(1);
		private final Assignment cAnyAssignment_1_1_0 = (Assignment)cAlternatives_1_1.eContents().get(0);
		private final Keyword cAnyQuestionMarkKeyword_1_1_0_0 = (Keyword)cAnyAssignment_1_1_0.eContents().get(0);
		private final Group cGroup_1_1_1 = (Group)cAlternatives_1_1.eContents().get(1);
		private final Alternatives cAlternatives_1_1_1_0 = (Alternatives)cGroup_1_1_1.eContents().get(0);
		private final RuleCall cONETerminalRuleCall_1_1_1_0_0 = (RuleCall)cAlternatives_1_1_1_0.eContents().get(0);
		private final Group cGroup_1_1_1_0_1 = (Group)cAlternatives_1_1_1_0.eContents().get(1);
		private final Assignment cFactorsAssignment_1_1_1_0_1_0 = (Assignment)cGroup_1_1_1_0_1.eContents().get(0);
		private final RuleCall cFactorsUnitFactorParserRuleCall_1_1_1_0_1_0_0 = (RuleCall)cFactorsAssignment_1_1_1_0_1_0.eContents().get(0);
		private final Group cGroup_1_1_1_0_1_1 = (Group)cGroup_1_1_1_0_1.eContents().get(1);
		private final Keyword cAsteriskKeyword_1_1_1_0_1_1_0 = (Keyword)cGroup_1_1_1_0_1_1.eContents().get(0);
		private final Assignment cFactorsAssignment_1_1_1_0_1_1_1 = (Assignment)cGroup_1_1_1_0_1_1.eContents().get(1);
		private final RuleCall cFactorsUnitFactorParserRuleCall_1_1_1_0_1_1_1_0 = (RuleCall)cFactorsAssignment_1_1_1_0_1_1_1.eContents().get(0);
		private final Group cGroup_1_1_1_1 = (Group)cGroup_1_1_1.eContents().get(1);
		private final Keyword cSolidusKeyword_1_1_1_1_0 = (Keyword)cGroup_1_1_1_1.eContents().get(0);
		private final Alternatives cAlternatives_1_1_1_1_1 = (Alternatives)cGroup_1_1_1_1.eContents().get(1);
		private final Assignment cFactorsAssignment_1_1_1_1_1_0 = (Assignment)cAlternatives_1_1_1_1_1.eContents().get(0);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_1_1_1_1_1_0_0 = (RuleCall)cFactorsAssignment_1_1_1_1_1_0.eContents().get(0);
		private final Group cGroup_1_1_1_1_1_1 = (Group)cAlternatives_1_1_1_1_1.eContents().get(1);
		private final Keyword cLeftParenthesisKeyword_1_1_1_1_1_1_0 = (Keyword)cGroup_1_1_1_1_1_1.eContents().get(0);
		private final Assignment cFactorsAssignment_1_1_1_1_1_1_1 = (Assignment)cGroup_1_1_1_1_1_1.eContents().get(1);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_1_1_1_1_1_1_1_0 = (RuleCall)cFactorsAssignment_1_1_1_1_1_1_1.eContents().get(0);
		private final Group cGroup_1_1_1_1_1_1_2 = (Group)cGroup_1_1_1_1_1_1.eContents().get(2);
		private final Keyword cAsteriskKeyword_1_1_1_1_1_1_2_0 = (Keyword)cGroup_1_1_1_1_1_1_2.eContents().get(0);
		private final Assignment cFactorsAssignment_1_1_1_1_1_1_2_1 = (Assignment)cGroup_1_1_1_1_1_1_2.eContents().get(1);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_1_1_1_1_1_1_2_1_0 = (RuleCall)cFactorsAssignment_1_1_1_1_1_1_2_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_1_1_1_1_1_1_3 = (Keyword)cGroup_1_1_1_1_1_1.eContents().get(3);
		...
		//any?="?"
		public Assignment getAnyAssignment_1_1_0() { return cAnyAssignment_1_1_0; }

		//"?"
		public Keyword getAnyQuestionMarkKeyword_1_1_0_0() { return cAnyQuestionMarkKeyword_1_1_0_0; }
		...
		//ONE
		public RuleCall getONETerminalRuleCall_1_1_1_0_0() { return cONETerminalRuleCall_1_1_1_0_0; }

		//factors+=UnitFactor ("*" factors+=UnitFactor)*
		public Group getGroup_1_1_1_0_1() { return cGroup_1_1_1_0_1; }

		//factors+=UnitFactor
		public Assignment getFactorsAssignment_1_1_1_0_1_0() { return cFactorsAssignment_1_1_1_0_1_0; }

		//UnitFactor
		public RuleCall getFactorsUnitFactorParserRuleCall_1_1_1_0_1_0_0() { return cFactorsUnitFactorParserRuleCall_1_1_1_0_1_0_0; }

		//("*" factors+=UnitFactor)*
		public Group getGroup_1_1_1_0_1_1() { return cGroup_1_1_1_0_1_1; }

		//"*"
		public Keyword getAsteriskKeyword_1_1_1_0_1_1_0() { return cAsteriskKeyword_1_1_1_0_1_1_0; }

		//factors+=UnitFactor
		public Assignment getFactorsAssignment_1_1_1_0_1_1_1() { return cFactorsAssignment_1_1_1_0_1_1_1; }

		//UnitFactor
		public RuleCall getFactorsUnitFactorParserRuleCall_1_1_1_0_1_1_1_0() { return cFactorsUnitFactorParserRuleCall_1_1_1_0_1_1_1_0; }

		//("/" (factors+=UnitDenominatorFactor | "(" factors+=UnitDenominatorFactor ("*" factors+=UnitDenominatorFactor)* ")"))?
		public Group getGroup_1_1_1_1() { return cGroup_1_1_1_1; }

		//"/"
		public Keyword getSolidusKeyword_1_1_1_1_0() { return cSolidusKeyword_1_1_1_1_0; }

		//factors+=UnitDenominatorFactor | "(" factors+=UnitDenominatorFactor ("*" factors+=UnitDenominatorFactor)* ")"
		public Alternatives getAlternatives_1_1_1_1_1() { return cAlternatives_1_1_1_1_1; }

		//factors+=UnitDenominatorFactor
		public Assignment getFactorsAssignment_1_1_1_1_1_0() { return cFactorsAssignment_1_1_1_1_1_0; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_1_1_1_1_1_0_0() { return cFactorsUnitDenominatorFactorParserRuleCall_1_1_1_1_1_0_0; }

		//"(" factors+=UnitDenominatorFactor ("*" factors+=UnitDenominatorFactor)* ")"
		public Group getGroup_1_1_1_1_1_1() { return cGroup_1_1_1_1_1_1; }

		//"("
		public Keyword getLeftParenthesisKeyword_1_1_1_1_1_1_0() { return cLeftParenthesisKeyword_1_1_1_1_1_1_0; }

		//factors+=UnitDenominatorFactor
		public Assignment getFactorsAssignment_1_1_1_1_1_1_1() { return cFactorsAssignment_1_1_1_1_1_1_1; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_1_1_1_1_1_1_1_0() { return cFactorsUnitDenominatorFactorParserRuleCall_1_1_1_1_1_1_1_0; }

		//("*" factors+=UnitDenominatorFactor)*
		public Group getGroup_1_1_1_1_1_1_2() { return cGroup_1_1_1_1_1_1_2; }

		//"*"
		public Keyword getAsteriskKeyword_1_1_1_1_1_1_2_0() { return cAsteriskKeyword_1_1_1_1_1_1_2_0; }

		//factors+=UnitDenominatorFactor
		public Assignment getFactorsAssignment_1_1_1_1_1_1_2_1() { return cFactorsAssignment_1_1_1_1_1_1_2_1; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_1_1_1_1_1_1_2_1_0() { return cFactorsUnitDenominatorFactorParserRuleCall_1_1_1_1_1_1_2_1_0; }

		//")"
		public Keyword getRightParenthesisKeyword_1_1_1_1_1_1_3() { return cRightParenthesisKeyword_1_1_1_1_1_1_3; }
	...
	public class ExplicitUnitElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cONETerminalRuleCall_2_0 = (RuleCall)cAlternatives_2.eContents().get(0);
		private final Group cGroup_2_1 = (Group)cAlternatives_2.eContents().get(1);
		private final Assignment cFactorsAssignment_2_1_0 = (Assignment)cGroup_2_1.eContents().get(0);
		private final RuleCall cFactorsUnitFactorParserRuleCall_2_1_0_0 = (RuleCall)cFactorsAssignment_2_1_0.eContents().get(0);
		private final Group cGroup_2_1_1 = (Group)cGroup_2_1.eContents().get(1);
		private final Keyword cAsteriskKeyword_2_1_1_0 = (Keyword)cGroup_2_1_1.eContents().get(0);
		private final Assignment cFactorsAssignment_2_1_1_1 = (Assignment)cGroup_2_1_1.eContents().get(1);
		private final RuleCall cFactorsUnitFactorParserRuleCall_2_1_1_1_0 = (RuleCall)cFactorsAssignment_2_1_1_1.eContents().get(0);
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		private final Keyword cSolidusKeyword_3_0 = (Keyword)cGroup_3.eContents().get(0);
		private final Alternatives cAlternatives_3_1 = (Alternatives)cGroup_3.eContents().get(1);
		private final Assignment cFactorsAssignment_3_1_0 = (Assignment)cAlternatives_3_1.eContents().get(0);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_3_1_0_0 = (RuleCall)cFactorsAssignment_3_1_0.eContents().get(0);
		...
		private final Assignment cFactorsAssignment_3_1_1_1 = (Assignment)cGroup_3_1_1.eContents().get(1);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_3_1_1_1_0 = (RuleCall)cFactorsAssignment_3_1_1_1.eContents().get(0);
		private final Group cGroup_3_1_1_2 = (Group)cGroup_3_1_1.eContents().get(2);
		private final Keyword cAsteriskKeyword_3_1_1_2_0 = (Keyword)cGroup_3_1_1_2.eContents().get(0);
		private final Assignment cFactorsAssignment_3_1_1_2_1 = (Assignment)cGroup_3_1_1_2.eContents().get(1);
		private final RuleCall cFactorsUnitDenominatorFactorParserRuleCall_3_1_1_2_1_0 = (RuleCall)cFactorsAssignment_3_1_1_2_1.eContents().get(0);
		...
		//ONE
		public RuleCall getONETerminalRuleCall_2_0() { return cONETerminalRuleCall_2_0; }
		...
		//UnitFactor
		public RuleCall getFactorsUnitFactorParserRuleCall_2_1_0_0() { return cFactorsUnitFactorParserRuleCall_2_1_0_0; }

		//("*" factors+=UnitFactor)*
		public Group getGroup_2_1_1() { return cGroup_2_1_1; }

		//"*"
		public Keyword getAsteriskKeyword_2_1_1_0() { return cAsteriskKeyword_2_1_1_0; }

		//factors+=UnitFactor
		public Assignment getFactorsAssignment_2_1_1_1() { return cFactorsAssignment_2_1_1_1; }

		//UnitFactor
		public RuleCall getFactorsUnitFactorParserRuleCall_2_1_1_1_0() { return cFactorsUnitFactorParserRuleCall_2_1_1_1_0; }
		...
		//factors+=UnitDenominatorFactor
		public Assignment getFactorsAssignment_3_1_0() { return cFactorsAssignment_3_1_0; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_3_1_0_0() { return cFactorsUnitDenominatorFactorParserRuleCall_3_1_0_0; }
		...
		//factors+=UnitDenominatorFactor
		public Assignment getFactorsAssignment_3_1_1_1() { return cFactorsAssignment_3_1_1_1; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_3_1_1_1_0() { return cFactorsUnitDenominatorFactorParserRuleCall_3_1_1_1_0; }

		//("*" factors+=UnitDenominatorFactor)*
		public Group getGroup_3_1_1_2() { return cGroup_3_1_1_2; }

		//"*"
		public Keyword getAsteriskKeyword_3_1_1_2_0() { return cAsteriskKeyword_3_1_1_2_0; }

		//factors+=UnitDenominatorFactor
		public Assignment getFactorsAssignment_3_1_1_2_1() { return cFactorsAssignment_3_1_1_2_1; }

		//UnitDenominatorFactor
		public RuleCall getFactorsUnitDenominatorFactorParserRuleCall_3_1_1_2_1_0() { return cFactorsUnitDenominatorFactorParserRuleCall_3_1_1_2_1_0; }
	...
	public class UnitFactorElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cSymbolUnitSymbolCrossReference_0_0 = (CrossReference)cSymbolAssignment_0.eContents().get(0);
		private final RuleCall cSymbolUnitSymbolQualifiedNameParserRuleCall_0_0_1 = (RuleCall)cSymbolUnitSymbolCrossReference_0_0.eContents().get(1);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		...
		//[UnitSymbol|QualifiedName]
		public CrossReference getSymbolUnitSymbolCrossReference_0_0() { return cSymbolUnitSymbolCrossReference_0_0; }

		//QualifiedName
		public RuleCall getSymbolUnitSymbolQualifiedNameParserRuleCall_0_0_1() { return cSymbolUnitSymbolQualifiedNameParserRuleCall_0_0_1; }
	...
	public class UnitDenominatorFactorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "UnitDenominatorFactor");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cSymbolAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final CrossReference cSymbolUnitSymbolCrossReference_0_0 = (CrossReference)cSymbolAssignment_0.eContents().get(0);
		private final RuleCall cSymbolUnitSymbolQualifiedNameParserRuleCall_0_0_1 = (RuleCall)cSymbolUnitSymbolCrossReference_0_0.eContents().get(1);
		...
		private final Keyword cCircumflexAccentKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final Assignment cExponentAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final RuleCall cExponentUnitDenominatorExponentParserRuleCall_1_1_0 = (RuleCall)cExponentAssignment_1_1.eContents().get(0);
		...
		public RuleCall getExponentUnitDenominatorExponentParserRuleCall_1_1_0() { return cExponentUnitDenominatorExponentParserRuleCall_1_1_0; }
	}
	...
	public class UnitDenominatorExponentElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "UnitDenominatorExponent");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cHyphenMinusKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final RuleCall cValidIntParserRuleCall_1 = (RuleCall)cGroup.eContents().get(1);
	...
	public class QualifiedNameWithUnitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "QualifiedNameWithUnit");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final RuleCall cValidIDWithUnitParserRuleCall_0 = (RuleCall)cGroup.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Keyword cFullStopKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final RuleCall cValidIDWithUnitParserRuleCall_1_1 = (RuleCall)cGroup_1.eContents().get(1);
		...
		//ValidIDWithUnit
		public RuleCall getValidIDWithUnitParserRuleCall_0() { return cValidIDWithUnitParserRuleCall_0; }
		...
		//ValidIDWithUnit
		public RuleCall getValidIDWithUnitParserRuleCall_1_1() { return cValidIDWithUnitParserRuleCall_1_1; }
	}
	...
	public class ValidIDWithUnitElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "ValidIDWithUnit");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class FunctionKindElements extends AbstractEnumRuleElementFinder {
		...
		//enum FunctionKind:
		//	Synchronous="synchronous" | Continuous="continuous";
	...
	private DerivedUnitDeclarationElements pDerivedUnitDeclaration;
	...
	private StandardFunctionDeclarationElements pStandardFunctionDeclaration;
	private FunctionKindElements unknownRuleFunctionKind;
	private StandardInputParameterDeclarationElements pStandardInputParameterDeclaration;
	private StandardOutputParameterDeclarationElements pStandardOutputParameterDeclaration;
	private CheckElements pCheck;
	private CheckArgumentElements pCheckArgument;
	private TypeCheckArgumentElements pTypeCheckArgument;
	private ExpressionCheckArgumentElements pExpressionCheckArgument;
	...
	private AnonymousArrayTypeElements pAnonymousArrayType;
	private DeclaredArrayTypeElements pDeclaredArrayType;
	...
	private InspectExpressionElements pInspectExpression;
	private InspectWhenClauseElements pInspectWhenClause;
	...
	private UnitConversionExpressionElements pUnitConversionExpression;
	...
	private MemberAccessElements pMemberAccess;
	...
	private RecordConstructionOperatorElements pRecordConstructionOperator;
	private RecordConstructionMemberElements pRecordConstructionMember;
	private UnionConstructionOperatorElements pUnionConstructionOperator;
	private UnionTypeSpecifierElements pUnionTypeSpecifier;
	private AnonymousUnionTypeSpecifierElements pAnonymousUnionTypeSpecifier;
	...
	private AssignableMemberFeatureReferenceElements pAssignableMemberFeatureReference;
	...
	private ImplicitUnitElements pImplicitUnit;
	private ImplicitUnitWithAnyElements pImplicitUnitWithAny;
	private ExplicitUnitElements pExplicitUnit;
	private UnitFactorElements pUnitFactor;
	private UnitDenominatorFactorElements pUnitDenominatorFactor;
	private UnitExponentElements pUnitExponent;
	private UnitDenominatorExponentElements pUnitDenominatorExponent;
	private QualifiedNameElements pQualifiedName;
	private QualifiedNameWithUnitElements pQualifiedNameWithUnit;
	private QualifiedNameWithWildcardElements pQualifiedNameWithWildcard;
	private ValidIntElements pValidInt;
	private ValidIDElements pValidID;
	private ValidIDWithUnitElements pValidIDWithUnit;
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eclipse.damos.mscript.Mscript".equals(grammar.getName())) {
				return grammar;
			}
	...
	public UnitDeclarationElements getUnitDeclarationAccess() {
		return (pUnitDeclaration != null) ? pUnitDeclaration : (pUnitDeclaration = new UnitDeclarationElements());
	}
	...
	//BaseUnitDeclaration:
	//	"unit" name=ValidID;
	public BaseUnitDeclarationElements getBaseUnitDeclarationAccess() {
		return (pBaseUnitDeclaration != null) ? pBaseUnitDeclaration : (pBaseUnitDeclaration = new BaseUnitDeclarationElements());
	}
	...
	//DerivedUnitDeclaration:
	//	"unit" name=ValidID "=" definition=UnitDefinition;
	public DerivedUnitDeclarationElements getDerivedUnitDeclarationAccess() {
		return (pDerivedUnitDeclaration != null) ? pDerivedUnitDeclaration : (pDerivedUnitDeclaration = new DerivedUnitDeclarationElements());
	}
	
	public ParserRule getDerivedUnitDeclarationRule() {
		return getDerivedUnitDeclarationAccess().getRule();
	}
	...
	//	stateVariableDeclarations+=StateVariableDeclaration | constantDeclarations+=ConstantDeclaration |
	//	equations+=Equation)* "}";
	public StandardFunctionDeclarationElements getStandardFunctionDeclarationAccess() {
		return (pStandardFunctionDeclaration != null) ? pStandardFunctionDeclaration : (pStandardFunctionDeclaration = new StandardFunctionDeclarationElements());
	}
	
	public ParserRule getStandardFunctionDeclarationRule() {
		return getStandardFunctionDeclarationAccess().getRule();
	}
	...
	public ParserRule getStandardInputParameterDeclarationRule() {
		return getStandardInputParameterDeclarationAccess().getRule();
	}

	//StandardOutputParameterDeclaration:
	//	name=ValidID;
	public StandardOutputParameterDeclarationElements getStandardOutputParameterDeclarationAccess() {
		return (pStandardOutputParameterDeclaration != null) ? pStandardOutputParameterDeclaration : (pStandardOutputParameterDeclaration = new StandardOutputParameterDeclarationElements());
	}
	
	public ParserRule getStandardOutputParameterDeclarationRule() {
		return getStandardOutputParameterDeclarationAccess().getRule();
	}
	...
	//CheckArgument:
	//	TypeCheckArgument | ExpressionCheckArgument;
	public CheckArgumentElements getCheckArgumentAccess() {
		return (pCheckArgument != null) ? pCheckArgument : (pCheckArgument = new CheckArgumentElements());
	}
	...
	//TypeCheckArgument:
	//	typeSpecifier=TypeSpecifier;
	public TypeCheckArgumentElements getTypeCheckArgumentAccess() {
		return (pTypeCheckArgument != null) ? pTypeCheckArgument : (pTypeCheckArgument = new TypeCheckArgumentElements());
	}
	...
	//ExpressionCheckArgument:
	//	"<" expression=Expression ">";
	public ExpressionCheckArgumentElements getExpressionCheckArgumentAccess() {
		return (pExpressionCheckArgument != null) ? pExpressionCheckArgument : (pExpressionCheckArgument = new ExpressionCheckArgumentElements());
	}
	...
	//	(PrimitiveType | CompositeType) ({AnonymousArrayType.elementType=current} "[" dimensions+=ArrayDimension (","
	//	dimensions+=ArrayDimension)* "]")?;
	public AnonymousArrayTypeElements getAnonymousArrayTypeAccess() {
		return (pAnonymousArrayType != null) ? pAnonymousArrayType : (pAnonymousArrayType = new AnonymousArrayTypeElements());
	}
	...
	//	elementTypeDeclaration=[TypeDeclaration|QualifiedName] "[" dimensions+=ArrayDimension (","
	//	dimensions+=ArrayDimension)* "]";
	public DeclaredArrayTypeElements getDeclaredArrayTypeAccess() {
		return (pDeclaredArrayType != null) ? pDeclaredArrayType : (pDeclaredArrayType = new DeclaredArrayTypeElements());
	}
	...
	//InspectExpression:
	//	"inspect" unionExpression=Expression whenClauses+=InspectWhenClause*;
	public InspectExpressionElements getInspectExpressionAccess() {
		return (pInspectExpression != null) ? pInspectExpression : (pInspectExpression = new InspectExpressionElements());
	}
	...
	//InspectWhenClause:
	//	"when" name=ValidID ":" expression=Expression;
	public InspectWhenClauseElements getInspectWhenClauseAccess() {
		return (pInspectWhenClause != null) ? pInspectWhenClause : (pInspectWhenClause = new InspectWhenClauseElements());
	}
	...
	//UnitConversionExpression returns Expression:
	//	PostfixUnaryExpression ({UnitConversionExpression.operand=current} "as" unit=ExplicitUnit)?;
	public UnitConversionExpressionElements getUnitConversionExpressionAccess() {
		return (pUnitConversionExpression != null) ? pUnitConversionExpression : (pUnitConversionExpression = new UnitConversionExpressionElements());
	}
	...
	public MemberAccessElements getMemberAccessAccess() {
		return (pMemberAccess != null) ? pMemberAccess : (pMemberAccess = new MemberAccessElements());
	}
	...
	//QualifiedFeatureReference returns Expression:
	//	{FeatureReference} "." feature=[CallableElement|QualifiedNameWithUnit];
	public QualifiedFeatureReferenceElements getQualifiedFeatureReferenceAccess() {
		return (pQualifiedFeatureReference != null) ? pQualifiedFeatureReference : (pQualifiedFeatureReference = new QualifiedFeatureReferenceElements());
	}
	...
	//RecordConstructionOperator:
	//	label=ValidID? "{" members+=RecordConstructionMember ("," members+=RecordConstructionMember)* "}";
	public RecordConstructionOperatorElements getRecordConstructionOperatorAccess() {
		return (pRecordConstructionOperator != null) ? pRecordConstructionOperator : (pRecordConstructionOperator = new RecordConstructionOperatorElements());
	}
	...
	//RecordConstructionMember:
	//	name=ValidID "=" value=Expression;
	public RecordConstructionMemberElements getRecordConstructionMemberAccess() {
		return (pRecordConstructionMember != null) ? pRecordConstructionMember : (pRecordConstructionMember = new RecordConstructionMemberElements());
	}
	...
	//UnionConstructionOperator:
	//	"new" typeSpecifier=UnionTypeSpecifier "with" member=[CompositeTypeMember|ValidID] "=" value=Expression;
	public UnionConstructionOperatorElements getUnionConstructionOperatorAccess() {
		return (pUnionConstructionOperator != null) ? pUnionConstructionOperator : (pUnionConstructionOperator = new UnionConstructionOperatorElements());
	}
	...
	//UnionTypeSpecifier returns TypeSpecifier:
	//	AnonymousUnionTypeSpecifier | DeclaredTypeSpecifier;
	public UnionTypeSpecifierElements getUnionTypeSpecifierAccess() {
		return (pUnionTypeSpecifier != null) ? pUnionTypeSpecifier : (pUnionTypeSpecifier = new UnionTypeSpecifierElements());
	}
	...
	//AnonymousUnionTypeSpecifier returns AnonymousTypeSpecifier:
	//	type=UnionType;
	public AnonymousUnionTypeSpecifierElements getAnonymousUnionTypeSpecifierAccess() {
		return (pAnonymousUnionTypeSpecifier != null) ? pAnonymousUnionTypeSpecifier : (pAnonymousUnionTypeSpecifier = new AnonymousUnionTypeSpecifierElements());
	}
	...
	//	AssignablePrimaryExpression ({ArrayElementAccess.array=current} "[" subscripts+=ArraySubscript (","
	//	subscripts+=ArraySubscript)* "]" | {MemberVariableAccess.target=current} "." memberVariable=ValidID)*;
	public AssignableMemberFeatureReferenceElements getAssignableMemberFeatureReferenceAccess() {
		return (pAssignableMemberFeatureReference != null) ? pAssignableMemberFeatureReference : (pAssignableMemberFeatureReference = new AssignableMemberFeatureReferenceElements());
	}
	...
	//	{Unit} ("(" (ONE | factors+=UnitFactor ("*" factors+=UnitFactor)*) ("/" (factors+=UnitDenominatorFactor | "("
	//	factors+=UnitDenominatorFactor ("*" factors+=UnitDenominatorFactor)* ")"))? ")")?;
	public ImplicitUnitElements getImplicitUnitAccess() {
		return (pImplicitUnit != null) ? pImplicitUnit : (pImplicitUnit = new ImplicitUnitElements());
	}
	...
	//	{Unit} ("(" (any?="?" | (ONE | factors+=UnitFactor ("*" factors+=UnitFactor)*) ("/" (factors+=UnitDenominatorFactor |
	//	"(" factors+=UnitDenominatorFactor ("*" factors+=UnitDenominatorFactor)* ")"))?) ")")?;
	public ImplicitUnitWithAnyElements getImplicitUnitWithAnyAccess() {
		return (pImplicitUnitWithAny != null) ? pImplicitUnitWithAny : (pImplicitUnitWithAny = new ImplicitUnitWithAnyElements());
	}
	...
	//UnitDenominatorFactor:
	//	symbol=[UnitSymbol|QualifiedName] ("^" exponent=UnitDenominatorExponent)?;
	public UnitDenominatorFactorElements getUnitDenominatorFactorAccess() {
		return (pUnitDenominatorFactor != null) ? pUnitDenominatorFactor : (pUnitDenominatorFactor = new UnitDenominatorFactorElements());
	}
	...
	//UnitDenominatorExponent returns ecore::EInt:
	//	"-"? ValidInt;
	public UnitDenominatorExponentElements getUnitDenominatorExponentAccess() {
		return (pUnitDenominatorExponent != null) ? pUnitDenominatorExponent : (pUnitDenominatorExponent = new UnitDenominatorExponentElements());
	}
	...
	//QualifiedNameWithUnit:
	//	ValidIDWithUnit ("." ValidIDWithUnit)*;
	public QualifiedNameWithUnitElements getQualifiedNameWithUnitAccess() {
		return (pQualifiedNameWithUnit != null) ? pQualifiedNameWithUnit : (pQualifiedNameWithUnit = new QualifiedNameWithUnitElements());
	}
	...
	//ValidIDWithUnit:
	//	ValidID | "unit";
	public ValidIDWithUnitElements getValidIDWithUnitAccess() {
		return (pValidIDWithUnit != null) ? pValidIDWithUnit : (pValidIDWithUnit = new ValidIDWithUnitElements());
	}
