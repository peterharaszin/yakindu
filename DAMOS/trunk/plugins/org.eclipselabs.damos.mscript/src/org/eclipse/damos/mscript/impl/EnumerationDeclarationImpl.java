...
import org.eclipse.damos.mscript.EnumerationDeclaration;
import org.eclipse.damos.mscript.EnumerationLiteralDeclaration;
 ...
 * <ul>
 *   <li>{@link org.eclipse.damos.mscript.impl.EnumerationDeclarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.damos.mscript.impl.EnumerationDeclarationImpl#getLiteralDeclarations <em>Literal Declarations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EnumerationDeclarationImpl extends TopLevelDeclarationImpl implements EnumerationDeclaration {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.ENUMERATION_DECLARATION__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MscriptPackage.ENUMERATION_DECLARATION__NAME:
				return getName();
			case MscriptPackage.ENUMERATION_DECLARATION__LITERAL_DECLARATIONS:
