 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.computationmodel.impl.NumberFormatImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NumberFormatImpl extends EObjectImpl implements NumberFormat {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComputationModelPackage.NUMBER_FORMAT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComputationModelPackage.NUMBER_FORMAT__NAME:
				return getName();
		}
