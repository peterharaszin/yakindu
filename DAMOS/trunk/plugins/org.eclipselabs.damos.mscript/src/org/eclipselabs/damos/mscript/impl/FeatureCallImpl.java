 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.FeatureCallImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class FeatureCallImpl extends ExpressionImpl implements FeatureCall {
	...
	protected EClass eStaticClass() {
		return MscriptPackage.Literals.FEATURE_CALL;
	}
		...
		if (feature != null && feature.eIsProxy()) {
			...
			if (feature != oldFeature) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MscriptPackage.FEATURE_CALL__FEATURE, oldFeature, feature));
			}
		}
		return feature;
	}
	...
	public void setFeature(CallableElement newFeature) {
		...
		feature = newFeature;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.FEATURE_CALL__FEATURE, oldFeature, feature));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MscriptPackage.FEATURE_CALL__FEATURE:
