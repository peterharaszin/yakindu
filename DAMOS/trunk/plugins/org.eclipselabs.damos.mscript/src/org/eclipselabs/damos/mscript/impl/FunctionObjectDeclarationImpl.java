 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.FunctionObjectDeclarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.FunctionObjectDeclarationImpl#getFunctionName <em>Function Name</em>}</li>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.FunctionObjectDeclarationImpl#getTemplateArguments <em>Template Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class FunctionObjectDeclarationImpl extends CallableElementImpl implements FunctionObjectDeclaration {
	...
	protected EClass eStaticClass() {
		return MscriptPackage.Literals.FUNCTION_OBJECT_DECLARATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.FUNCTION_OBJECT_DECLARATION__NAME, oldName, name));
	}
	...
	public EList<Expression> getTemplateArguments() {
		if (templateArguments == null) {
			templateArguments = new EObjectContainmentEList<Expression>(Expression.class, this, MscriptPackage.FUNCTION_OBJECT_DECLARATION__TEMPLATE_ARGUMENTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MscriptPackage.FUNCTION_OBJECT_DECLARATION__NAME:
				return getName();
