 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.LambdaExpressionImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.LambdaExpressionImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LambdaExpressionImpl extends ExpressionImpl implements LambdaExpression {
	...
	protected EClass eStaticClass() {
		return MscriptPackage.Literals.LAMBDA_EXPRESSION;
	}
	...
	public NotificationChain basicSetExpression(Expression newExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MscriptPackage.LAMBDA_EXPRESSION__EXPRESSION, oldExpression, newExpression);
	...
	public void setExpression(Expression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.LAMBDA_EXPRESSION__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.LAMBDA_EXPRESSION__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.LAMBDA_EXPRESSION__EXPRESSION, newExpression, newExpression));
	}
