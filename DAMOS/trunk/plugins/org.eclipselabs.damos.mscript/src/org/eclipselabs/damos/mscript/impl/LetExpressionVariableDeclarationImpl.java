 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.LetExpressionVariableDeclarationImpl#getParts <em>Parts</em>}</li>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.LetExpressionVariableDeclarationImpl#getAssignedExpression <em>Assigned Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LetExpressionVariableDeclarationImpl extends MinimalEObjectImpl.Container implements LetExpressionVariableDeclaration {
	...
	protected EClass eStaticClass() {
		return MscriptPackage.Literals.LET_EXPRESSION_VARIABLE_DECLARATION;
	}
	...
	public EList<LetExpressionVariableDeclarationPart> getParts() {
		if (parts == null) {
			parts = new EObjectContainmentEList<LetExpressionVariableDeclarationPart>(LetExpressionVariableDeclarationPart.class, this, MscriptPackage.LET_EXPRESSION_VARIABLE_DECLARATION__PARTS);
		}
		return parts;
	}
	...
	public NotificationChain basicSetAssignedExpression(Expression newAssignedExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MscriptPackage.LET_EXPRESSION_VARIABLE_DECLARATION__ASSIGNED_EXPRESSION, oldAssignedExpression, newAssignedExpression);
	...
	public void setAssignedExpression(Expression newAssignedExpression) {
		if (newAssignedExpression != assignedExpression) {
			...
			if (assignedExpression != null)
				msgs = ((InternalEObject)assignedExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.LET_EXPRESSION_VARIABLE_DECLARATION__ASSIGNED_EXPRESSION, null, msgs);
			if (newAssignedExpression != null)
				msgs = ((InternalEObject)newAssignedExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.LET_EXPRESSION_VARIABLE_DECLARATION__ASSIGNED_EXPRESSION, null, msgs);
			msgs = basicSetAssignedExpression(newAssignedExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.LET_EXPRESSION_VARIABLE_DECLARATION__ASSIGNED_EXPRESSION, newAssignedExpression, newAssignedExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MscriptPackage.LET_EXPRESSION_VARIABLE_DECLARATION__PARTS:
				return ((InternalEList<?>)getParts()).basicRemove(otherEnd, msgs);
			case MscriptPackage.LET_EXPRESSION_VARIABLE_DECLARATION__ASSIGNED_EXPRESSION:
