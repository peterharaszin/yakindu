 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.PowerExpressionImpl#getOperand <em>Operand</em>}</li>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.PowerExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.PowerExpressionImpl#getExponent <em>Exponent</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PowerExpressionImpl extends ExpressionImpl implements PowerExpression {
	...
	public NotificationChain basicSetOperand(Expression newOperand, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MscriptPackage.POWER_EXPRESSION__OPERAND, oldOperand, newOperand);
	...
	public void setOperand(Expression newOperand) {
		if (newOperand != operand) {
			...
			if (operand != null)
				msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.POWER_EXPRESSION__OPERAND, null, msgs);
			if (newOperand != null)
				msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.POWER_EXPRESSION__OPERAND, null, msgs);
			msgs = basicSetOperand(newOperand, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.POWER_EXPRESSION__OPERAND, newOperand, newOperand));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MscriptPackage.POWER_EXPRESSION__OPERAND:
