 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.StringLiteralImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralImpl extends LiteralImpl implements StringLiteral {
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.STRING_LITERAL__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MscriptPackage.STRING_LITERAL__TEXT:
				return getText();
		}
