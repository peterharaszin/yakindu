 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.StructConstructionOperatorImpl#getLabel <em>Label</em>}</li>
...
public class StructConstructionOperatorImpl extends ExpressionImpl implements StructConstructionOperator {
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.STRUCT_CONSTRUCTION_OPERATOR__LABEL, oldLabel, label));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MscriptPackage.STRUCT_CONSTRUCTION_OPERATOR__LABEL:
				return getLabel();
			case MscriptPackage.STRUCT_CONSTRUCTION_OPERATOR__MEMBERS:
				return getMembers();
		}
