 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.UnitProductImpl#getFactors <em>Factors</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class UnitProductImpl extends MinimalEObjectImpl.Container implements UnitProduct {
	/**
	...
	protected EClass eStaticClass() {
		return MscriptPackage.Literals.UNIT_PRODUCT;
	}
	...
	public EList<UnitFactor> getFactors() {
		if (factors == null) {
			factors = new EObjectContainmentEList<UnitFactor>(UnitFactor.class, this, MscriptPackage.UNIT_PRODUCT__FACTORS);
		}
		return factors;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MscriptPackage.UNIT_PRODUCT__FACTORS:
