 ...
 * <ul>
 *   <li>{@link org.eclipselabs.damos.mscript.impl.VariableAccessImpl#getStepExpression <em>Step Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableAccessImpl extends FeatureCallImpl implements VariableAccess {
	...
	protected EClass eStaticClass() {
		return MscriptPackage.Literals.VARIABLE_ACCESS;
	}
	...
	public NotificationChain basicSetStepExpression(StepExpression newStepExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MscriptPackage.VARIABLE_ACCESS__STEP_EXPRESSION, oldStepExpression, newStepExpression);
	...
	public void setStepExpression(StepExpression newStepExpression) {
		if (newStepExpression != stepExpression) {
			...
			if (stepExpression != null)
				msgs = ((InternalEObject)stepExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.VARIABLE_ACCESS__STEP_EXPRESSION, null, msgs);
			if (newStepExpression != null)
				msgs = ((InternalEObject)newStepExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MscriptPackage.VARIABLE_ACCESS__STEP_EXPRESSION, null, msgs);
			msgs = basicSetStepExpression(newStepExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.VARIABLE_ACCESS__STEP_EXPRESSION, newStepExpression, newStepExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MscriptPackage.VARIABLE_ACCESS__STEP_EXPRESSION:
