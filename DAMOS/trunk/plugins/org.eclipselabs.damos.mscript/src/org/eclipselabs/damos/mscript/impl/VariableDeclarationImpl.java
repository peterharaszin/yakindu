...
public abstract class VariableDeclarationImpl extends CallableElementImpl implements VariableDeclaration {
	...
	protected EClass eStaticClass() {
		return MscriptPackage.Literals.VARIABLE_DECLARATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MscriptPackage.VARIABLE_DECLARATION__NAME, oldName, name));
	}
