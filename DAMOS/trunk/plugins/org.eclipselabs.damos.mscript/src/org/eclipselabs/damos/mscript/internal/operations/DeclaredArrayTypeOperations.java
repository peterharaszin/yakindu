 ...
 *
 */
public class DeclaredArrayTypeOperations {

	public static Type getElementType(DeclaredArrayType declaredArrayType) {
		TypeDeclaration typeDeclaration = declaredArrayType.getElementTypeDeclaration();
		if (typeDeclaration != null) {
			TypeSpecifier typeSpecifier = typeDeclaration.getTypeSpecifier();
