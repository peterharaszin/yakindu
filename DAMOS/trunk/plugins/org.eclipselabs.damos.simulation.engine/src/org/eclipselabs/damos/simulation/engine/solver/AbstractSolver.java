...
public abstract class AbstractSolver implements ISolver {
	...
	/* (non-Javadoc)
	 * @see org.eclipselabs.damos.simulation.engine.solver.ISolver#initialize(org.eclipselabs.damos.simulation.engine.internal.ISimulationContext, org.eclipselabs.damos.simulation.core.ISimulationMonitor)
	 */
