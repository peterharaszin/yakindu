...
public abstract class EmbeddedRungeKuttaSolver extends AdaptiveStepSizeSolver implements ISolver {
	...
	/* (non-Javadoc)
	 * @see org.eclipselabs.damos.simulation.engine.solver.AdaptiveStepSizeSolver#initialize(org.eclipselabs.damos.simulation.engine.ISimulationContext, org.eclipselabs.damos.execution.executionflow.Graph, org.eclipselabs.damos.simulation.engine.ISimulationMonitor)
	 */
	@Override
