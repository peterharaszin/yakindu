...
public class SimulationModelItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSolverIdPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Solver Id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSolverIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SimulationModel_solverId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SimulationModel_solverId_feature", "_UI_SimulationModel_type"),
				 SimulationModelPackage.Literals.SIMULATION_MODEL__SOLVER_ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SimulationModelPackage.Literals.SIMULATION_MODEL__SOLVER_CONFIGURATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SimulationModelPackage.Literals.SIMULATION_MODEL__SOLVER_CONFIGURATION,
				 SimulationModelFactory.eINSTANCE.createFixedStepSizeSolverConfiguration()));

		newChildDescriptors.add
			(createChildParameter
				(SimulationModelPackage.Literals.SIMULATION_MODEL__SOLVER_CONFIGURATION,
				 SimulationModelFactory.eINSTANCE.createAdaptiveStepSizeSolverConfiguration()));
	}
