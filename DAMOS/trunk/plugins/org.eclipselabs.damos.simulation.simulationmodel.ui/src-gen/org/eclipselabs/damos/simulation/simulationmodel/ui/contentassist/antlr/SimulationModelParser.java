...
* generated by Xtext
*/
package org.eclipselabs.damos.simulation.simulationmodel.ui.contentassist.antlr;
...
public class SimulationModelParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipselabs.damos.simulation.simulationmodel.ui.contentassist.antlr.internal.InternalSimulationModelParser createParser() {
		org.eclipselabs.damos.simulation.simulationmodel.ui.contentassist.antlr.internal.InternalSimulationModelParser result = new org.eclipselabs.damos.simulation.simulationmodel.ui.contentassist.antlr.internal.InternalSimulationModelParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getValidParameterNameAccess().getAlternatives(), "rule__ValidParameterName__Alternatives");
					...
					put(grammarAccess.getSimulationModelAccess().getGroup(), "rule__SimulationModel__Group__0");
					put(grammarAccess.getSimulationModelAccess().getGroup_4_0(), "rule__SimulationModel__Group_4_0__0");
					put(grammarAccess.getSimulationModelAccess().getGroup_4_1(), "rule__SimulationModel__Group_4_1__0");
					put(grammarAccess.getSolverConfigurationAccess().getGroup(), "rule__SolverConfiguration__Group__0");
					put(grammarAccess.getSolverConfigurationAccess().getGroup_2(), "rule__SolverConfiguration__Group_2__0");
					put(grammarAccess.getSolverArgumentAccess().getGroup(), "rule__SolverArgument__Group__0");
					...
					put(grammarAccess.getSimulationModelAccess().getSimulationTimeAssignment_4_1_1(), "rule__SimulationModel__SimulationTimeAssignment_4_1_1");
					put(grammarAccess.getSimulationModelAccess().getSolverConfigurationAssignment_4_2(), "rule__SimulationModel__SolverConfigurationAssignment_4_2");
					put(grammarAccess.getSolverConfigurationAccess().getTypeAssignment_1(), "rule__SolverConfiguration__TypeAssignment_1");
					put(grammarAccess.getSolverConfigurationAccess().getArgumentsAssignment_2_1(), "rule__SolverConfiguration__ArgumentsAssignment_2_1");
					put(grammarAccess.getSolverArgumentAccess().getParameterAssignment_0(), "rule__SolverArgument__ParameterAssignment_0");
					put(grammarAccess.getSolverArgumentAccess().getValueAssignment_2(), "rule__SolverArgument__ValueAssignment_2");
					...
					put(grammarAccess.getSimulationModelAccess().getUnorderedGroup_4(), "rule__SimulationModel__UnorderedGroup_4");
				}
			};
		}
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipselabs.damos.simulation.simulationmodel.ui.contentassist.antlr.internal.InternalSimulationModelParser typedParser = (org.eclipselabs.damos.simulation.simulationmodel.ui.contentassist.antlr.internal.InternalSimulationModelParser) parser;
			typedParser.entryRuleSimulationModel();
