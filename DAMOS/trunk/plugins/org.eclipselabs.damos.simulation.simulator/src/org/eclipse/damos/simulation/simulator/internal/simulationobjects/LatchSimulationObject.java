...
public class LatchSimulationObject extends AbstractSimulationObject {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.AbstractSimulationObject#initialize(org.eclipse.core.runtime.IProgressMonitor)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.eclipse.damos.simulation.simulator.AbstractSimulationObject#getNode()
	 */
	@Override
