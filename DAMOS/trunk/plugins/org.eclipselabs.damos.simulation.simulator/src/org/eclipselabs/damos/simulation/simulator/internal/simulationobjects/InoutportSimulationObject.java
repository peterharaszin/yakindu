...
public class InoutportSimulationObject extends AbstractComponentSimulationObject {
	...
	/* (non-Javadoc)
	 * @see org.eclipselabs.damos.simulation.simulator.AbstractComponentSimulationObject#computeOutputValues(double, org.eclipselabs.damos.simulation.core.ISimulationMonitor)
	 */
	@Override
