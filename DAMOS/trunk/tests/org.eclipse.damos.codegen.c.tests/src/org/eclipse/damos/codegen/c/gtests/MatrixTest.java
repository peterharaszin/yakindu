 ...
 *
 */
@GTest(sourceFile="gtests/MatrixTest.cpp", program="gtests/MatrixTest")
public class MatrixTest extends AbstractGeneratorGTest {
	...
	public void setUp() {
		...
		Block structConstructionTest = createTestBlock("MatrixTest", "MatrixTest");
		Outport outport1 = createOutport("Out1", createDataTypeSpecification("int[3, 2]"));
		Outport outport2 = createOutport("Out2", createDataTypeSpecification("int[3, 2]"));
