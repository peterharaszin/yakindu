 ...
 *
 */
@GTest(sourceFile="gtests/MatrixVectorMultiplyTest.cpp", program="gtests/MatrixVectorMultiplyTest")
public class MatrixVectorMultiplyTest extends AbstractGeneratorGTest {
	...
	public void setUp() {
		...
		Block structConstructionTest = createTestBlock("MatrixVectorMultiplyTest", "MatrixVectorMultiplyTest");
		Outport outport = createOutport("Out", createDataTypeSpecification("real[3]"));
