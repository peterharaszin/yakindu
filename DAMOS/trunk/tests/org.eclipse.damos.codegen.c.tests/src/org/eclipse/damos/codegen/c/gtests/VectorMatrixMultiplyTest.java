 ...
 *
 */
@GTest(sourceFile="gtests/VectorMatrixMultiplyTest.cpp", program="gtests/VectorMatrixMultiplyTest")
public class VectorMatrixMultiplyTest extends AbstractGeneratorGTest {
	...
	public void setUp() {
		...
		Block structConstructionTest = createTestBlock("VectorMatrixMultiplyTest", "VectorMatrixMultiplyTest");
		Outport outport = createOutport("Out", createDataTypeSpecification("real[2]"));
