 ...
 *
 */
@GTest(sourceFile="gtests/VectorMultiplyTest.cpp", program="gtests/VectorMultiplyTest")
public class VectorMultiplyTest extends AbstractGeneratorGTest {
	...
	public void setUp() {
		...
		Block structConstructionTest = createTestBlock("VectorMultiplyTest", "VectorMultiplyTest");
		Outport outport = createOutport("Out", createDataTypeSpecification("real"));
