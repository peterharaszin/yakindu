...
public class AbstractSimulationTest extends AbstractExecutionTest {
	...
	protected static final String STEP = "damos.blocks.Step";
	protected static final String TRANSFER_FUNCTION = "damos.blocks.TransferFunction";
	protected static final String SCOPE = "damos.blocks.Scope";
