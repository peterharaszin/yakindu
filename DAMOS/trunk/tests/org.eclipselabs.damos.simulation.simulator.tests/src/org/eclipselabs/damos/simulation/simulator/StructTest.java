 ...
 *
 */
public class StructTest extends AbstractSimulationTest {
	...
	public void struct() {
		...
		Block structExtractXY = createTestBlock("StructExtractXY", "StructExtractXY");
		Block structExtractStructLiteral = createTestBlock("StructExtractStructLiteral", "StructExtractStructLiteral");
		...
		connect(structTest, 1, structExtractStructLiteral);
		connect(structExtractXY, 0, out1X);
		connect(structExtractXY, 1, out1Y);
		connect(structExtractStructLiteral, 0, out2X);
		connect(structExtractStructLiteral, 1, out2A);
		connect(structExtractStructLiteral, 2, out2B0);
		connect(structExtractStructLiteral, 3, out2B1);
