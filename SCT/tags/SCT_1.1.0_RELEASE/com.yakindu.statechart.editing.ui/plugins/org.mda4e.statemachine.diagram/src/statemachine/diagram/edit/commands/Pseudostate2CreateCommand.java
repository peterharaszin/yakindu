 ...
 * @generated
 */
public class Pseudostate2CreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public Pseudostate2CreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Pseudostate newElement = StatemachineFactory.eINSTANCE
				.createPseudostate();

		Region owner = (Region) getElementToEdit();
		owner.getState().add(newElement);

		StatemachineElementTypes.init_Pseudostate_3005(newElement);
