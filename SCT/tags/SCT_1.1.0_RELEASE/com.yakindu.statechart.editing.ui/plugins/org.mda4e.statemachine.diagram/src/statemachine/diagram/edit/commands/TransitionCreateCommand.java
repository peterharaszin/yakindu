...
public class TransitionCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final Statechart container;
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Transition newElement = StatemachineFactory.eINSTANCE
				.createTransition();
		getContainer().getTransition().add(newElement);
		newElement.setSourceNode(getSource());
		newElement.setTargetNode(getTarget());
		StatemachineElementTypes.init_Transition_4001(newElement);
	 ...
	 * @generated
	 */
	public Statechart getContainer() {
		return container;
	}
	 ...
	 * @generated
	 */
	private static Statechart deduceContainer(EObject source, EObject target) {
