 ...
 * @generated
 */
public class RegionPriorityEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RegionPriorityEditPart(View view) {
		super(view);
	}
			...
			parser = StatemachineParserProvider
					.getParser(
							...
							StatemachineVisualIDRegistry
									.getType(statemachine.diagram.edit.parts.RegionPriorityEditPart.VISUAL_ID));
		}
		return parser;
	}
