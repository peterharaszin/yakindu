 ...
 * @generated
 */
public class StateEntryEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StateEntryEditPart(View view) {
		super(view);
	}
			...
			parser = StatemachineParserProvider
					.getParser(
							...
							StatemachineVisualIDRegistry
									.getType(statemachine.diagram.edit.parts.StateEntryEditPart.VISUAL_ID));
		}
		return parser;
	}
