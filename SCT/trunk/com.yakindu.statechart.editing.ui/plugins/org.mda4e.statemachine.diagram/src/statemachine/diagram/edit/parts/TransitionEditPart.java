...
public class TransitionEditPart extends ConnectionNodeEditPart implements
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TransitionExpressionEditPart) {
			((TransitionExpressionEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureTransitionExpressionFigure());
			return true;
		}
	...
	public class TransitionFigure extends PolylineConnectionEx {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureTransitionExpressionFigure;
		...
		private void createContents() {
			...
			fFigureTransitionPriorityFigure.setText("<priority>");

			this.add(fFigureTransitionPriorityFigure);

			fFigureTransitionExpressionFigure = new WrappingLabel();
			fFigureTransitionExpressionFigure.setText("*");

			this.add(fFigureTransitionExpressionFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureTransitionExpressionFigure() {
			return fFigureTransitionExpressionFigure;
		}
