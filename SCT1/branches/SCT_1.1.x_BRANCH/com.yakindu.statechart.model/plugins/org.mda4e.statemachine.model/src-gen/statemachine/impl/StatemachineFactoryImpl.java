...
public class StatemachineFactoryImpl extends EFactoryImpl implements StatemachineFactory {
	...
	public static StatemachineFactory init() {
		try {
			StatemachineFactory theStatemachineFactory = (StatemachineFactory)EPackage.Registry.INSTANCE.getEFactory("org.mda4e.statemachine.model"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case StatemachinePackage.NODE: return createNode();
			...
			case StatemachinePackage.DATA_ELEMENT: return createDataElement();
			case StatemachinePackage.VARIABLE: return createVariable();
			case StatemachinePackage.EVENT: return createEvent();
			case StatemachinePackage.STATECHART: return createStatechart();
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case StatemachinePackage.PSEUDO_TYPES:
				return createPseudoTypesFromString(eDataType, initialValue);
			case StatemachinePackage.DATA_TYPES:
				return createDataTypesFromString(eDataType, initialValue);
			case StatemachinePackage.IO_TYPES:
				return createIOTypesFromString(eDataType, initialValue);
			case StatemachinePackage.TRIGGER_TYPES:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case StatemachinePackage.PSEUDO_TYPES:
				return convertPseudoTypesToString(eDataType, instanceValue);
			case StatemachinePackage.DATA_TYPES:
	 ...
	 * @generated
	 */
	public PseudoTypes createPseudoTypesFromString(EDataType eDataType, String initialValue) {
		PseudoTypes result = PseudoTypes.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertPseudoTypesToString(EDataType eDataType, Object instanceValue) {
