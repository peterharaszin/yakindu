...
<!-- Modifications to distinguish errors and warnings by Ingo Feltes <ingo.feltes@itemis.de> -->
      ...
      <tr>
        ...
        <th>Warning</th>
          ...
          <xsl:for-each select="file[@name and generate-id(.) = generate-id(key('files', @name))]">
                ...
                <xsl:variable name="errorCount" select="count(../file[@name=$currentName]/error[@severity='error'])"/>
                <xsl:variable name="warningCount" select="count(../file[@name=$currentName]/error[@severity='warning'])"/>
                <tr>
