...
typedef struct TimerElement_t {
	...
	uint64                       timeout;
	HistoryTest_TrgType          trigger;

} TimerElement;

static TimerElement Head;

void historyTest_timerIface_raiseTimer(HistoryTest_IfaceHandle* ihandle, HistoryTest_TrgType trigger)
{
    historyTest_Iface_raiseTrigger(ihandle, trigger);
}

void historyTest_timerIface_print()
{
...
void historyTest_timerIface_installTimer(HistoryTest_IfaceHandle* ihandle, HistoryTest_TrgType trigger, uint64 time_ms)
{
...
void historyTest_timerIface_resetTimer(HistoryTest_IfaceHandle* handle, HistoryTest_TrgType trigger)
{
...
void historyTest_timerIface_trigger(uint64 tics)
{
...
/*		printf("Raise %d %d\n", (uint32)actElem->timeout, (uint32)actElem->trigger);
		...
		historyTest_timerIface_raiseTimer(actElem->ihandle, actElem->trigger);
