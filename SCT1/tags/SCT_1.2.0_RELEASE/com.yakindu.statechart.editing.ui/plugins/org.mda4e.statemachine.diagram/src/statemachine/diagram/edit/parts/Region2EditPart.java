...
import statemachine.diagram.edit.policies.Region2ItemSemanticEditPolicy;
...
public class Region2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof RegionPriority2EditPart) {
			((RegionPriority2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureRegionPriorityFigure());
			return true;
		}
		if (childEditPart instanceof RegionRegionCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRegionCompartmentRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((RegionRegionCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof RegionRegionCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureRegionCompartmentRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((RegionRegionCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
