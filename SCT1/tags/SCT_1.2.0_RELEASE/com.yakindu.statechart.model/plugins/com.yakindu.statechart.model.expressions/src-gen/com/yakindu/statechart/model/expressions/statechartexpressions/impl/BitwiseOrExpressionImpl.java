 ...
 * <ul>
 *   <li>{@link com.yakindu.statechart.model.expressions.statechartexpressions.impl.BitwiseOrExpressionImpl#getOperand1 <em>Operand1</em>}</li>
 *   <li>{@link com.yakindu.statechart.model.expressions.statechartexpressions.impl.BitwiseOrExpressionImpl#getOperand2 <em>Operand2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BitwiseOrExpressionImpl extends MinimalEObjectImpl.Container implements BitwiseOrExpression
{
  ...
  {
    return StatechartexpressionsPackage.Literals.BITWISE_OR_EXPRESSION;
  }
  ...
  public NotificationChain basicSetOperand1(BitwiseAndExpression newOperand1, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StatechartexpressionsPackage.BITWISE_OR_EXPRESSION__OPERAND1, oldOperand1, newOperand1);
  ...
  public void setOperand1(BitwiseAndExpression newOperand1)
  {
    if (newOperand1 != operand1)
    {
      ...
      if (operand1 != null)
        msgs = ((InternalEObject)operand1).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StatechartexpressionsPackage.BITWISE_OR_EXPRESSION__OPERAND1, null, msgs);
      if (newOperand1 != null)
        msgs = ((InternalEObject)newOperand1).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StatechartexpressionsPackage.BITWISE_OR_EXPRESSION__OPERAND1, null, msgs);
      msgs = basicSetOperand1(newOperand1, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StatechartexpressionsPackage.BITWISE_OR_EXPRESSION__OPERAND1, newOperand1, newOperand1));
  }
  ...
  public NotificationChain basicSetOperand2(BitwiseAndExpression newOperand2, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StatechartexpressionsPackage.BITWISE_OR_EXPRESSION__OPERAND2, oldOperand2, newOperand2);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setOperand2(BitwiseAndExpression newOperand2)
  {
    if (newOperand2 != operand2)
    {
      NotificationChain msgs = null;
      if (operand2 != null)
        msgs = ((InternalEObject)operand2).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StatechartexpressionsPackage.BITWISE_OR_EXPRESSION__OPERAND2, null, msgs);
      if (newOperand2 != null)
        msgs = ((InternalEObject)newOperand2).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StatechartexpressionsPackage.BITWISE_OR_EXPRESSION__OPERAND2, null, msgs);
      msgs = basicSetOperand2(newOperand2, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StatechartexpressionsPackage.BITWISE_OR_EXPRESSION__OPERAND2, newOperand2, newOperand2));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case StatechartexpressionsPackage.BITWISE_OR_EXPRESSION__OPERAND1:
        return basicSetOperand1(null, msgs);
      case StatechartexpressionsPackage.BITWISE_OR_EXPRESSION__OPERAND2:
