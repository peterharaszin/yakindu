 ...
 */
package com.yakindu.simulation.engine.statechart.ui;
...
public class SimulationParameterTab extends AbstractLaunchConfigurationTab {
	...
	private void createParameterControls(final Composite parent) {
		...
		tTimeScaling.setText(SimulationParameterSet.TIME_SCALING_DEFAULT);
		...
		tSchedulerInterval.setText(SimulationParameterSet.SCHEDULER_INTERVAL_DEFAULT);
	}
