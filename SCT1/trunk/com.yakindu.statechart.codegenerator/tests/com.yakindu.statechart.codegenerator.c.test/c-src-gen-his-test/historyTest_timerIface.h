...
extern void historyTest_timerIface_installTimer(void* ihandle, uint32 trigger, uint64 time_ms);
extern void historyTest_timerIface_resetTimer(void* ihandle, uint32 trigger);

/* Interface funktion is called by the timer service to inform the state machine of a time-trigger event */
extern void historyTest_timerIface_raiseTimer(void* ihandle, uint32 trigger);
