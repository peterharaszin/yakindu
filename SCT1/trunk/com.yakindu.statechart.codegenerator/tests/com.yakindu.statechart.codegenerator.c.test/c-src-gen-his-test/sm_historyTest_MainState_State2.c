...
static void local_State6_handle(SM_HistoryTest_MainState_State2_Handle* rhandle);
static void local_Initial_handle(SM_HistoryTest_MainState_State2_Handle* rhandle);

static BOOL local_State6_analyseTransitionIn(SM_HistoryTest_MainState_State2_Handle* rhandle);
static BOOL local_Initial_analyseTransitionIn(SM_HistoryTest_MainState_State2_Handle* rhandle);

static void local_State6_enter(SM_HistoryTest_MainState_State2_Handle* rhandle);
static void local_Initial_enter(SM_HistoryTest_MainState_State2_Handle* rhandle);

static void local_State6_exit(SM_HistoryTest_MainState_State2_Handle* rhandle, HistoryTest_StateType oldState);
static void local_Initial_exit(SM_HistoryTest_MainState_State2_Handle* rhandle, HistoryTest_StateType oldState);
...
HistoryTest_StateType getLocalStateInThisRegion(HistoryTest_StateType globalState)
{
	...
	switch (globalState) {
      ...
      case st_historyTest_MainState_State2_State6: {
        stateInThisRegion = st_historyTest_MainState_State2_State6;
	 	break;
	  }
      ...
      case st_historyTest_MainState_State2_Initial: {
        stateInThisRegion = st_historyTest_MainState_State2_Initial;
	 	break;
	  }
...
BOOL sm_historyTest_MainState_State2_runCycle(SM_HistoryTest_MainState_State2_Handle* rhandle)
{
	...
	if (((sm_historyTest_MainState_State2_isIn(rhandle->global->state) == TRUE) && 
      ...
      sm_historyTest_MainState_State2_exit(rhandle, oldState);
	  ...
	  sm_historyTest_MainState_State2_enter(rhandle);
	}
	
  return(rhandle->global->state == oldState);
}

BOOL sm_historyTest_MainState_State2_isIn(HistoryTest_StateType testState)
{
	BOOL retvalue = FALSE;
...
void sm_historyTest_MainState_State2_enter(SM_HistoryTest_MainState_State2_Handle* rhandle)
{
  HistoryTest_StateType localState = getLocalStateInThisRegion(rhandle->global->state);
  ...
  switch (localState) {
    ...
    default: {
        rhandle->global->state = st_historyTest_MainState_State2_Initial;
        local_Initial_enter(rhandle);
      }
	}
...
void sm_historyTest_MainState_State2_exit(SM_HistoryTest_MainState_State2_Handle* rhandle, HistoryTest_StateType oldState)
{
...
void local_State6_enter(SM_HistoryTest_MainState_State2_Handle* rhandle)
{
...
void local_State6_exit(SM_HistoryTest_MainState_State2_Handle* rhandle, HistoryTest_StateType oldState)
{
...
void local_State6_handle(SM_HistoryTest_MainState_State2_Handle* rhandle)
{
...
BOOL local_State6_analyseTransitionIn(SM_HistoryTest_MainState_State2_Handle* rhandle)
{
...
void local_Initial_enter(SM_HistoryTest_MainState_State2_Handle* rhandle)
{
...
void local_Initial_exit(SM_HistoryTest_MainState_State2_Handle* rhandle, HistoryTest_StateType oldState)
{
} 


void local_Initial_handle(SM_HistoryTest_MainState_State2_Handle* rhandle)
{
...
BOOL local_Initial_analyseTransitionIn(SM_HistoryTest_MainState_State2_Handle* rhandle)
{
  BOOL isTriggerSet = FALSE;
  ...
  if (isTriggerSet == FALSE)
  {
	...
	if (  (1 == 1) )  
    {
	  ...
	  rhandle->global->transition = historyTest_MainState_State2_Initial_TO_historyTest_MainState_State2_State6_P1;
