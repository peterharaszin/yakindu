 ...
 * @generated
 */
public class StateDoEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StateDoEditPart(View view) {
		super(view);
	}
			...
			parser = StatemachineParserProvider
					.getParser(
							...
							StatemachineVisualIDRegistry
									.getType(statemachine.diagram.edit.parts.StateDoEditPart.VISUAL_ID));
		}
		return parser;
	}
