 ...
 * @generated
 */
public class StatemachineSheetLabelProvider extends BaseLabelProvider implements
		ILabelProvider {
	...
	public String getText(Object element) {
		...
		if (element instanceof StatemachineNavigatorGroup) {
			return ((StatemachineNavigatorGroup) element).getGroupName();
		}
	...
	public Image getImage(Object element) {
		...
		return etype == null ? null : StatemachineElementTypes.getImage(etype);
	}
