		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_targetNode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_targetNode_feature", "_UI_Transition_type"),
				 StatemachinePackage.Literals.TRANSITION__TARGET_NODE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatemachinePackage.Literals.TRANSITION__PRIORITY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatemachinePackage.Literals.TRANSITION__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addSourceNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_sourceNode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_sourceNode_feature", "_UI_Transition_type"),
				 StatemachinePackage.Literals.TRANSITION__SOURCE_NODE,
				 true,
				 false,
				 true,
				 null,
