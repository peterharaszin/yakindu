...
/**
 * This is the item provider adapter for a {@link org.yakindu.sct.model.stext.stext.LogicalNotExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public LogicalNotExpressionItemProvider(AdapterFactory adapterFactory)
  {
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(StextPackage.Literals.LOGICAL_NOT_EXPRESSION__OPERAND);
    }
  ...
  /**
   * This returns LogicalNotExpression.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/LogicalNotExpression"));
  }
  ...
  {
    return getString("_UI_LogicalNotExpression_type");
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(LogicalNotExpression.class))
    {
      case StextPackage.LOGICAL_NOT_EXPRESSION__OPERAND:
