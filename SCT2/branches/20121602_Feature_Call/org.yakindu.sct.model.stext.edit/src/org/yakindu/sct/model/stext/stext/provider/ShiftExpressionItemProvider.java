...
/**
 * This is the item provider adapter for a {@link org.yakindu.sct.model.stext.stext.ShiftExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public ShiftExpressionItemProvider(AdapterFactory adapterFactory)
  {
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ShiftExpression_operator_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ShiftExpression_operator_feature", "_UI_ShiftExpression_type"),
         StextPackage.Literals.SHIFT_EXPRESSION__OPERATOR,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(StextPackage.Literals.SHIFT_EXPRESSION__LEFT_OPERAND);
      childrenFeatures.add(StextPackage.Literals.SHIFT_EXPRESSION__RIGHT_OPERAND);
    }
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/ShiftExpression"));
  }
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_ShiftExpression_type") :
      getString("_UI_ShiftExpression_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(ShiftExpression.class))
    {
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
  {
    ...
    boolean qualify =
      childFeature == StextPackage.Literals.SHIFT_EXPRESSION__LEFT_OPERAND ||
      childFeature == StextPackage.Literals.SHIFT_EXPRESSION__RIGHT_OPERAND;
