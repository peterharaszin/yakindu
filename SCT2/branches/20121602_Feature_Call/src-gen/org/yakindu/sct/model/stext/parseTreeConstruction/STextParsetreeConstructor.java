...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 45: return new Statement_Alternatives(this, this, 45, inst);
			case 46: return new Assignment_Group(this, this, 46, inst);
			case 47: return new EventRaising_Group(this, this, 47, inst);
			case 48: return new Expression_ConditionalExpressionParserRuleCall(this, this, 48, inst);
			...
			case 63: return new ValueExpression_Alternatives(this, this, 63, inst);
...
protected class StateScope_DeclarationsAssignment_1 extends AssignmentToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 1: return new Entrypoint_Group(this, this, 1, inst);
			case 2: return new Exitpoint_Group(this, this, 2, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getLocalReactionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getStateScopeAccess().getDeclarationsLocalReactionParserRuleCall_1_0_0(); 
				consumed = obj;
				return param;
			}
		}
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getEntrypointRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getStateScopeAccess().getDeclarationsEntrypointParserRuleCall_1_0_1(); 
				consumed = obj;
				return param;
			}
		}
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExitpointRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getStateScopeAccess().getDeclarationsExitpointParserRuleCall_1_0_2(); 
				consumed = obj;
				return param;
			}
		}
 ...
 *
 * InterfaceScope:
 * 	{InterfaceScope} "interface" name=ID? ":" declarations+=(EventDeclarartion | VariableDeclaration | Entrypoint |
 * 	Exitpoint)*;
 *
 **/
...
// declarations+=(EventDeclarartion | VariableDeclaration | Entrypoint | Exitpoint)*
protected class InterfaceScope_DeclarationsAssignment_4 extends AssignmentToken  {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 2: return new Entrypoint_Group(this, this, 2, inst);
			case 3: return new Exitpoint_Group(this, this, 3, inst);
			default: return null;
		}	
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getEntrypointRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getInterfaceScopeAccess().getDeclarationsEntrypointParserRuleCall_4_0_2(); 
				consumed = obj;
				return param;
			}
		}
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExitpointRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getInterfaceScopeAccess().getDeclarationsExitpointParserRuleCall_4_0_3(); 
				consumed = obj;
				return param;
			}
		}
...
protected class Declaration_Alternatives extends AlternativesToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 4: return new Declaration_EntrypointParserRuleCall_4(lastRuleCallOrigin, this, 4, inst);
			case 5: return new Declaration_ExitpointParserRuleCall_5(lastRuleCallOrigin, this, 5, inst);
			default: return null;
		}	
	}
...
// Entrypoint
protected class Declaration_EntrypointParserRuleCall_4 extends RuleCallToken {
	
	public Declaration_EntrypointParserRuleCall_4(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getDeclarationAccess().getEntrypointParserRuleCall_4();
	}
...
// Exitpoint
protected class Declaration_ExitpointParserRuleCall_5 extends RuleCallToken {
	
	public Declaration_ExitpointParserRuleCall_5(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getDeclarationAccess().getExitpointParserRuleCall_5();
	}
...
protected class ReactionEffect_Group_2 extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ReactionEffect_Group_2_0(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// ";" actions+=Statement
protected class ReactionEffect_Group_2_0 extends GroupToken {
	
	public ReactionEffect_Group_2_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Group getGrammarElement() {
		return grammarAccess.getReactionEffectAccess().getGroup_2_0();
	}

    @Override
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ReactionEffect_ActionsAssignment_2_0_1(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
// ";"
protected class ReactionEffect_SemicolonKeyword_2_0_0 extends KeywordToken  {
	
	public ReactionEffect_SemicolonKeyword_2_0_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Keyword getGrammarElement() {
		return grammarAccess.getReactionEffectAccess().getSemicolonKeyword_2_0_0();
	}
...
// actions+=Statement
protected class ReactionEffect_ActionsAssignment_2_0_1 extends AssignmentToken  {
	
	public ReactionEffect_ActionsAssignment_2_0_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getReactionEffectAccess().getActionsAssignment_2_0_1();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getStatementRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getReactionEffectAccess().getActionsStatementParserRuleCall_2_0_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new ReactionEffect_SemicolonKeyword_2_0_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
...
protected class ReactionProperty_Alternatives extends AlternativesToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ReactionProperty_EntryPointSpecParserRuleCall_0(lastRuleCallOrigin, this, 0, inst);
			case 1: return new ReactionProperty_ExitPointSpecParserRuleCall_1(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
// EntryPointSpec
protected class ReactionProperty_EntryPointSpecParserRuleCall_0 extends RuleCallToken {
	
	public ReactionProperty_EntryPointSpecParserRuleCall_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getReactionPropertyAccess().getEntryPointSpecParserRuleCall_0();
	}
...
// ExitPointSpec
protected class ReactionProperty_ExitPointSpecParserRuleCall_1 extends RuleCallToken {
	
	public ReactionProperty_ExitPointSpecParserRuleCall_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getReactionPropertyAccess().getExitPointSpecParserRuleCall_1();
	}
 ...
 *
 * Assignment:
 * 	varRef=FeatureCall operator=AssignmentOperator expression=Expression;
 *
 **/
...
protected class Assignment_VarRefAssignment_0 extends AssignmentToken  {
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getFeatureCallRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getAssignmentAccess().getVarRefFeatureCallParserRuleCall_0_0(); 
				consumed = obj;
				return param;
			}
		}
 ...
 *
 * EventRaising:
 * 	"raise" event=FeatureCall (":" value=Expression)?;
 *
 **/
...
protected class EventRaising_EventAssignment_1 extends AssignmentToken  {
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getFeatureCallRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getEventRaisingAccess().getEventFeatureCallParserRuleCall_1_0(); 
				consumed = obj;
				return param;
			}
		}
	...
	public AbstractToken createFollowerAfterReturn(AbstractToken next,	int actIndex, int index, IEObjectConsumer inst) {
		if(value == inst.getEObject() && !inst.isConsumed()) return null;
		switch(index) {
			case 0: return new EventRaising_RaiseKeyword_0(lastRuleCallOrigin, next, actIndex, consumed);
			default: return null;
		}	
	}	
}
 ...
 * 	FeatureCall | {NumericalUnaryExpression} operator=UnaryOperator operand=FeatureCall;
 *
 **/
...
protected class NumericalUnaryExpression_Alternatives extends AlternativesToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new NumericalUnaryExpression_FeatureCallParserRuleCall_0(lastRuleCallOrigin, this, 0, inst);
...
// FeatureCall
protected class NumericalUnaryExpression_FeatureCallParserRuleCall_0 extends RuleCallToken {
	
	public NumericalUnaryExpression_FeatureCallParserRuleCall_0(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getNumericalUnaryExpressionAccess().getFeatureCallParserRuleCall_0();
	}
...
// {NumericalUnaryExpression} operator=UnaryOperator operand=FeatureCall
...
protected class NumericalUnaryExpression_OperandAssignment_1_2 extends AssignmentToken  {
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getFeatureCallRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getNumericalUnaryExpressionAccess().getOperandFeatureCallParserRuleCall_1_2_0(); 
				consumed = obj;
				return param;
			}
		}
 ...
 * 	PrimaryExpression ({FeatureCall.owner=current} "." feature=[types::Feature])*;
 *
 **/
...
protected class FeatureCall_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 1: return new FeatureCall_PrimaryExpressionParserRuleCall_0(lastRuleCallOrigin, this, 1, inst);
			default: return null;
		}	
	}
...
// ({FeatureCall.owner=current} "." feature=[types::Feature])*
 ...
 * 	PrimitiveValueExpression | TypedElementReferenceExpression | ActiveStateReferenceExpression |
...
protected class ValueExpression_Alternatives extends AlternativesToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 1: return new ValueExpression_TypedElementReferenceExpressionParserRuleCall_1(lastRuleCallOrigin, this, 1, inst);
...
protected class ValueExpression_TypedElementReferenceExpressionParserRuleCall_1 extends RuleCallToken {
	
	public ValueExpression_TypedElementReferenceExpressionParserRuleCall_1(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getValueExpressionAccess().getTypedElementReferenceExpressionParserRuleCall_1();
	}
 ...
 * 	{EventValueReferenceExpression} "valueof" "(" value=Expression ")";
 *
 **/
...
protected class EventValueReferenceExpression_ValueAssignment_3 extends AssignmentToken  {
	...
	public IEObjectConsumer tryConsume() {
		...
		if(value instanceof EObject) { // org::eclipse::xtext::impl::RuleCallImpl
			...
			if(param.isInstanceOf(grammarAccess.getExpressionRule().getType().getClassifier())) {
				type = AssignmentType.PARSER_RULE_CALL;
				element = grammarAccess.getEventValueReferenceExpressionAccess().getValueExpressionParserRuleCall_3_0(); 
				consumed = obj;
				return param;
			}
		}
