...
public class EventRaisingImpl extends StatementImpl implements EventRaising
{
  ...
  public NotificationChain basicSetEvent(Expression newEvent, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, StextPackage.EVENT_RAISING__EVENT, oldEvent, newEvent);
  ...
  public void setEvent(Expression newEvent)
  {
    if (newEvent != event)
    {
      ...
      if (event != null)
        msgs = ((InternalEObject)event).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - StextPackage.EVENT_RAISING__EVENT, null, msgs);
      if (newEvent != null)
        msgs = ((InternalEObject)newEvent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - StextPackage.EVENT_RAISING__EVENT, null, msgs);
      msgs = basicSetEvent(newEvent, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, StextPackage.EVENT_RAISING__EVENT, newEvent, newEvent));
  }
