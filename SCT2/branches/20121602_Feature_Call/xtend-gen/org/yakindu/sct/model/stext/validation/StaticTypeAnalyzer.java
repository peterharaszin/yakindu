...
public class StaticTypeAnalyzer {
  ...
  protected Class<? extends Serializable> _check(final LogicalAndExpression expression) throws TypeCheckException {
    Class<Boolean> _xblockexpression = null;
    {
      ...
      Class<? extends Serializable> _check = this.check(_leftOperand);
      this.assertIsBoolean(_check, "&&");
      Expression _rightOperand = expression.getRightOperand();
      Class<? extends Serializable> _check_1 = this.check(_rightOperand);
  ...
  protected Class<? extends Serializable> _check(final LogicalOrExpression expression) throws TypeCheckException {
    Class<Boolean> _xblockexpression = null;
    {
      Expression _leftOperand = expression.getLeftOperand();
      Class<? extends Serializable> _check = this.check(_leftOperand);
  ...
  protected Class<? extends Serializable> _check(final LogicalNotExpression expression) throws TypeCheckException {
    Class<Boolean> _xblockexpression = null;
    {
      Expression _operand = expression.getOperand();
      Class<? extends Serializable> _check = this.check(_operand);
      this.assertIsBoolean(_check, "!");
      _xblockexpression = (java.lang.Boolean.class);
    }
    return _xblockexpression;
  ...
  protected Class<? extends Serializable> _check(final BitwiseAndExpression expression) throws TypeCheckException {
  ...
  protected Class<? extends Serializable> _check(final BitwiseOrExpression expression) throws TypeCheckException {
    Class<Number> _xblockexpression = null;
    {
      Expression _leftOperand = expression.getLeftOperand();
      Class<? extends Serializable> _check = this.check(_leftOperand);
  ...
  protected Class<? extends Serializable> _check(final BitwiseXorExpression expression) throws TypeCheckException {
    Class<Number> _xblockexpression = null;
    {
      Expression _leftOperand = expression.getLeftOperand();
      Class<? extends Serializable> _check = this.check(_leftOperand);
  ...
  protected Class<? extends Serializable> _check(final LogicalRelationExpression expression) throws TypeCheckException {
    {
      Expression _leftOperand = expression.getLeftOperand();
      Class<? extends Serializable> _check = this.check(_leftOperand);
      Class<? extends Serializable> leftType = _check;
      Expression _rightOperand = expression.getRightOperand();
      Class<? extends Serializable> _check_1 = this.check(_rightOperand);
      Class<? extends Serializable> rightType = _check_1;
  ...
  protected Class<? extends Serializable> _check(final NumericalAddSubtractExpression expression) throws TypeCheckException {
    Class<Number> _xblockexpression = null;
    {
      Expression _leftOperand = expression.getLeftOperand();
      Class<? extends Serializable> _check = this.check(_leftOperand);
  ...
  protected Class<? extends Serializable> _check(final NumericalMultiplyDivideExpression expression) throws TypeCheckException {
    Class<Number> _xblockexpression = null;
    {
      Expression _leftOperand = expression.getLeftOperand();
      Class<? extends Serializable> _check = this.check(_leftOperand);
  ...
  protected Class<? extends Serializable> _check(final NumericalUnaryExpression expression) throws TypeCheckException {
    Class<Number> _xblockexpression = null;
    {
      Expression _operand = expression.getOperand();
      Class<? extends Serializable> _check = this.check(_operand);
  ...
  protected Class<? extends Serializable> _check(final PrimitiveValueExpression expression) {
    Literal _value = expression.getValue();
    Class<? extends Serializable> _type = this.type(_value);
    return _type;
  }
  
  protected Class<? extends Serializable> _check(final ShiftExpression expression) {
    return null;
  }
  
  protected Class<? extends Serializable> _check(final ConditionalExpression expression) {
    return null;
  }
  
  protected Class<? extends Serializable> _check(final EventValueReferenceExpression expression) {
    return null;
  }
