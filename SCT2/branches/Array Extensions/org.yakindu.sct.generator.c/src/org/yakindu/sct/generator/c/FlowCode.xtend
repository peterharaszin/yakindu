...
class FlowCode {
	...
	def dispatch CharSequence code(Execution it) 
		'''«IF statement instanceof AssignmentExpression && ((statement as AssignmentExpression).expression instanceof ArrayInitializationExpression)»«ELSE»«statement.code»;«ENDIF»'''
