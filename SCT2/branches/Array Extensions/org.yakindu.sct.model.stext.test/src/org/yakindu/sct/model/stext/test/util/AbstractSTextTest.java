...
public abstract class AbstractSTextTest {
	 ...
	 *  var intArrayVar : integer
	 *  var int2DArrayVar : integer
	 *  var int3DArrayVar : integer	  
	...
	protected Scope internalScope() {
		return createInternalScope("internal: operation voidOp() operation intOp():integer var intVar : integer var boolVar : boolean var realVar : real var stringVar : string  var intArrayVar : integer   var int2DArrayVar : integer  var int3DArrayVar : integer   event intEvent : integer  event boolEvent : boolean event realEvent : real event stringEvent : string event voidEvent : void ");
	}
	...
	protected Scope interfaceScope() {
		return createInterfaceScope("interface ABC : operation paramOp(param1 : integer, param2 : boolean ) : string operation stringOp() in event voidEvent  in event intEvent : integer var intVar : integer var boolVar : boolean   var intArrayVar : integer  var int2DArrayVar : integer  var int3DArrayVar : integer ");
	}
}
