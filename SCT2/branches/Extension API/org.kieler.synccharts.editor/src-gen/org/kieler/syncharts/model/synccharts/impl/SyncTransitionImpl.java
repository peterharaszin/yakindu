...
import org.kieler.syncharts.model.synccharts.SyncTransition;
 ...
 * <ul>
 *   <li>{@link org.kieler.syncharts.model.synccharts.impl.SyncTransitionImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SyncTransitionImpl extends TransitionImpl implements SyncTransition {
	...
	protected EClass eStaticClass() {
		return SyncchartsPackage.Literals.SYNC_TRANSITION;
	}
	...
	public void setType(TransitionType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SyncchartsPackage.SYNC_TRANSITION__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SyncchartsPackage.SYNC_TRANSITION__TYPE:
				return getType();
		}
