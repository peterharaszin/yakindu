...
public class STextDefaultTypeInferrer implements ISTextTypeInferrer {
    ...
    if (_equals) {
      ...
      if (_notEquals) {
        ...
        if (_equals_2) {
          ...
          String _plus_1 = ("Cannot assign a value of type " + _name_1);
          String _plus_2 = (_plus_1 + " to a variable of type ");
          InferredType _type_6 = varType.getType();
          Type _type_7 = _type_6.getType();
          String _name_2 = _type_7.getName();
          String _plus_3 = (_plus_2 + _name_2);
          String _plus_4 = (_plus_3 + ".");
          InferenceIssue _inferenceIssue_1 = new InferenceIssue(_plus_4, IStatus.ERROR);
  ...
  protected InferenceResult _doInferType(final InterfaceScope s) {
    Type _voidType = this.ts.getVoidType();
    InferenceResult _inferenceResult = new InferenceResult(_voidType);
    return _inferenceResult;
  }
  
  protected InferenceResult _doInferType(final InternalScope s) {
    Type _voidType = this.ts.getVoidType();
    InferenceResult _inferenceResult = new InferenceResult(_voidType);
    return _inferenceResult;
  }
    ...
    if (_equals) {
      ...
      if (_equals_1) {
        ...
        if (_not) {
          ...
          String _plus = ("Need to assign a value to an event of type " + _name);
          String _plus_1 = (_plus + ".");
          InferenceIssue _inferenceIssue = new InferenceIssue(_plus_1, IStatus.ERROR);
          InferenceResult _inferenceResult = new InferenceResult(null, _inferenceIssue);
          return _inferenceResult;
        }
        return eventType;
        ...
        if (_equals_3) {
          ...
          String _plus_3 = (_plus_2 + " to an event of type ");
          InferredType _type_8 = eventType.getType();
          Type _type_9 = _type_8.getType();
          String _name_2 = _type_9.getName();
          String _plus_4 = (_plus_3 + _name_2);
          String _plus_5 = (_plus_4 + ".");
          InferenceIssue _inferenceIssue_1 = new InferenceIssue(_plus_5, IStatus.ERROR);
  ...
  protected InferenceResult _doInferType(final StringLiteral literal) {
    String _value = literal.getValue();
    return this.ts.inferTypeForLiteral(_value);
  }
  
  protected InferenceResult _doInferType(final BoolLiteral literal) {
    boolean _isValue = literal.isValue();
    return this.ts.inferTypeForLiteral(Boolean.valueOf(_isValue));
  }
  
  protected InferenceResult _doInferType(final RealLiteral literal) {
    float _value = literal.getValue();
    return this.ts.inferTypeForLiteral(Float.valueOf(_value));
  }
  
  protected InferenceResult _doInferType(final HexLiteral literal) {
    int _value = literal.getValue();
    return this.ts.inferTypeForLiteral(Integer.valueOf(_value));
  }
  
  protected InferenceResult _doInferType(final IntLiteral literal) {
    int _value = literal.getValue();
    return this.ts.inferTypeForLiteral(Integer.valueOf(_value));
  }
  
  protected InferenceResult _doInferType(final Literal l) {
  ...
  protected InferenceResult _doInferType(final EObject e) {
    return this.ts.inferTypeForLiteral(e);
  }
  ...
  public InferenceResult doInferType(final EObject definition) {
    ...
    } else if (definition instanceof InterfaceScope) {
      return _doInferType((InterfaceScope)definition);
    } else if (definition instanceof InternalScope) {
      return _doInferType((InternalScope)definition);
    ...
    } else if (definition instanceof BoolLiteral) {
      return _doInferType((BoolLiteral)definition);
    } else if (definition instanceof Expression) {
      return _doInferType((Expression)definition);
    } else if (definition instanceof HexLiteral) {
      return _doInferType((HexLiteral)definition);
    } else if (definition instanceof IntLiteral) {
      return _doInferType((IntLiteral)definition);
    } else if (definition instanceof RealLiteral) {
      return _doInferType((RealLiteral)definition);
    } else if (definition instanceof StringLiteral) {
      return _doInferType((StringLiteral)definition);
