...
public class CompartmentCreationEditPolicy extends CreationEditPolicy {
	...
	private static final ImmutableList<String> fixedSizeElements = ImmutableList
			.of(SemanticHints.CHOICE, SemanticHints.ENTRY,
					SemanticHints.FINALSTATE, SemanticHints.DEEPHISTORY,
					SemanticHints.SHALLOWHISTORY, SemanticHints.EXIT,
					SemanticHints.SYNCHRONIZATION);
