...
public class ExecutionFactoryImpl extends EFactoryImpl implements ExecutionFactory {
	...
	public static ExecutionFactory init() {
		try {
			ExecutionFactory theExecutionFactory = (ExecutionFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.yakindu.org/sct/statechart/Execution"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ExecutionPackage.EXECUTION_CONTEXT: return createExecutionContext();
			case ExecutionPackage.EXECUTION_VARIABLE: return createExecutionVariable();
			case ExecutionPackage.EXECUTION_EVENT: return createExecutionEvent();
			case ExecutionPackage.EXECUTION_SCOPE: return createExecutionScope();
			default:
