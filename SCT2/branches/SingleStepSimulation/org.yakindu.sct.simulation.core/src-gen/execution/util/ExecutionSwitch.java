...
public class ExecutionSwitch<T> extends Switch<T> {
	 ...
	 * @generated
	 */
	public T caseExecutionFeature(ExecutionFeature object) {
		return null;
	}
