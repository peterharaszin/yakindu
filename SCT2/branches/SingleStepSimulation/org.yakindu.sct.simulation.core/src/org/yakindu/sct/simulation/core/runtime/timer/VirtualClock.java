...
public class VirtualClock {
	...
	// factor to set after the clock is resumed (only if it is greater than zero))
	private double factorToSet = 0;
	...
	public synchronized long getTime() {
		long difference = System.currentTimeMillis() - getPauseTime() - this.realTime;
	...
	private long getPauseTime() {
		if(isSuspended){
			return (System.currentTimeMillis() - startSuspendTime) + accumulatedSuspendTime;
		}
