...
/**
 * This is the item provider adapter for a {@link org.yakindu.sct.model.stext.stext.EnumLiteral} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_EnumLiteral_type_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_EnumLiteral_type_feature", "_UI_EnumLiteral_type"),
         StextPackage.Literals.ENUM_LITERAL__TYPE,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         StextPackage.Literals.ENUM_LITERAL__VALUE,
         true,
         false,
         true,
         null,
  ...
  {
    return getString("_UI_EnumLiteral_type");
  }
