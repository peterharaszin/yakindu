...
public class STextJavaValidator extends AbstractSTextJavaValidator {
	...
	@Check(CheckType.FAST)
	public void checkTypesystemRules(VariableDefinition definition) {
		typeSystem.checkTypesystemConstraints(definition, this);
	}
	...
	@Check(CheckType.FAST)
	public void checkTypesystemRules(Guard guard) {
		typeSystem.checkTypesystemConstraints(guard, this);
	}

	@Check(CheckType.FAST)
	public void checkTimeEventSpecValueExpression(TimeEventSpec spec) {
		typeSystem.checkTypesystemConstraints(spec, this);
	}
