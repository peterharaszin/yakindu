...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Composite Slot</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class CompositeSlotImpl extends RuntimeSlotImpl implements CompositeSlot {
	/**
	...
	public EList<RuntimeSlot> getSlots() {
		if (slots == null) {
			slots = new EObjectContainmentEList<RuntimeSlot>(RuntimeSlot.class, this, SRuntimePackage.COMPOSITE_SLOT__SLOTS);
		}
		return slots;
	}
