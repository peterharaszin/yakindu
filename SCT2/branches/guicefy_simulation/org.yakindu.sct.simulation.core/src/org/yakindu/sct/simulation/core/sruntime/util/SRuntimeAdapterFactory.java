...
public class SRuntimeAdapterFactory extends AdapterFactoryImpl {
	...
	protected SRuntimeSwitch<Adapter> modelSwitch =
		new SRuntimeSwitch<Adapter>() {
			...
			@Override
			public Adapter caseRuntimeEvent(RuntimeEvent object) {
				return createRuntimeEventAdapter();
			}
			@Override
			public Adapter caseRuntimeSlot(RuntimeSlot object) {
				return createRuntimeSlotAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.yakindu.sct.simulation.core.sruntime.RuntimeContext <em>Runtime Context</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.yakindu.sct.simulation.core.sruntime.RuntimeEvent <em>Runtime Event</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRuntimeEventAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.yakindu.sct.simulation.core.sruntime.RuntimeSlot <em>Runtime Slot</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createRuntimeSlotAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.yakindu.sct.simulation.core.sruntime.RuntimeVariable <em>Runtime Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
