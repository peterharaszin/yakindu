...
:
(
{ before(grammarAccess.getFeatureParameterValueAccess().getExpressionXLiteralParserRuleCall_3_0()); }
	ruleXLiteral{ after(grammarAccess.getFeatureParameterValueAccess().getExpressionXLiteralParserRuleCall_3_0()); }
)
