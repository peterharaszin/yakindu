...
/**
 * Manual modifications go to {org.yakindu.sct.generator.genmodel.SGenRuntimeModule}
 */
 @SuppressWarnings("all")
public abstract class AbstractSGenRuntimeModule extends DefaultRuntimeModule {

	protected Properties properties = null;

	@Override
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/yakindu/sct/generator/genmodel/SGen.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.yakindu.sct.generator.genmodel.SGen");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("sgen");
	}
	
	// contributed by org.eclipse.xtext.generator.grammarAccess.GrammarAccessFragment
	public Class<? extends org.eclipse.xtext.IGrammarAccess> bindIGrammarAccess() {
		return org.yakindu.sct.generator.genmodel.services.SGenGrammarAccess.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISemanticSequencer> bindISemanticSequencer() {
		return org.yakindu.sct.generator.genmodel.serializer.SGenSemanticSequencer.class;
	}

	// contributed by org.eclipse.xtext.generator.serializer.SerializerFragment
	public Class<? extends org.eclipse.xtext.serializer.sequencer.ISyntacticSequencer> bindISyntacticSequencer() {
		return org.yakindu.sct.generator.genmodel.serializer.SGenSyntacticSequencer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.IParser> bindIParser() {
		return org.yakindu.sct.generator.genmodel.parser.antlr.SGenParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> bindIAntlrTokenFileProvider() {
		return org.yakindu.sct.generator.genmodel.parser.antlr.SGenAntlrTokenFileProvider.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public Class<? extends org.eclipse.xtext.parser.antlr.Lexer> bindLexer() {
		return org.yakindu.sct.generator.genmodel.parser.antlr.internal.InternalSGenLexer.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<org.yakindu.sct.generator.genmodel.parser.antlr.internal.InternalSGenLexer> provideInternalSGenLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(org.yakindu.sct.generator.genmodel.parser.antlr.internal.InternalSGenLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(org.yakindu.sct.generator.genmodel.parser.antlr.internal.InternalSGenLexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends org.yakindu.sct.generator.genmodel.validation.SGenJavaValidator> bindSGenJavaValidator() {
		return org.yakindu.sct.generator.genmodel.validation.SGenJavaValidator.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return org.yakindu.sct.generator.genmodel.formatting.SGenFormatter.class;
	}
	...
	public Class<? extends org.eclipse.xtext.xbase.jvmmodel.IJvmModelInferrer> bindIJvmModelInferrer() {
		return org.yakindu.sct.generator.genmodel.jvmmodel.SGenJvmModelInferrer.class;
	}
