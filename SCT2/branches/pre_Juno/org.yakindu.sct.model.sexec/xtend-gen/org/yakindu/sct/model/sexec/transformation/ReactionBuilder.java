...
public class ReactionBuilder {
  ...
  public Sequence defineCycle(final RegularState state) {
    ...
    final List<RegularState> parents = this.sgraph.parentStates(state);
    ...
    final Iterable<ExecutionNode> parentNodes = Iterables.<ExecutionNode>concat(_map, _newHashSet);
