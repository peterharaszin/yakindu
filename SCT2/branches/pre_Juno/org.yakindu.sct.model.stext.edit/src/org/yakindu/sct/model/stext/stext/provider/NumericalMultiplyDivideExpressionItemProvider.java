...
/**
 * This is the item provider adapter for a {@link org.yakindu.sct.model.stext.stext.NumericalMultiplyDivideExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public NumericalMultiplyDivideExpressionItemProvider(AdapterFactory adapterFactory)
  {
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_NumericalMultiplyDivideExpression_operator_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_NumericalMultiplyDivideExpression_operator_feature", "_UI_NumericalMultiplyDivideExpression_type"),
         StextPackage.Literals.NUMERICAL_MULTIPLY_DIVIDE_EXPRESSION__OPERATOR,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(StextPackage.Literals.NUMERICAL_MULTIPLY_DIVIDE_EXPRESSION__LEFT_OPERAND);
      childrenFeatures.add(StextPackage.Literals.NUMERICAL_MULTIPLY_DIVIDE_EXPRESSION__RIGHT_OPERAND);
    }
  ...
  /**
   * This returns NumericalMultiplyDivideExpression.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/NumericalMultiplyDivideExpression"));
  }
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_NumericalMultiplyDivideExpression_type") :
      getString("_UI_NumericalMultiplyDivideExpression_type") + " " + label;
  }
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection)
  {
    ...
    boolean qualify =
      childFeature == StextPackage.Literals.NUMERICAL_MULTIPLY_DIVIDE_EXPRESSION__LEFT_OPERAND ||
      childFeature == StextPackage.Literals.NUMERICAL_MULTIPLY_DIVIDE_EXPRESSION__RIGHT_OPERAND;
