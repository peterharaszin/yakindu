...
/**
 * This is the item provider adapter for a {@link org.yakindu.sct.model.stext.stext.NumericalUnaryExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public NumericalUnaryExpressionItemProvider(AdapterFactory adapterFactory)
  {
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_NumericalUnaryExpression_operator_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_NumericalUnaryExpression_operator_feature", "_UI_NumericalUnaryExpression_type"),
         StextPackage.Literals.NUMERICAL_UNARY_EXPRESSION__OPERATOR,
         true,
         false,
         false,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(StextPackage.Literals.NUMERICAL_UNARY_EXPRESSION__OPERAND);
    }
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/NumericalUnaryExpression"));
  }
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_NumericalUnaryExpression_type") :
      getString("_UI_NumericalUnaryExpression_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(NumericalUnaryExpression.class))
    {
      case StextPackage.NUMERICAL_UNARY_EXPRESSION__OPERATOR:
        fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
        return;
      case StextPackage.NUMERICAL_UNARY_EXPRESSION__OPERAND:
