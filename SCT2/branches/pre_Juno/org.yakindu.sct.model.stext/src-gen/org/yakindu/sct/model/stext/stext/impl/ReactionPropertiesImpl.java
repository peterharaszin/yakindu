 ...
 * <ul>
 *   <li>{@link org.yakindu.sct.model.stext.stext.impl.ReactionPropertiesImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReactionPropertiesImpl extends MinimalEObjectImpl.Container implements ReactionProperties
{
  ...
  {
    return StextPackage.Literals.REACTION_PROPERTIES;
  }
  ...
  public EList<ReactionProperty> getProperties()
  {
    if (properties == null)
    {
      properties = new EObjectContainmentEList<ReactionProperty>(ReactionProperty.class, this, StextPackage.REACTION_PROPERTIES__PROPERTIES);
    }
    return properties;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case StextPackage.REACTION_PROPERTIES__PROPERTIES:
