 ...
 * @generated
 */
public class TransitionPriorityEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				StatemachineVisualIDRegistry
						.getType(statemachine.diagram.edit.parts.TransitionPriorityEditPart.VISUAL_ID),
				new Point(0, 60));
	}
	 ...
	 * @generated
	 */
	public TransitionPriorityEditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof StatemachineTextSelectionEditPolicy) {
			((StatemachineTextSelectionEditPolicy) pdEditPolicy)
					.refreshFeedback();
		}
		Object sfEditPolicy = getEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE);
		if (sfEditPolicy instanceof StatemachineTextSelectionEditPolicy) {
			((StatemachineTextSelectionEditPolicy) sfEditPolicy)
					.refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), StatemachineEditPartFactory
