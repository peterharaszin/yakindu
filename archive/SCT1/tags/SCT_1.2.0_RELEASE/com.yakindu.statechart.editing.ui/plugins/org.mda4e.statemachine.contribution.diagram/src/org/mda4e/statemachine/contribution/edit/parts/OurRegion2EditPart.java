...
public class OurRegion2EditPart extends Region2EditPart {
	
	private boolean isOpen;
	private IPreferenceStore store;

	public OurRegion2EditPart(View view) {
		super(view);
		isOpen = true;
	...
	private void updateFigure(){
		...
		//System.out.println("region Compartment children: "+regionCompartment.getChildren().size());
	}
