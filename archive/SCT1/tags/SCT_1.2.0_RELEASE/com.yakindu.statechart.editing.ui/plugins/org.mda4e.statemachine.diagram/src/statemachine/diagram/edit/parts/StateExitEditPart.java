 ...
 * @generated
 */
public class StateExitEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StateExitEditPart(View view) {
		super(view);
	}
			...
			parser = StatemachineParserProvider
					.getParser(
							...
							StatemachineVisualIDRegistry
									.getType(statemachine.diagram.edit.parts.StateExitEditPart.VISUAL_ID));
		}
		return parser;
	}
