 ...
 * @generated
 */
public class Pseudostate5ItemSemanticEditPolicy extends
		StatemachineBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Pseudostate5ItemSemanticEditPolicy() {
		super(StatemachineElementTypes.Pseudostate_3008);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (StatemachineVisualIDRegistry.getVisualID(incomingLink) == TransitionEditPart.VISUAL_ID) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (StatemachineVisualIDRegistry.getVisualID(outgoingLink) == TransitionEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
