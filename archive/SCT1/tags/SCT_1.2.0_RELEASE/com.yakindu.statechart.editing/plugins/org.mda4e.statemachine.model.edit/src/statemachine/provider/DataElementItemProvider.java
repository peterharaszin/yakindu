...
/**
 * This is the item provider adapter for a {@link statemachine.DataElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataElement_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataElement_name_feature", "_UI_DataElement_type"),
				 StatemachinePackage.Literals.DATA_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addIoTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataElement_ioType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataElement_ioType_feature", "_UI_DataElement_type"),
				 StatemachinePackage.Literals.DATA_ELEMENT__IO_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataElement_port_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataElement_port_feature", "_UI_DataElement_type"),
				 StatemachinePackage.Literals.DATA_ELEMENT__PORT,
				 true,
				 false,
				 false,
