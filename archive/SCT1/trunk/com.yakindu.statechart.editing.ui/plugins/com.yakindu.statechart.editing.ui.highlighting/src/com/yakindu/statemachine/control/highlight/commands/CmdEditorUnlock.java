...
public class CmdEditorUnlock extends AbstractTransactionalCommand {
	
	private StatemachineDiagramEditor editor;
	
	public CmdEditorUnlock(String label, List<IFile> affectedFiles, StatemachineDiagramEditor editor) {
