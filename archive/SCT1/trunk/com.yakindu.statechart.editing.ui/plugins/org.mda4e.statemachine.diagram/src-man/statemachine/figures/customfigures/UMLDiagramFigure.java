...
import statemachine.figures.layouts.GridData;
...
public class UMLDiagramFigure extends DiagramFigure
{
    ...
    protected void paintFigure(Graphics graphics)
    {
        ...
        graphics.drawLine(headerBounds.getBottomRight(), headerBounds.getBottomRight().getTranslated(HEADER_CORNER,
                -HEADER_CORNER * 2));
        graphics.drawLine(headerBounds.getBottomRight().getTranslated(HEADER_CORNER, -HEADER_CORNER * 2),
                headerBounds.getTopRight().getTranslated(HEADER_CORNER, 0));
    }

    /**
     * Subclasses should override this to return the prefix that should be used
     * in the header
     * 
     * @return String
     */
