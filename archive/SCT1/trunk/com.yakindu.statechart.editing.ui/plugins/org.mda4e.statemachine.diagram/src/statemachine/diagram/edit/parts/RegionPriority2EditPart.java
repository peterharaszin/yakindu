 ...
 * @generated
 */
public class RegionPriority2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RegionPriority2EditPart(View view) {
		super(view);
	}
			...
			parser = StatemachineParserProvider
					.getParser(
							...
							StatemachineVisualIDRegistry
									.getType(statemachine.diagram.edit.parts.RegionPriority2EditPart.VISUAL_ID));
		}
		return parser;
	}
