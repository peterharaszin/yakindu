...
public abstract class AbstractStatechartExpressionsRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "com/yakindu/statechart/model/expressions/StatechartExpressions.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("com.yakindu.statechart.model.expressions.StatechartExpressions");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("se");
	}
	...
	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public com.google.inject.Provider<com.yakindu.statechart.model.expressions.parser.antlr.internal.InternalStatechartExpressionsLexer> provideInternalStatechartExpressionsLexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(com.yakindu.statechart.model.expressions.parser.antlr.internal.InternalStatechartExpressionsLexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(com.yakindu.statechart.model.expressions.parser.antlr.internal.InternalStatechartExpressionsLexer.class);
	}
