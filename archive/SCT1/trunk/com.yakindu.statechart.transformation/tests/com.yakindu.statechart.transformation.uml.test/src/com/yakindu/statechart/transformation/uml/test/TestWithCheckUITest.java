 ...
 */
package com.yakindu.statechart.transformation.uml.test;
...
public class TestWithCheckUITest extends AbstractExpressionEvaluationTest {
	...
	protected XtendFacade createXtendFacade(ExecutionContext executionContext) {
		return XtendFacade.create(executionContext,
				"com::yakindu::statechart::transformation::uml::m2m");
	}
	...
	public void testTransformation() {
		...
		Model uml2 = (Model) Reader
				.load(
						...
						"platform:/plugin/com.yakindu.statechart.transformation.uml.test/model/PedestrianTrafficLightGER.uml",
						true);
		...
		CheckFacade.checkAll(
				"com/yakindu/statechart/transformation/uml/test/check/modelTest",
